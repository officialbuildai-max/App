...
public class r extends c {
    public r(CloudControlConfig.CodeSeat codeSeat, i iVar, t tVar) {
        super(codeSeat, iVar, tVar);
    }

    @Override // be.c
    public AdCache G() {
        return AdCacheManager.getCache(7);
    }
    ...
    public BaseVideo e(boolean z10) {
        ...
        this.f16443i = cache;
        if (cache == null) {
            AdLogUtil.Log().w("RewardedInterstitialCacheHandler", "no ad");
            return null;
        }
        G().removeCache(this.f16444j, (BaseVideo) this.f16443i);
        if (((BaseVideo) this.f16443i).isExpired()) {
            AdLogUtil.Log().w("RewardedInterstitialCacheHandler", "ad is expired");
            return null;
        }
