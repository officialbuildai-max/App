...
public abstract class c {
    ...
    private static WindowManager f71089a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f71090b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f71091c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b b(JSONObject jSONObject) {
        ...
        if (f71089a != null) {
            ...
            f71089a.getDefaultDisplay().getRealSize(point);
            f11 = a(point.x);
            f12 = a(point.y);
        } else {
            f11 = 0.0f;
    ...
    public static void d(Context context) {
        if (context != null) {
            f71091c = context.getResources().getDisplayMetrics().density;
            f71089a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void f(JSONObject jSONObject, a.C0463a c0463a) {
        com.iab.omid.library.mmadbridge.internal.e a11 = c0463a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator it = c0463a.c().iterator();
        while (it.hasNext()) {
    ...
    private static boolean k(OutputDeviceStatus outputDeviceStatus) {
        return a.f71092a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void m(JSONObject jSONObject) {
        b b11 = b(jSONObject);
        try {
            jSONObject.put("width", b11.f71093a);
            jSONObject.put("height", b11.f71094b);
        } catch (JSONException e11) {
            e11.printStackTrace();
        }
    }
