...
public final class b implements Application.ActivityLifecycleCallbacks {
    ...
    private static final CopyOnWriteArrayList f79577b = new CopyOnWriteArrayList();

    /* renamed from: c, reason: collision with root package name */
    private static final Lazy f79578c = LazyKt.b(new Function0() { // from class: zs.a
    ...
    private final List e() {
        return (List) f79578c.getValue();
    }

    public final void f(int i11, Activity activity) {
        Intrinsics.h(activity, "activity");
        try {
            CopyOnWriteArrayList copyOnWriteArrayList = f79577b;
