...
public final class c {
    ...
    private static Integer[] f62131b = {120, 180, 240, 360, 540, 720, 1080};

    /* renamed from: c, reason: collision with root package name */
    private static LruCache f62132c = new LruCache(600);

    private c() {
    }

    private final int f(int i11) {
        int intValue = ((Number) ArraysKt.q0(f62131b)).intValue();
        for (Integer num : f62131b) {
    ...
    public final int c(String url) {
        Intrinsics.h(url, "url");
        Integer num = (Integer) f62132c.get(url);
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public final String d(String url, int i11, boolean z10, boolean z11, int i12, boolean z12, boolean z13, boolean z14, int i13) {
        ...
        if (intValue != f11 && !z13) {
            f62132c.put(url, Integer.valueOf(f11));
        }
