...
import com.transsion.shorttv_pugc.base.image.blurhash.BlurHash;
import kotlin.Unit;
...
public final class b {
    ...
    public static final a f62118a = new a(null);

    /* renamed from: b, reason: collision with root package name */
    private static int f62119b = y.e() / 3;

    /* renamed from: c, reason: collision with root package name */
    private static int f62120c = y.b() / 2;

    /* renamed from: d, reason: collision with root package name */
    private static int f62121d = y.c();

    /* renamed from: e, reason: collision with root package name */
    private static final BlurHash f62122e;

    /* renamed from: f, reason: collision with root package name */
    private static final DrawableTransitionOptions f62123f;
    ...
    public static final class a {
        ...
        /* loaded from: classes7.dex */
        public static final class C0770a implements RequestListener {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ long f62124a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function3 f62125b;

            C0770a(long j11, Function3 function3) {
                this.f62124a = j11;
                this.f62125b = function3;
            }
            ...
            public boolean onResourceReady(Drawable resource, Object model, Target target, DataSource dataSource, boolean z10) {
                ...
                long currentTimeMillis = System.currentTimeMillis() - this.f62124a;
                Function3 function3 = this.f62125b;
                if (function3 != null) {
                }
                return false;
            }
        ...
        /* loaded from: classes7.dex */
        public static final class C0771b implements RequestListener {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ long f62126a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function3 f62127b;

            C0771b(long j11, Function3 function3) {
                this.f62126a = j11;
                this.f62127b = function3;
            }
            ...
            public boolean onResourceReady(Drawable resource, Object model, Target target, DataSource dataSource, boolean z10) {
                ...
                Intrinsics.h(model, "model");
                Intrinsics.h(dataSource, "dataSource");
                long currentTimeMillis = System.currentTimeMillis() - this.f62126a;
                Function3 function3 = this.f62127b;
                if (function3 != null) {
                }
                return false;
            }
        ...
        public static final class c implements RequestListener {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ long f62128a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function3 f62129b;

            c(long j11, Function3 function3) {
                this.f62128a = j11;
                this.f62129b = function3;
            }
            ...
            public boolean onResourceReady(Drawable resource, Object model, Target target, DataSource dataSource, boolean z10) {
                ...
                Intrinsics.h(model, "model");
                Intrinsics.h(dataSource, "dataSource");
                long currentTimeMillis = System.currentTimeMillis() - this.f62128a;
                Function3 function3 = this.f62129b;
                if (function3 != null) {
                }
                return false;
            }
        ...
        */
        private final void f(android.content.Context r18, final android.widget.ImageView r19, java.lang.String r20, int r21, int r22, int r23, int r24, boolean r25, java.lang.String r26, boolean r27, boolean r28, boolean r29, boolean r30, boolean r31, int r32, com.bumptech.glide.Priority r33, kotlin.jvm.functions.Function3 r34) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: et.b.a.f(android.content.Context, android.widget.ImageView, java.lang.String, int, int, int, int, boolean, java.lang.String, boolean, boolean, boolean, boolean, boolean, int, com.bumptech.glide.Priority, kotlin.jvm.functions.Function3):void");
        }
        ...
        public final String d(String url, int i11, int i12, boolean z10, boolean z11, boolean z12, int i13) {
            ...
            d11 = et.c.f62130a.d(url, i11, (r23 & 4) != 0 ? true : z10, (r23 & 8) != 0, (r23 & 16) != 0 ? 0 : 0, (r23 & 32) != 0 ? false : false, (r23 & 64) != 0 ? false : z11, (r23 & 128) != 0 ? false : z12, (r23 & 256) != 0 ? 25 : i13);
            return d11;
        }
        ...
        public final void i(Context context, ImageView imageView, String url, int i11, int i12, int i13, int i14, boolean z10, String thumbnail, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, int i15) {
            ...
            if (url.length() == 0) {
                Glide.with(context).load2("").transition(b.f62123f).apply((BaseRequestOptions<?>) p(this, i11, i14, z13 ? i13 : -1, z13 ? i12 : -1, null, 16, null)).into(imageView);
                return;
            }
            try {
    ...
    static {
        ...
        f62122e = new BlurHash(a11, 5, 0.6f);
