...
@Metadata(d1 = {"okio/Okio__JvmOkioKt", "okio/Okio__OkioKt"}, k = 4, mv = {1, 9, 0}, xi = Sdk$SDKMetric.SDKMetricType.AD_SHOW_TO_VALIDATION_DURATION_MS_VALUE)
...
public final class Okio {
    ...
    public static final <T extends Closeable, R> R use(T t11, Function1<? super T, ? extends R> function1) {
        return (R) Okio__OkioKt.use(t11, function1);
    }
}
