...
public final class HashingSink extends ForwardingSink implements Sink {
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007J\u0018\u0010\t\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007J\u0018\u0010\n\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007J\u0010\u0010\u000b\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\f\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\r\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\u000e\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u000f"}, d2 = {"Lokio/HashingSink$Companion;", "", "()V", "hmacSha1", "Lokio/HashingSink;", "sink", "Lokio/Sink;", "key", "Lokio/ByteString;", "hmacSha256", "hmacSha512", "md5", "sha1", "sha256", "sha512", "okio"}, k = 1, mv = {1, 9, 0}, xi = Sdk$SDKMetric.SDKMetricType.AD_SHOW_TO_VALIDATION_DURATION_MS_VALUE)
    /* loaded from: classes7.dex */
    public static final class Companion {
        ...
        public final HashingSink sha1(Sink sink) {
            Intrinsics.h(sink, "sink");
            return new HashingSink(sink, EncoderUtil.ALGORITHM_SHA_1);
        }

        @JvmStatic
        public final HashingSink sha256(Sink sink) {
            Intrinsics.h(sink, "sink");
            return new HashingSink(sink, EncoderUtil.ALGORITHM_SHA_256);
        }

        @JvmStatic
        public final HashingSink sha512(Sink sink) {
            Intrinsics.h(sink, "sink");
            return new HashingSink(sink, EncoderUtil.ALGORITHM_SHA_512);
        }
    }
    ...
    */
    ...
    public final ByteString m1359deprecated_hash() {
        return hash();
    }
    ...
    public void write(Buffer source, long byteCount) throws IOException {
        ...
        long j11 = 0;
        while (j11 < byteCount) {
            int min = (int) Math.min(byteCount - j11, segment.limit - segment.pos);
            MessageDigest messageDigest = this.messageDigest;
            if (messageDigest != null) {
