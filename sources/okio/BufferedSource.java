...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(byte b11, long fromIndex) throws IOException;

    long indexOf(byte b11, long fromIndex, long toIndex) throws IOException;
