...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            CollectionsKt.B(this.interceptors, okHttpClient.interceptors());
            CollectionsKt.B(this.networkInterceptors, okHttpClient.networkInterceptors());
        ...
        public final Builder m1314addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m1315addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.h(block, "block");
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            ...
            if (!Intrinsics.c(certificatePinner, this.certificatePinner)) {
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> connectionSpecs) {
            ...
            if (!Intrinsics.c(connectionSpecs, this.connectionSpecs)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            ...
            if (!Intrinsics.c(hostnameVerifier, this.hostnameVerifier)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            List U0 = CollectionsKt.U0(protocols);
            ...
            Intrinsics.f(U0, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Protocol?>");
            if (U0.contains(null)) {
                throw new IllegalArgumentException("protocols must not contain null");
            }
            U0.remove(Protocol.SPDY_3);
            if (!Intrinsics.c(U0, this.protocols)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            ...
            if (!Intrinsics.c(proxyAuthenticator, this.proxyAuthenticator)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            if (!Intrinsics.c(proxySelector, this.proxySelector)) {
                this.routeDatabase = null;
            }
        ...
        public final void setCertificatePinner$okhttp(CertificatePinner certificatePinner) {
            Intrinsics.h(certificatePinner, "<set-?>");
            this.certificatePinner = certificatePinner;
        }
        ...
        public final void setSocketFactory$okhttp(SocketFactory socketFactory) {
            Intrinsics.h(socketFactory, "<set-?>");
            this.socketFactory = socketFactory;
        }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!Intrinsics.c(socketFactory, this.socketFactory)) {
                this.routeDatabase = null;
            }
            this.socketFactory = socketFactory;
            return this;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            if (!Intrinsics.c(sslSocketFactory, this.sslSocketFactoryOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sslSocketFactory;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            ...
            if (!Intrinsics.c(sslSocketFactory, this.sslSocketFactoryOrNull) || !Intrinsics.c(trustManager, this.x509TrustManagerOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sslSocketFactory;
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, d2 = {"Lokhttp3/OkHttpClient$Companion;", "", "()V", "DEFAULT_CONNECTION_SPECS", "", "Lokhttp3/ConnectionSpec;", "getDEFAULT_CONNECTION_SPECS$okhttp", "()Ljava/util/List;", "DEFAULT_PROTOCOLS", "Lokhttp3/Protocol;", "getDEFAULT_PROTOCOLS$okhttp", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = Sdk$SDKMetric.SDKMetricType.AD_SHOW_TO_VALIDATION_DURATION_MS_VALUE)
    /* loaded from: classes7.dex */
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).getIsTls()) {
                    if (builder.getSslSocketFactoryOrNull() != null) {
                        ...
                        Intrinsics.e(x509TrustManagerOrNull);
                        ...
                        Platform platform = companion.get();
                        Intrinsics.e(platformTrustManager);
    ...
    private final void verifyClientState() {
        ...
        if (!Intrinsics.c(this.certificatePinner, CertificatePinner.DEFAULT)) {
            throw new IllegalStateException("Check failed.");
        }
    }
    ...
    public final List<ConnectionSpec> m1294deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Interceptor> m1302deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m1303deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m1305deprecated_protocols() {
        return this.protocols;
    }
    ...
    public final SSLSocketFactory m1312deprecated_sslSocketFactory() {
