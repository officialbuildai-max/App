...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, ComparisonsKt.g());
        } else {
    ...
    public final List<CipherSuite> m1231deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1233deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), ComparisonsKt.g())) {
            return false;
        }
