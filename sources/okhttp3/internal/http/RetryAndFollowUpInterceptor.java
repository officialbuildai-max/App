...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response userResponse, String method) {
        ...
        HttpUrl resolve;
        if (!this.client.followRedirects() || (header$default = Response.header$default(userResponse, com.alibaba.sdk.android.oss.common.utils.HttpHeaders.LOCATION, null, 2, null)) == null || (resolve = userResponse.request().url().resolve(header$default)) == null) {
            return null;
        }
        if (!Intrinsics.c(resolve.scheme(), userResponse.request().url().scheme()) && !this.client.followSslRedirects()) {
            return null;
        }
    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L99:
            ...
            java.util.List r2 = kotlin.collections.CollectionsKt.C0(r2, r6)     // Catch: java.lang.Throwable -> L42
        La9:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r3
            goto L19
