        ...
        synchronized (strArr) {
            try {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    ...
                    if (dateFormat == null) {
                        dateFormat = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i11], Locale.US);
