...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        @JvmOverloads
        public Reader(Source source, int i11) {
            this(source, i11, 0, 4, null);
            Intrinsics.h(source, "source");
        }

        @JvmOverloads
        public Reader(Source source, int i11, int i12) {
            Intrinsics.h(source, "source");
        ...
        private final void clearDynamicTable() {
            ArraysKt.A(this.dynamicTable, null, 0, 0, 6, null);
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> R0 = CollectionsKt.R0(this.headerList);
    ...
    public static final class Writer {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        @JvmOverloads
        public Writer(int i11, Buffer out) {
            this(i11, false, out, 2, null);
            Intrinsics.h(out, "out");
        }

        @JvmOverloads
        public Writer(int i11, boolean z10, Buffer out) {
            Intrinsics.h(out, "out");
            this.headerTableSizeSetting = i11;
        ...
        public /* synthetic */ Writer(int i11, boolean z10, Buffer buffer, int i12, DefaultConstructorMarker defaultConstructorMarker) {
            this((i12 & 1) != 0 ? 4096 : i11, (i12 & 2) != 0 ? true : z10, buffer);
        }
        ...
        public final void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i14 = 0; i14 < size; i14++) {
                ...
                if (num != null) {
                    ...
                    i12 = intValue + 1;
                    if (2 <= i12 && i12 < 8) {
                        if (Intrinsics.c(hpack.getSTATIC_HEADER_TABLE()[intValue].value, byteString)) {
                            i11 = i12;
                        } else if (Intrinsics.c(hpack.getSTATIC_HEADER_TABLE()[i12].value, byteString)) {
                            i11 = i12;
                            i12 = intValue + 2;
                        }
                    }
                ...
                if (i12 == -1) {
                    ...
                    while (true) {
                        ...
                        Intrinsics.e(header2);
                        if (Intrinsics.c(header2.name, asciiLowercase)) {
                            Header header3 = this.dynamicTable[i15];
                            Intrinsics.e(header3);
                            if (Intrinsics.c(header3.value, byteString)) {
                ...
                } else if (!asciiLowercase.startsWith(Header.PSEUDO_PREFIX) || Intrinsics.c(Header.TARGET_AUTHORITY, asciiLowercase)) {
                    writeInt(i11, Hpack.PREFIX_6_BITS, 64);
                    writeByteString(byteString);
                    insertIntoDynamicTable(header);
                } else {
                    writeInt(i11, 15, 0);
    ...
    static {
        ...
        STATIC_HEADER_TABLE = new Header[]{header, header2, header3, header4, header5, header6, header7, new Header(byteString4, MsgShowStatus.STATUS_OK), new Header(byteString4, "204"), new Header(byteString4, "206"), new Header(byteString4, "304"), new Header(byteString4, "400"), new Header(byteString4, "404"), new Header(byteString4, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header(BufferQueue.CONTENT_ENCODING, ""), new Header("content-language", ""), new Header(BufferQueue.CONTENT_LENGTH, ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header("date", ""), new Header(DownloadModel.ETAG, ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header(RequestParameters.SUBRESOURCE_LOCATION, ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header(RequestParameters.SUBRESOURCE_REFERER, ""), new Header(ToolBar.REFRESH, ""), new Header("retry-after", ""), new Header(TmcConstants.CHANNEL_REQUEST_SERVER, ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
