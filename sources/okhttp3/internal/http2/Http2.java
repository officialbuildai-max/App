...
public final class Http2 {
    ...
    static {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            ...
            Intrinsics.g(binaryString, "toBinaryString(it)");
            strArr[i11] = StringsKt.P(Util.format("%8s", binaryString), ' ', '0', false, 4, null);
        }
        BINARY = strArr;
