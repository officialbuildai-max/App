...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() {
            ...
            try {
                ...
                String obj = StringsKt.n1(this.this$0.source.readUtf8LineStrict()).toString();
                if (this.bytesRemainingInChunk < 0 || (obj.length() > 0 && !StringsKt.W(obj, ";", false, 2, null))) {
    ...
    private final boolean isChunked(Request request) {
        return StringsKt.H("chunked", request.header("Transfer-Encoding"), true);
    }

    private final boolean isChunked(Response response) {
        return StringsKt.H("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true);
    }
