...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder m841clone = m841clone();
        m841clone.serializeInnerClasses = false;
        return m841clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            m841clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z11) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            m841clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m841clone = m841clone();
        m841clone.modifiers = 0;
        for (int i11 : iArr) {
            m841clone.modifiers = i11 | m841clone.modifiers;
        }
        return m841clone;
    }
