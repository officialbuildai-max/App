...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        ...
        public final TypeAdapterFactory createDefaultsAdapterFactory() {
            int i11 = 2;
            return createFactory(new DefaultDateTypeAdapter<>(this, i11, i11));
        }

        protected abstract T deserialize(Date date);
    }

    private DefaultDateTypeAdapter(DateType<T> dateType, int i11) {
    ...
    private DefaultDateTypeAdapter(DateType<T> dateType, int i11, int i12) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        Objects.requireNonNull(dateType);
        this.dateType = dateType;
