...
final class DescendingImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public ImmutableSortedSet<E> headSetImpl(E e11, boolean z10) {
        return this.forward.tailSet((ImmutableSortedSet<E>) e11, z10).descendingSet();
    }
    ...
    ImmutableSortedSet<E> subSetImpl(E e11, boolean z10, E e12, boolean z11) {
        return this.forward.subSet((boolean) e12, z11, (boolean) e11, z10).descendingSet();
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    ImmutableSortedSet<E> tailSetImpl(E e11, boolean z10) {
        return this.forward.headSet((ImmutableSortedSet<E>) e11, z10).descendingSet();
    }
