...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        static {
            ...
            GROUP = fieldType10;
            int i11 = 2;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, javaType3, i11) { // from class: com.google.protobuf.WireFormat.FieldType.3
                {
                    a aVar = null;
                }
            ...
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, i11) { // from class: com.google.protobuf.WireFormat.FieldType.4
                {
                    a aVar = null;
                }
        ...
        /* synthetic */ FieldType(String str, int i11, JavaType javaType, int i12, a aVar) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object readPrimitiveField(i iVar, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (a.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
                return Double.valueOf(iVar.readDouble());
            case 2:
                return Float.valueOf(iVar.readFloat());
            case 3:
                return Long.valueOf(iVar.readInt64());
            case 4:
                return Long.valueOf(iVar.readUInt64());
            case 5:
                return Integer.valueOf(iVar.readInt32());
            case 6:
                return Long.valueOf(iVar.readFixed64());
            case 7:
                return Integer.valueOf(iVar.readFixed32());
            case 8:
                return Boolean.valueOf(iVar.readBool());
            case 9:
                return iVar.readBytes();
            case 10:
                return Integer.valueOf(iVar.readUInt32());
            case 11:
                return Integer.valueOf(iVar.readSFixed32());
            case 12:
                return Long.valueOf(iVar.readSFixed64());
            case 13:
                return Integer.valueOf(iVar.readSInt32());
            case 14:
                return Long.valueOf(iVar.readSInt64());
            case 15:
                return utf8Validation.readString(iVar);
            case 16:
