...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f32863id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i11, int i12, Collection collection, JavaType javaType) {
        ...
        int i14 = a.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i14 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i13 = a.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i13 == 2 || i13 == 3) ? false : true;
    }
