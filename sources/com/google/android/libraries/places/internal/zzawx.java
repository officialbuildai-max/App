...
public final class zzawx {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzawx.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j11, byte b11) {
        zzaww zzawwVar = zzf;
        long j12 = (-4) & j11;
        int i11 = zzawwVar.zza.getInt(obj, j12);
        int i12 = ((~((int) j11)) & 3) << 3;
        zzawwVar.zza.putInt(obj, j12, ((255 & b11) << i12) | (i11 & (~(255 << i12))));
    }
    ...
    public static void zzE(Object obj, long j11, byte b11) {
        ...
        long j12 = (-4) & j11;
        int i11 = (((int) j11) & 3) << 3;
        zzawwVar.zza.putInt(obj, j12, ((255 & b11) << i11) | (zzawwVar.zza.getInt(obj, j12) & (~(255 << i11))));
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th2) {
        Logger.getLogger(zzawx.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
    }
