...
public abstract class zzaa {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzaa(String str, int i11) {
        this.zza = str;
        this.zzb = i11;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Boolean zza(double d11, zzfo.zzd zzdVar) {
        try {
            return zza(new BigDecimal(d11), zzdVar, Math.ulp(d11));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Boolean zza(long j11, zzfo.zzd zzdVar) {
        try {
            return zza(new BigDecimal(j11), zzdVar, 0.0d);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
    ...
    public static Boolean zza(String str, zzfo.zzf zzfVar, zzgo zzgoVar) {
        ...
        return zza(str, zzb2, zzg, zze, list, zzb2 == zzfo.zzf.zzb.REGEXP ? zze : null, zzgoVar);
    }
