...
public interface zzt extends IInterface {
    ...
    void setAlpha(float f11) throws RemoteException;

    void setAnchor(float f11, float f12) throws RemoteException;

    void setDraggable(boolean z10) throws RemoteException;

    void setFlat(boolean z10) throws RemoteException;

    void setInfoWindowAnchor(float f11, float f12) throws RemoteException;

    void setPosition(LatLng latLng) throws RemoteException;

    void setRotation(float f11) throws RemoteException;
