...
public interface zzk extends IInterface {
    ...
    void setBearing(float f11) throws RemoteException;

    void setClickable(boolean z10) throws RemoteException;

    void setDimensions(float f11) throws RemoteException;

    void setPosition(LatLng latLng) throws RemoteException;

    void setPositionFromBounds(LatLngBounds latLngBounds) throws RemoteException;

    void setTransparency(float f11) throws RemoteException;

    void setVisible(boolean z10) throws RemoteException;

    void setZIndex(float f11) throws RemoteException;

    void zza(float f11, float f12) throws RemoteException;
