...
final class zzfm extends zzfq {
    ...
    public final void zza(Object obj, long j11) {
        ...
        List list = (List) zzhn.zzf(obj, j11);
        ...
        zzhn.zzs(obj, j11, unmodifiableList);
    }
    ...
    public final void zzb(Object obj, Object obj2, long j11) {
        zzfj zzfjVar;
        List list = (List) zzhn.zzf(obj2, j11);
        int size = list.size();
        List list2 = (List) zzhn.zzf(obj, j11);
        if (list2.isEmpty()) {
