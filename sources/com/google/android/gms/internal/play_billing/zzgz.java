...
public class zzgz extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i12 = 0;
        if (i11 >= 0) {
            int compareTo = comparable.compareTo(((zzgt) this.zzb.get(i11)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int compareTo2 = comparable.compareTo(((zzgt) this.zzb.get(i13)).zza());
            if (compareTo2 < 0) {
                i11 = i13 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final Object zzl(int i11) {
        zzn();
        Object value = ((zzgt) this.zzb.remove(i11)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i11 = 0; i11 < zzb; i11++) {
            if (!zzg(i11).equals(zzgzVar.zzg(i11))) {
                return false;
            }
        }
        if (zzb != size) {
    ...
    public final int hashCode() {
        ...
        for (int i12 = 0; i12 < zzb; i12++) {
            i11 += ((zzgt) this.zzb.get(i12)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i12 = this.zza;
        if (size == i12) {
            zzgt zzgtVar = (zzgt) this.zzb.remove(i12 - 1);
            zzm().put(zzgtVar.zza(), zzgtVar.getValue());
        }
        this.zzb.add(i11, new zzgt(this, comparable, obj));
        return null;
    }
