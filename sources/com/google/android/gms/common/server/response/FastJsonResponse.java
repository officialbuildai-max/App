...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public Field(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) boolean z10, @SafeParcelable.Param(id = 4) int i13, @SafeParcelable.Param(id = 5) boolean z11, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) int i14, @Nullable @SafeParcelable.Param(id = 8) String str2, @Nullable @SafeParcelable.Param(id = 9) com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i11;
            this.zaa = i12;
            this.zab = z10;
            this.zac = i13;
        ...
        protected Field(int i11, boolean z10, int i12, boolean z11, @NonNull String str, int i13, @Nullable Class cls, @Nullable FieldConverter fieldConverter) {
            this.zai = 1;
            this.zaa = i11;
            this.zab = z10;
            this.zac = i12;
        ...
        @NonNull
        @KeepForSdk
        public static Field withConverter(@NonNull String str, int i11, @NonNull FieldConverter<?, ?> fieldConverter, boolean z10) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z10, 0, false, str, i11, null, fieldConverter);
        }
    ...
    protected void zar(@NonNull Field field, @NonNull String str, float f11) {
