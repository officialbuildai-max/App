...
public class SafeParcelReader {
    ...
    public static int readSize(@NonNull Parcel parcel, int i11) {
        return (i11 & FlowLayout.SPACING_AUTO) != -65536 ? (char) (i11 >> 16) : parcel.readInt();
    }
    ...
    private static void zzb(Parcel parcel, int i11, int i12) {
        ...
        throw new ParseException("Expected size " + i12 + " got " + readSize + " (0x" + Integer.toHexString(readSize) + ")", parcel);
    }
}
