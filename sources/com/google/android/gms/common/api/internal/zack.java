...
public final class zack extends RegisterListenerMethod {
    ...
    public zack(RegistrationMethods.Builder builder, ListenerHolder listenerHolder, Feature[] featureArr, boolean z10, int i11) {
        super(listenerHolder, featureArr, z10, i11);
        this.zaa = builder;
    }
