...
public final class zaaa implements zaca {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i11, boolean z10) {
        zaaaVar.zab.zac(i11, z10);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), client.getSignInIntent(), com.google.android.gms.internal.base.zap.zaa | ASTNode.NOJIT);
    }
    ...
    @Override // com.google.android.gms.common.api.internal.zaca
    public final ConnectionResult zac(long j11, @NonNull TimeUnit timeUnit) {
        throw new UnsupportedOperationException();
    }
