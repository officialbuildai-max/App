...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzdVar2 = (zzd) fragmentActivity.getSupportFragmentManager().k0("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                fragmentActivity.getSupportFragmentManager().p().e(zzdVar2, "SupportLifecycleFragmentImpl").j();
            }
