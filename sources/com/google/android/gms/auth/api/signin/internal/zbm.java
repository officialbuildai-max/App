...
public final class zbm {
    ...
    public static Intent zbc(Context context, GoogleSignInOptions googleSignInOptions) {
        ...
        bundle.putParcelable(XLogUtil.TAG, signInConfiguration);
        intent.putExtra(XLogUtil.TAG, bundle);
        return intent;
    }
    ...
    */
    ...
    public static PendingResult zbf(GoogleApiClient googleApiClient, Context context, boolean z10) {
        ...
        zbh(context);
        return z10 ? zbb.zba(savedRefreshToken) : googleApiClient.execute(new zbk(googleApiClient));
    }
    ...
    public static PendingResult zbg(GoogleApiClient googleApiClient, Context context, boolean z10) {
        ...
        zbh(context);
        return z10 ? PendingResults.immediatePendingResult(Status.RESULT_SUCCESS, googleApiClient) : googleApiClient.execute(new zbi(googleApiClient));
    }
