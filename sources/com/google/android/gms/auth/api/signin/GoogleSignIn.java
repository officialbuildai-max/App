...
public final class GoogleSignIn {
    ...
    public static void requestPermissions(@NonNull Activity activity, int i11, @Nullable GoogleSignInAccount googleSignInAccount, @NonNull GoogleSignInOptionsExtension googleSignInOptionsExtension) {
    ...
    public static void requestPermissions(@NonNull Activity activity, int i11, @Nullable GoogleSignInAccount googleSignInAccount, @NonNull Scope... scopeArr) {
        Preconditions.checkNotNull(activity, "Please provide a non-null Activity");
    ...
    public static void requestPermissions(@NonNull Fragment fragment, int i11, @Nullable GoogleSignInAccount googleSignInAccount, @NonNull GoogleSignInOptionsExtension googleSignInOptionsExtension) {
    ...
    public static void requestPermissions(@NonNull Fragment fragment, int i11, @Nullable GoogleSignInAccount googleSignInAccount, @NonNull Scope... scopeArr) {
        Preconditions.checkNotNull(fragment, "Please provide a non-null Fragment");
        Preconditions.checkNotNull(scopeArr, "Please provide at least one scope");
