...
public final class zzs extends zzbz {
    ...
    static {
        ...
        aVar.put(NativeComponentConstants.KEY_COMPONENT_RESULT_SUCCESS, FastJsonResponse.Field.forStrings(NativeComponentConstants.KEY_COMPONENT_RESULT_SUCCESS, 4));
    ...
    public zzs(@SafeParcelable.Param(id = 1) int i11, @Nullable @SafeParcelable.Param(id = 2) List list, @Nullable @SafeParcelable.Param(id = 3) List list2, @Nullable @SafeParcelable.Param(id = 4) List list3, @Nullable @SafeParcelable.Param(id = 5) List list4, @Nullable @SafeParcelable.Param(id = 6) List list5) {
        this.zza = i11;
        this.zzc = list;
        this.zzd = list2;
        this.zze = list3;
