...
public class DeviceMetaData extends AbstractSafeParcelable {
    ...
    public DeviceMetaData(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) boolean z10, @SafeParcelable.Param(id = 3) long j11, @SafeParcelable.Param(id = 4) boolean z11) {
        this.zza = i11;
        this.zzb = z10;
        this.zzc = j11;
        this.zzd = z11;
