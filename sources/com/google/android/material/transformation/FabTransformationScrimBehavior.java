...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private final i f30235c;

    /* renamed from: d, reason: collision with root package name */
    private final i f30236d;
    ...
    public FabTransformationScrimBehavior() {
        this.f30235c = new i(75L, 150L);
        this.f30236d = new i(0L, 150L);
    }
    ...
    private void K(View view, boolean z10, boolean z11, List list, List list2) {
        ...
        i iVar = z10 ? this.f30235c : this.f30236d;
        if (z10) {
            if (!z11) {
                view.setAlpha(0.0f);
            }
