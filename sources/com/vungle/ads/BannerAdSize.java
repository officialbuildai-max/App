...
public enum BannerAdSize {
    ...
    BannerAdSize(String str, int i11, int i12) {
        this.sizeName = str;
        this.width = i11;
        this.height = i12;
    }
