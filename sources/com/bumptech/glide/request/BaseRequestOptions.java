...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public T apply(@NonNull BaseRequestOptions<?> baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().apply(baseRequestOptions);
        }
    ...
    public T decode(@NonNull Class<?> cls) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().decode(cls);
        }
    ...
    public T diskCacheStrategy(@NonNull DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public T dontTransform() {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().dontTransform();
        }
        this.transformations.clear();
        int i11 = this.fields;
        this.isTransformationRequired = false;
    ...
    public T error(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().error(drawable);
        }
    ...
    public T fallback(int i11) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().fallback(i11);
        }
        this.fallbackId = i11;
    ...
    public T fallback(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().fallback(drawable);
        }
    ...
    public T onlyRetrieveFromCache(boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().onlyRetrieveFromCache(z10);
        }
    ...
    final T optionalTransform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    public T override(int i11, int i12) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().override(i11, i12);
        }
    ...
    public T placeholder(int i11) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().placeholder(i11);
        }
    ...
    public T placeholder(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().placeholder(drawable);
        }
    ...
    public T priority(@NonNull Priority priority) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().priority(priority);
        }
    ...
    T removeOption(@NonNull Option<?> option) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().removeOption(option);
        }
    ...
    public <Y> T set(@NonNull Option<Y> option, @NonNull Y y10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().set(option, y10);
        }
    ...
    public T signature(@NonNull Key key) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().signature(key);
        }
    ...
    public T sizeMultiplier(float f11) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().sizeMultiplier(f11);
        }
    ...
    public T skipMemoryCache(boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().skipMemoryCache(true);
        }
    ...
    public T theme(@Nullable Resources.Theme theme) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().theme(theme);
        }
        this.theme = theme;
        if (theme != null) {
            this.fields |= 32768;
    ...
    @NonNull
    T transform(@NonNull Transformation<Bitmap> transformation, boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().transform(transformation, z10);
        }
    ...
    final T transform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    @NonNull
    <Y> T transform(@NonNull Class<Y> cls, @NonNull Transformation<Y> transformation, boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().transform(cls, transformation, z10);
        }
    ...
    public T useAnimationPool(boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().useAnimationPool(z10);
        }
    ...
    public T useUnlimitedSourceGeneratorsPool(boolean z10) {
        if (this.isAutoCloneEnabled) {
            return (T) mo649clone().useUnlimitedSourceGeneratorsPool(z10);
        }
