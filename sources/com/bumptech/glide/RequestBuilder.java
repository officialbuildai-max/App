...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    private Request buildRequestRecursive(Object obj, Target<TranscodeType> target, @Nullable RequestListener<TranscodeType> requestListener, @Nullable RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i11, int i12, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        Request buildThumbnailRequestRecursive = buildThumbnailRequestRecursive(obj, target, requestListener, requestCoordinator3, transitionOptions, priority, i11, i12, baseRequestOptions, executor);
    ...
    private RequestBuilder<TranscodeType> cloneWithNullErrorAndThumbnail() {
        return mo649clone().error((RequestBuilder) null).thumbnail((RequestBuilder) null);
    }
    ...
    public RequestBuilder<TranscodeType> addListener(@Nullable RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo649clone().addListener(requestListener);
        }
    ...
    @CheckResult
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> mo649clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.mo649clone();
        requestBuilder.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) requestBuilder.transitionOptions.m650clone();
        ...
        if (requestBuilder2 != null) {
            requestBuilder.thumbnailBuilder = requestBuilder2.mo649clone();
        }
        RequestBuilder<TranscodeType> requestBuilder3 = requestBuilder.errorBuilder;
        if (requestBuilder3 != null) {
            requestBuilder.errorBuilder = requestBuilder3.mo649clone();
        }
    ...
    public RequestBuilder<TranscodeType> error(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
        if (isAutoCloneEnabled()) {
            return mo649clone().error((RequestBuilder) requestBuilder);
        }
    ...
    public RequestBuilder<TranscodeType> error(Object obj) {
        return obj == null ? error((RequestBuilder) null) : error((RequestBuilder) cloneWithNullErrorAndThumbnail().load2(obj));
    }
    ...
    @NonNull
    <Y extends Target<TranscodeType>> Y into(@NonNull Y y10, @Nullable RequestListener<TranscodeType> requestListener, Executor executor) {
    ...
    public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView imageView) {
        ...
        if (!isTransformationSet() && isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (AnonymousClass1.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
                    requestBuilder = mo649clone().optionalCenterCrop();
                    break;
                case 2:
                    requestBuilder = mo649clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    requestBuilder = mo649clone().optionalFitCenter();
                    break;
                case 6:
                    requestBuilder = mo649clone().optionalCenterInside();
                    break;
    ...
    public RequestBuilder<TranscodeType> listener(@Nullable RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo649clone().listener(requestListener);
        }
    ...
    @CheckResult
    /* renamed from: load */
    public RequestBuilder<TranscodeType> load2(@Nullable Integer num) {
    ...
    public RequestBuilder<TranscodeType> thumbnail(float f11) {
        if (isAutoCloneEnabled()) {
            return mo649clone().thumbnail(f11);
        }
    ...
    public RequestBuilder<TranscodeType> thumbnail(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
        if (isAutoCloneEnabled()) {
            return mo649clone().thumbnail(requestBuilder);
        }
    ...
    public RequestBuilder<TranscodeType> transition(@NonNull TransitionOptions<?, ? super TranscodeType> transitionOptions) {
        if (isAutoCloneEnabled()) {
            return mo649clone().transition(transitionOptions);
        }
