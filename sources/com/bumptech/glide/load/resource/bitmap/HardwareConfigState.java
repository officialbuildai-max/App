...
public final class HardwareConfigState {
    ...
    public boolean isHardwareConfigAllowed(int i11, int i12, boolean z10, boolean z11) {
        if (!z10) {
    ...
    @TargetApi(26)
    public boolean setHardwareConfigIfAllowed(int i11, int i12, BitmapFactory.Options options, boolean z10, boolean z11) {
        Bitmap.Config config;
        boolean isHardwareConfigAllowed = isHardwareConfigAllowed(i11, i12, z10, z11);
