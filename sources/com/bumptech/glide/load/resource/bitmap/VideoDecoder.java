...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    private boolean isUnsupportedFormat(@NonNull T t11, MediaMetadataRetriever mediaMetadataRetriever) {
        ...
        try {
            ...
            for (int i11 = 0; i11 < trackCount; i11++) {
                if (MimeTypes.VIDEO_VP8.equals(mediaExtractor2.getTrackFormat(i11).getString("mime"))) {
    ...
    public Resource<Bitmap> decode(@NonNull T t11, int i11, int i12, @NonNull Options options) throws IOException {
        ...
        try {
            ...
            return BitmapResource.obtain(decodeFrame(t11, build, longValue, num.intValue(), i11, i12, downsampleStrategy2), this.bitmapPool);
        } finally {
