...
public class GifFrameLoader {
    ...
    public GifFrameLoader(Glide glide, GifDecoder gifDecoder, int i11, int i12, Transformation<Bitmap> transformation, Bitmap bitmap) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder, null, getRequestBuilder(Glide.with(glide.getContext()), i11, i12), transformation, bitmap);
    }
    ...
    private void loadNextFrame() {
        ...
        this.requestBuilder.apply((BaseRequestOptions<?>) RequestOptions.signatureOf(getFrameSignature())).load2((Object) this.gifDecoder).into((RequestBuilder<Bitmap>) this.next);
    }
