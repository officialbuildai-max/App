...
public final class Option<T> {
    ...
    private Option(@NonNull String str, @Nullable T t11, @NonNull CacheKeyUpdater<T> cacheKeyUpdater) {
    ...
    @NonNull
    public static <T> Option<T> disk(@NonNull String str, @Nullable T t11, @NonNull CacheKeyUpdater<T> cacheKeyUpdater) {
