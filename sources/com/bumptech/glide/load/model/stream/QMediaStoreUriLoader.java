...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        QMediaStoreUriFetcher(Context context, ModelLoader<File, DataT> modelLoader, ModelLoader<Uri, DataT> modelLoader2, Uri uri, int i11, int i12, Options options, Class<DataT> cls) {
