...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    private static final Set<String> SCHEMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(OfflineConstantsKt.OFFLINE_DOWNLOAD_SEARCH_MODE_FILE, "content", "android.resource")));
