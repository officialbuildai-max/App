...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public static class DecodeJobFactory {
        ...
        final f pool = FactoryPools.threadSafe(Engine.JOB_POOL_SIZE, new FactoryPools.Factory<DecodeJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.DecodeJobFactory.1
        ...
        <R> DecodeJob<R> build(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z10, boolean z11, boolean z12, Options options, DecodeJob.Callback<R> callback) {
            ...
            return decodeJob.init(glideContext, obj, engineKey, key, i11, i12, cls, cls2, priority, diskCacheStrategy, map, z10, z11, z12, options, callback, i13);
        }
    }
    ...
    public static class EngineJobFactory {
        ...
        final f pool = FactoryPools.threadSafe(Engine.JOB_POOL_SIZE, new FactoryPools.Factory<EngineJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.EngineJobFactory.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.bumptech.glide.util.pool.FactoryPools.Factory
        ...
        <R> EngineJob<R> build(Key key, boolean z10, boolean z11, boolean z12, boolean z13) {
    ...
    public class LoadStatus {
        ...
        private final ResourceCallback f20226cb;
        private final EngineJob<?> engineJob;

        LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob) {
            this.f20226cb = resourceCallback;
            this.engineJob = engineJob;
        }

        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f20226cb);
            }
        }
    }
    ...
    @Nullable
    private EngineResource<?> loadFromMemory(EngineKey engineKey, boolean z10, long j11) {
        if (!z10) {
            return null;
        }
    ...
    private static void logWithTimeAndKey(String str, long j11, Key key) {
        Log.v(TAG, str + " in " + LogTime.getElapsedMillis(j11) + "ms, key: " + key);
    }

    private <R> LoadStatus waitForExistingOrStartNewJob(GlideContext glideContext, Object obj, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z10, boolean z11, Options options, boolean z12, boolean z13, boolean z14, boolean z15, ResourceCallback resourceCallback, Executor executor, EngineKey engineKey, long j11) {
        ...
        DecodeJob<R> build2 = this.decodeJobFactory.build(glideContext, obj, engineKey, key, i11, i12, cls, cls2, priority, diskCacheStrategy, map, z10, z11, z15, options, build);
        ...
        synchronized (this) {
            try {
                ...
                if (loadFromMemory == null) {
                    return waitForExistingOrStartNewJob(glideContext, obj, key, i11, i12, cls, cls2, priority, diskCacheStrategy, map, z10, z11, options, z12, z13, z14, z15, resourceCallback, executor, buildKey, logTime);
                }
