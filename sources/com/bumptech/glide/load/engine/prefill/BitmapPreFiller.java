...
public final class BitmapPreFiller {
    ...
    PreFillQueue generateAllocationOrder(PreFillType... preFillTypeArr) {
        ...
        for (PreFillType preFillType : preFillTypeArr) {
            i11 += preFillType.getWeight();
        }
        float f11 = ((float) maxSize) / i11;
        HashMap hashMap = new HashMap();
        for (PreFillType preFillType2 : preFillTypeArr) {
            hashMap.put(preFillType2, Integer.valueOf(Math.round(preFillType2.getWeight() * f11) / getSizeInBytes(preFillType2)));
        }
    ...
    public void preFill(PreFillType.Builder... builderArr) {
        ...
        for (int i11 = 0; i11 < builderArr.length; i11++) {
            ...
            preFillTypeArr[i11] = builder.build();
        }
