...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f20213ix = readShort();
        this.header.currentFrame.f20214iy = readShort();
        this.header.currentFrame.f20212iw = readShort();
        this.header.currentFrame.f20211ih = readShort();
        int read = read();
    ...
    private int[] readColorTable(int i11) {
        ...
        try {
            ...
            while (i12 < i11) {
                ...
                i13 += 3;
                int i17 = i12 + 1;
                iArr[i12] = (i16 << 8) | (i14 << 16) | ViewCompat.MEASURED_STATE_MASK | (bArr[i15] & 255);
                i12 = i17;
            }
    ...
    private void readContents(int i11) {
        boolean z10 = false;
        while (!z10 && !err() && this.header.frameCount <= i11) {
            int read = read();
            if (read == 33) {
                int read2 = read();
                if (read2 == 1) {
