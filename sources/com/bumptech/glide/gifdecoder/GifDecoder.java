...
public interface GifDecoder {
    ...
    public interface BitmapProvider {
        @NonNull
        Bitmap obtain(int i11, int i12, @NonNull Bitmap.Config config);
    ...
    int read(@Nullable InputStream inputStream, int i11);
    ...
    void setData(@NonNull GifHeader gifHeader, @NonNull ByteBuffer byteBuffer, int i11);
