...
public class uA extends com.bytedance.sdk.openadsdk.core.sP.sP {
    public uA(@NonNull Context context, @NonNull com.bytedance.sdk.openadsdk.core.model.sU sUVar, @NonNull String str, int i11) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.TEQ Sj(float f11, float f12, float f13, float f14, SparseArray<TKC.Sj> sparseArray, long j11, long j12, View view, View view2, String str, float f15, int i11, float f16, int i12, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.sU = i18;
        return new TEQ.Sj().vS(f17).HiB(f18).EjP(f19).TKC(f20).sP(j13).Sj(j14).sP(Sj).Sj(iArr).TKC(FPG.TKC(view)).EjP(iArr2).EjP(this.ley).HiB(this.LqL).vS(this.Yf).sP(com.bytedance.sdk.openadsdk.core.uA.sP().Sj() ? i15 : 2).Sj(sparseArray).Sj(str).Sj(i12).Sj(jSONObject).sP(jSONObject2).Sj();
    }
