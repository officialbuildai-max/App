...
public class TEQ {
    public static void Sj(String str, int i11, String str2, String str3, String str4) {
        try {
            ...
            if (Sj != null) {
                ...
                if (Sj.tz() != null) {
                    if (TextUtils.isEmpty(str2)) {
                        Sj.tz().Sj((String) null);
                        Sj.tz().sP("");
                    } else {
                        Sj.tz().Sj(str2);
                        Sj.tz().sP("Test the downloaded app");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
                    } else {
            ...
            arrayList.add(Sj);
            sj2.Sj(arrayList);
            new sef(dNu.Sj(), sj2).Sj(true);
        } catch (Exception e11) {
            com.bytedance.sdk.component.utils.sU.sP("PlayableVerityHelper", e11.getMessage());
        }
    }
}
