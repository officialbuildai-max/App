...
public interface IListenerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IListenerManager {
        ...
        /* loaded from: classes2.dex */
        public static class Sj implements IListenerManager {
            public static IListenerManager Sj;
            private IBinder sP;
            ...
            public void broadcastDialogListener(String str, int i11) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i11);
                    if (this.sP.transact(6, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
                        Stub.getDefaultImpl().broadcastDialogListener(str, i11);
                    }
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void broadcastPermissionListener(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (this.sP.transact(8, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void executeAppOpenAdCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.sP.transact(13, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void executeDisLikeClosedCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.sP.transact(11, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
                ...
                try {
                    ...
                    try {
                        if (this.sP.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                            ...
                            Stub.getDefaultImpl().executeRewardVideoCallback(str, str2, z10, i11, str3, i12, str4);
                        }
                        obtain2.recycle();
                        obtain.recycle();
                    } catch (Throwable th2) {
            ...
            public void registerAppOpenAdListener(String str, IAppOpenAdInteractionListener iAppOpenAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.sP.transact(12, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void registerDisLikeClosedListener(String str, IDislikeClosedListener iDislikeClosedListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.sP.transact(9, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void registerPermissionListener(String str, ICommonPermissionListener iCommonPermissionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.sP.transact(7, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
            ...
            public void unregisterDisLikeClosedListener(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IListenerManager");
                    obtain.writeString(str);
                    if (this.sP.transact(10, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                    } else {
        ...
        public static IListenerManager asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IListenerManager)) ? new Sj(iBinder) : (IListenerManager) queryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(IListenerManager iListenerManager) {
            if (Sj.Sj != null || iListenerManager == null) {
                return false;
            }
            Sj.Sj = iListenerManager;
            return true;
        }
    ...
    void broadcastDialogListener(String str, int i11) throws RemoteException;
    ...
    void executeRewardVideoCallback(String str, String str2, boolean z10, int i11, String str3, int i12, String str4) throws RemoteException;
