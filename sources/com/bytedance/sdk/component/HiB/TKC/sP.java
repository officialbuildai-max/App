...
import com.bytedance.sdk.component.HiB.TKC.TKC;
...
public class sP implements Zq {
    ...
    public InputStream Sj(String str, String str2) {
        if (this.Sj != null) {
            ...
            Collection<TzV> sP = this.Sj.sP();
            if (sP != null) {
                Iterator<TzV> it = sP.iterator();
                while (it.hasNext()) {
                    byte[] Sj = it.next().Sj(str2);
                    if (Sj != null) {
                        return new ByteArrayInputStream(Sj);
                    }
                }
            }
            Collection<com.bytedance.sdk.component.HiB.TKC> TKC = this.Sj.TKC();
            if (TKC != null) {
                Iterator<com.bytedance.sdk.component.HiB.TKC> it2 = TKC.iterator();
                while (it2.hasNext()) {
                    InputStream Sj2 = it2.next().Sj(str2);
                    if (Sj2 != null) {
                        return Sj2;
                    }
                }
