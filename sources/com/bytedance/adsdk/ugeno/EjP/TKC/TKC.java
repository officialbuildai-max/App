...
public class TKC extends com.bytedance.adsdk.ugeno.EjP.sP.Sj {
    public TKC(com.bytedance.adsdk.ugeno.sP.TKC tkc, String str, vS.Sj sj2) {
        super(tkc, str, sj2);
    }

    @Override // com.bytedance.adsdk.ugeno.EjP.sP.Sj
    public void Sj() {
        com.bytedance.adsdk.ugeno.sP.TKC sP;
        com.bytedance.adsdk.ugeno.sP.TKC tkc = this.TKC;
        if (tkc == null || (sP = tkc.sP(tkc)) == null) {
            return;
        }
        com.bytedance.adsdk.ugeno.sP.TKC EjP = sP.EjP("SwiperView");
        if (EjP instanceof com.bytedance.adsdk.ugeno.sP) {
            ((com.bytedance.adsdk.ugeno.sP) EjP).EjP();
        }
    }
}
