...
public class EjP extends sef<Integer, Integer> {
    public EjP(List<com.bytedance.adsdk.sP.Jcg.Sj<Integer>> list) {
        super(list);
    }

    @Override // com.bytedance.adsdk.sP.TKC.Sj.Fmk
    public com.bytedance.adsdk.sP.Sj.sP.Sj<Integer, Integer> Sj() {
        return new com.bytedance.adsdk.sP.Sj.sP.vS(this.Sj);
    }
