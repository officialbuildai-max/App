...
public final class AddHomeCustom1PopUpWindowView extends LinearLayout {
    ...
    public AddHomeCustom1PopUpWindowView(Context context, AttributeSet attributeSet) {
        ...
        setOnClickListener(new View.OnClickListener() { // from class: com.cloud.tmc.miniapp.widget.popupview.b
    ...
    public static final void OooO00o(IResourceProcessor iResourceProcessor, String str, String str2, AddHomeCustom1PopUpWindowView this$0, final Function1 function1) {
        ...
        if (ivImages != null) {
            ivImages.post(new Runnable() { // from class: com.cloud.tmc.miniapp.widget.popupview.a
            ...
            try {
                if (str.length() != 0) {
                    ...
                    if (RegexUtils.isURL(str) && !StringsKt.c0(str, ".miniapp.transsion.com", false, 2, null)) {
                        ExecutorUtils.execute(ExecutorType.IO, new Runnable() { // from class: com.cloud.tmc.miniapp.widget.popupview.c
                            @Override // java.lang.Runnable
                            public final void run() {
                ...
                TmcLogger.e("AddHomeCustom1PopUpWind", "requestDrawable failed!", th2);
