...
public final class MiniShellFragment$hideCustomView$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* renamed from: com.cloud.tmc.miniapp.ui.MiniShellFragment$hideCustomView$1$1, reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MiniShellFragment$hideCustomView$1(MiniShellFragment miniShellFragment, Continuation<? super MiniShellFragment$hideCustomView$1> continuation) {
        super(2, continuation);
        this.this$0 = miniShellFragment;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MiniShellFragment$hideCustomView$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((MiniShellFragment$hideCustomView$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
