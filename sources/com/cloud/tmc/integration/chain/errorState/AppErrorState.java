...
public final class AppErrorState implements ChainState {
    ...
    public AppErrorState(Bundle dataBundle) {
        Intrinsics.h(dataBundle, "dataBundle");
        this.dataBundle = dataBundle;
    }

    public /* synthetic */ AppErrorState(Bundle bundle, int i11, DefaultConstructorMarker defaultConstructorMarker) {
