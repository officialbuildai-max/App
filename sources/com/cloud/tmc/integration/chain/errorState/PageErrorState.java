package com.cloud.tmc.integration.chain.errorState;
...
public final class PageErrorState implements ChainState {
    ...
    public PageErrorState(Bundle dataBundle) {
        Intrinsics.h(dataBundle, "dataBundle");
        this.dataBundle = dataBundle;
    }

    public /* synthetic */ PageErrorState(Bundle bundle, int i11, DefaultConstructorMarker defaultConstructorMarker) {
