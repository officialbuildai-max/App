...
public final class PageStageOpenMidSuccessState implements IHotOpenState {
    private final boolean appendStagesOnFail(AppChainContext appChainContext, Map<String, List<Long>> tmpStateRangeTime, Map<String, Long> tmpStateCostTime, int lastStep) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_appendStagesOnFail");
    ...
    static /* synthetic */ boolean appendStagesOnFail$default(PageStageOpenMidSuccessState pageStageOpenMidSuccessState, AppChainContext appChainContext, Map map, Map map2, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
        ...
        return pageStageOpenMidSuccessState.appendStagesOnFail(appChainContext, map, map2, i11);
    }
    ...
    private final boolean appendStagesOnSuccess(AppChainContext appChainContext, Map<String, List<Long>> tmpStateRangeTime, Map<String, Long> tmpStateCostTime, int lastStep) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_appendStagesOnSuccess");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ boolean appendStagesOnSuccess$default(PageStageOpenMidSuccessState pageStageOpenMidSuccessState, AppChainContext appChainContext, Map map, Map map2, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            map = new LinkedHashMap();
        }
        if ((i12 & 4) != 0) {
        ...
        return pageStageOpenMidSuccessState.appendStagesOnSuccess(appChainContext, map, map2, i11);
    }

    private final void reportAppOpenEndFail(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_reportAppOpenEndFail");
        ...
        if (appChainContext.getPageContexts().size() > 0) {
            PageChainContext peek = appChainContext.getPageContexts().peek();
    ...
    private final void reportAppOpenMidSuccess(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_reportAppOpenMidSuccess");
        Bundle bundle = new Bundle();
        bundle.putAll(data);
    ...
    private final void reportPageOpenEndFail(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_reportPageOpenEndFail");
        if (appChainContext.getPageContexts().isEmpty()) {
            return;
        }
        PageChainContext peek = appChainContext.getPageContexts().peek();
    ...
    private final void reportPageOpenMidSuccess(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenMidSuccessState.class.getName() + "_reportPageOpenMidSuccess");
        if (appChainContext.getPageContexts().isEmpty()) {
            return;
        }
        PageChainContext peek = appChainContext.getPageContexts().peek();
