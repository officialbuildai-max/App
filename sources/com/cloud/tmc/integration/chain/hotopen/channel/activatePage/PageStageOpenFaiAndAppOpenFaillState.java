...
public final class PageStageOpenFaiAndAppOpenFaillState implements IHotOpenState {
    private final boolean appendStages(AppChainContext appChainContext, Map<String, List<Long>> tmpStateRangeTime, Map<String, Long> tmpStateCostTime, int lastStep) {
        long j11;
        boolean z10 = true;
        TmcLogger.d("chainPoint", PageStageOpenFaiAndAppOpenFaillState.class.getName() + "_appendStages");
    ...
    static /* synthetic */ boolean appendStages$default(PageStageOpenFaiAndAppOpenFaillState pageStageOpenFaiAndAppOpenFaillState, AppChainContext appChainContext, Map map, Map map2, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
        ...
        return pageStageOpenFaiAndAppOpenFaillState.appendStages(appChainContext, map, map2, i11);
    }

    private final void reportAppOpenEndFail(AppChainContext appChainContext, Bundle data) {
        int maxStage;
        TmcLogger.d("chainPoint", PageStageOpenFaiAndAppOpenFaillState.class.getName() + "_reportAppOpenEndFail");
    ...
    private final void reportAppOpenMidFail(AppChainContext appChainContext, Bundle data) {
        int maxStage;
        TmcLogger.d("chainPoint", PageStageOpenFaiAndAppOpenFaillState.class.getName() + "_reportAppOpenMidFail");
        Bundle bundle = new Bundle();
        bundle.putAll(data);
        bundle.putString("openMiniAppResult", "false");
        bundle.putString("openMiniAppFailedReason", String.valueOf(appChainContext.getOpenMiniAppFailedReason()));
    ...
    private final void reportPageOpenEndFail(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenFaiAndAppOpenFaillState.class.getName() + "_reportPageOpenEndFail");
        if (appChainContext.getPageContexts().isEmpty()) {
            return;
        }
        PageChainContext peek = appChainContext.getPageContexts().peek();
    ...
    private final void reportPageOpenMidFail(AppChainContext appChainContext, Bundle data) {
        TmcLogger.d("chainPoint", PageStageOpenFaiAndAppOpenFaillState.class.getName() + "_reportPageOpenMidFail");
        if (appChainContext.getPageContexts().isEmpty()) {
            return;
        }
        PageChainContext peek = appChainContext.getPageContexts().peek();
