...
public final class DownloadStepEndState implements ChainState {
    ...
    public DownloadStepEndState(Bundle dataBundle) {
        Intrinsics.h(dataBundle, "dataBundle");
        this.dataBundle = dataBundle;
    }

    public /* synthetic */ DownloadStepEndState(Bundle bundle, int i11, DefaultConstructorMarker defaultConstructorMarker) {
