...
public final class RegexUtils {
    ...
    public static boolean isIDCard18Exact(CharSequence charSequence) {
        if (isIDCard18(charSequence)) {
            ...
            x0 x0Var = CITY_MAP;
            if (x0Var.isEmpty()) {
                x0Var.put(PrepareException.ERROR_DOWNLOAD_PACKAGE_URL_EMPTY, "北京");
                x0Var.put("12", "天津");
                x0Var.put(PrepareException.ERROR_WARMUP_DOWNLOAD_EXCEPTION, "河北");
                x0Var.put("14", "山西");
                x0Var.put(PrepareException.ERROR_FILE2VURL_MINIAPP_FILE_EXCEPTION, "内蒙古");
                x0Var.put(ChainPoint.ROUTE_PAGE, "辽宁");
                x0Var.put("22", "吉林");
                x0Var.put("23", "黑龙江");
                x0Var.put("31", "上海");
                x0Var.put("32", "江苏");
            ...
            if (x0Var.get(charSequence.subSequence(0, 2).toString()) != null) {
                ...
                for (int i12 = 0; i12 < 17; i12++) {
                    i11 += (charSequence.charAt(i12) - '0') * iArr[i12];
                }
                return charSequence.charAt(17) == cArr[i11 % 11];
            }
        }
        return false;
    }
