...
public final /* data */ class RenderWarmup extends BaseBean {
    ...
    public final RenderWarmup copy(boolean open, boolean lazyLoad, int cacheSize) {
        return new RenderWarmup(open, lazyLoad, cacheSize);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RenderWarmup)) {
            return false;
        }
        RenderWarmup renderWarmup = (RenderWarmup) other;
