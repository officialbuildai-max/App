...
@DebugMetadata(c = "com.cloud.tmc.integration.performance.worker.WorkerWarmupManager$warmup$1", f = "WorkerWarmupManager.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class WorkerWarmupManager$warmup$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public WorkerWarmupManager$warmup$1(JSI jsi, Node node, WarmUpCallback warmUpCallback, Continuation<? super WorkerWarmupManager$warmup$1> continuation) {
    ...
    public static final void invokeSuspend$lambda$0(final Node node, final JSI jsi, final WarmUpCallback warmUpCallback) {
        ...
        if (eventCenterInstance != null) {
            eventCenterInstance.register(EventConstants.EVENT_WORKER_ON_MSG_READY, new IEventSubscriber() { // from class: com.cloud.tmc.integration.performance.worker.WorkerWarmupManager$warmup$1$1$1
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WorkerWarmupManager$warmup$1(this.$worker, this.$warmupNode, this.$warmUpCallback, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((WorkerWarmupManager$warmup$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        jsi.registerWorkerReadyListener(new JSI.WorkerReadyListener() { // from class: com.cloud.tmc.integration.performance.worker.a
            @Override // com.cloud.tmc.kernel.worker.JSI.WorkerReadyListener
            public final void onWorkerReady() {
                WorkerWarmupManager$warmup$1.invokeSuspend$lambda$0(Node.this, jsi, warmUpCallback);
            }
        });
        return Unit.f67184a;
    }
