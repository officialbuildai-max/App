...
public final class RenderWarmupManager {
    private final void bindWarmupListener(final IRender render, final WarmUpCallback warmUpCallback, Node warmupNode) {
        ...
        if (eventCenterInstance != null) {
            eventCenterInstance.register(EventConstants.EVENT_RENDER_ON_MSG_READY, new IEventSubscriber() { // from class: com.cloud.tmc.integration.performance.render.RenderWarmupManager$bindWarmupListener$1
    ...
    public final void preWarmup(Context context, int warmupType) {
        ...
        k.d(o0.a(y0.a()), null, null, new RenderWarmupManager$preWarmup$1(context, warmupType, null), 3, null);
    }
