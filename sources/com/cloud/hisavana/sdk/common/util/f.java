...
public class f {
    public static Bitmap a(Bitmap bitmap, int i11, boolean z10) {
        ...
        while (i64 < width) {
            ...
            int i88 = 0;
            while (i88 < i85) {
                iArr16[i83] = (iArr16[i83] & ViewCompat.MEASURED_STATE_MASK) | (iArr14[i84] << 16) | (iArr14[i86] << 8) | iArr14[i87];
                int i89 = i84 - i70;
                int i90 = i86 - i69;
                int i91 = i87 - i68;
                int[] iArr18 = iArr8[((i82 - i12) + i66) % i66];
                int i92 = i70 - iArr18[0];
                int i93 = i69 - iArr18[1];
                int i94 = i68 - iArr18[2];
                if (i64 == 0) {
                    iArr15[i88] = Math.min(i88 + i22, i81) * i80;
                }
                int i95 = iArr15[i88] + i64;
                int i96 = iArr3[i95];
                iArr18[0] = i96;
                int i97 = iArr4[i95];
                iArr18[1] = i97;
        ...
        int i105 = width;
        bitmap3.setPixels(iArr2, 0, i105, 0, 0, i105, i63);
        return bitmap3;
    }
}
