...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bytedance2.weakreference.b f33525b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f33526c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f33527d;

    /* renamed from: e, reason: collision with root package name */
    private a f33528e;

    /* renamed from: f, reason: collision with root package name */
    private long f33529f;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f33524a = str;
        this.f33525b = new com.iab.omid.library.bytedance2.weakreference.b(null);
    }

    public void a() {
        this.f33529f = f.b();
        this.f33528e = a.AD_STATE_IDLE;
    }

    public void a(float f11) {
        h.a().a(getWebView(), this.f33524a, f11);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void a(WebView webView) {
        this.f33525b = new com.iab.omid.library.bytedance2.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f33526c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f33524a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f33524a, errorType, str);
    }
    ...
    public void a(String str, long j11) {
        if (j11 >= this.f33529f) {
            ...
            if (aVar != aVar2) {
                this.f33528e = aVar2;
                h.a().a(getWebView(), this.f33524a, str);
            }
        }
    }

    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f33524a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f33524a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.f33524a, z10 ? "foregrounded" : "backgrounded");
        }
    }
    ...
    public void b(String str, long j11) {
        if (j11 >= this.f33529f) {
            this.f33528e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.f33524a, str);
        }
    }
    ...
    public boolean e() {
        return this.f33525b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f33524a);
    }

    public void g() {
        h.a().b(getWebView(), this.f33524a);
    }
