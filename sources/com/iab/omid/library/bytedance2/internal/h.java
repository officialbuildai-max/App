...
public class h {
    ...
    private static h f33510a = new h();
    ...
    public class a implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f33511a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f33512b;

        a(WebView webView, String str) {
            this.f33511a = webView;
            this.f33512b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f33511a, this.f33512b);
        }
    }
    ...
    public void a(WebView webView, String str, float f11) {
        a(webView, "setDeviceVolume", Float.valueOf(f11), str);
    }
