...
public class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f36543a = new CopyOnWriteArrayList<>();

    public void a(WebChromeClient webChromeClient) {
        this.f36543a.add(webChromeClient);
    }

    public void b(WebChromeClient webChromeClient) {
        this.f36543a.remove(webChromeClient);
    }
    ...
    public void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f36543a.iterator();
        while (it.hasNext()) {
    ...
    public void onPermissionRequest(PermissionRequest permissionRequest) {
        try {
            ...
            o0.b("CommonWebChromeClient", e11.getMessage());
        }
    }
