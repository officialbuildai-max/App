...
public abstract class BaseCampaign implements Serializable, NoProGuard, c {
    ...
    public void setAdchoiceSizeHeight(int i11) {
        this.adchoiceSizeHeight = i11;
    }

    public void setAdchoiceSizeWidth(int i11) {
        this.adchoiceSizeWidth = i11;
    }
    ...
    public void setNumberRating(int i11) {
        if (i11 > 0) {
            this.numberRating = i11;
        }
    }
