...
public abstract class BaseMBMediaView extends LinearLayout implements VideoPlayerStatusListener, IRewardCommunication {
    ...
    private static int f36638n0 = 2;

    /* renamed from: o0, reason: collision with root package name */
    private static int f36639o0 = 1;
    ...
    private OnMBMediaViewListener f36643b0;

    /* renamed from: c, reason: collision with root package name */
    private boolean f36644c;

    /* renamed from: c0, reason: collision with root package name */
    private OnMBMediaViewListenerPlus f36645c0;

    /* renamed from: d, reason: collision with root package name */
    private boolean f36646d;

    /* renamed from: d0, reason: collision with root package name */
    private int f36647d0;
    ...
    private boolean f36650f;

    /* renamed from: f0, reason: collision with root package name */
    private boolean f36651f0;

    /* renamed from: g, reason: collision with root package name */
    private boolean f36652g;

    /* renamed from: g0, reason: collision with root package name */
    private RelativeLayout f36653g0;

    /* renamed from: h, reason: collision with root package name */
    private boolean f36654h;

    /* renamed from: h0, reason: collision with root package name */
    private ImageView f36655h0;

    /* renamed from: i, reason: collision with root package name */
    private volatile boolean f36656i;

    /* renamed from: i0, reason: collision with root package name */
    private int f36657i0;

    /* renamed from: j, reason: collision with root package name */
    private volatile boolean f36658j;

    /* renamed from: j0, reason: collision with root package name */
    private boolean f36659j0;

    /* renamed from: k, reason: collision with root package name */
    private boolean f36660k;

    /* renamed from: k0, reason: collision with root package name */
    private Context f36661k0;

    /* renamed from: l, reason: collision with root package name */
    private boolean f36662l;

    /* renamed from: l0, reason: collision with root package name */
    private boolean f36663l0;

    /* renamed from: m, reason: collision with root package name */
    private ArrayList<String> f36664m;

    /* renamed from: m0, reason: collision with root package name */
    private Runnable f36665m0;

    /* renamed from: n, reason: collision with root package name */
    private ArrayList<String> f36666n;
    ...
    private com.iab.omid.library.mmadbridge.adsession.b f36669q;

    /* renamed from: r, reason: collision with root package name */
    private com.iab.omid.library.mmadbridge.adsession.a f36670r;

    /* renamed from: s, reason: collision with root package name */
    private com.iab.omid.library.mmadbridge.adsession.media.a f36671s;

    /* renamed from: t, reason: collision with root package name */
    private int f36672t;

    /* renamed from: u, reason: collision with root package name */
    protected boolean f36673u;

    /* renamed from: v, reason: collision with root package name */
    private MediaViewPlayerView f36674v;

    /* renamed from: w, reason: collision with root package name */
    private RelativeLayout f36675w;

    /* renamed from: x, reason: collision with root package name */
    private RelativeLayout f36676x;

    /* renamed from: y, reason: collision with root package name */
    private RelativeLayout f36677y;

    /* renamed from: z, reason: collision with root package name */
    private WindVaneWebViewForNV f36678z;
    ...
    public class c extends com.mbridge.msdk.widget.a {
        ...
        protected void a(View view) {
            try {
                ...
                if (BaseMBMediaView.this.f36671s != null) {
                    try {
                        BaseMBMediaView.this.f36671s.a(InteractionType.CLICK);
                ...
                o0.b(BaseMBMediaView.TAG, e12.getMessage());
            }
        }
    }
    ...
    public class d implements Runnable {
        ...
        public void run() {
            BaseMBMediaView.this.f36668p = true;
            if (BaseMBMediaView.this.f36654h) {
    ...
    public class f extends com.mbridge.msdk.mbsignalcommon.listener.b {
        ...
        public void a(WebView webView, int i11, String str, String str2) {
            ...
            BaseMBMediaView.this.f36649e0 = false;
        }

        @Override // com.mbridge.msdk.mbsignalcommon.listener.b, com.mbridge.msdk.mbsignalcommon.windvane.c
        public void a(WebView webView, String str) {
            super.a(webView, str);
            BaseMBMediaView.this.f36649e0 = true;
        }
    }
    ...
    class g implements Runnable {
        ...
        public void run() {
            try {
                com.mbridge.msdk.nativex.view.mbfullview.a.a(BaseMBMediaView.this.getContext()).a(BaseMBMediaView.this.E, BaseMBMediaView.this.f36656i);
                if (BaseMBMediaView.this.f36657i0 == 0) {
                ...
                if (BaseMBMediaView.this.A != null) {
                    BaseMBMediaView.this.A.orientation(BaseMBMediaView.this.f36656i);
                }
            } catch (Exception e11) {
    ...
    public static /* synthetic */ class i {
        ...
        static {
            ...
            try {
                f36687a[BaseView.a.FULL_TOP_VIEW.ordinal()] = 2;
        ...
        public void handleMessage(Message message) {
            ...
            if (message != null) {
                try {
                    ...
                    } else if (i11 == 3 && (obj = message.obj) != null && (obj instanceof View)) {
    ...
    public class k extends com.mbridge.msdk.widget.a {
        ...
        protected void a(View view) {
            try {
                ...
                BaseMBMediaView.this.f36674v.showSoundIndicator(true);
                BaseMBMediaView.this.f36674v.showProgressView(true);
                if (BaseMBMediaView.this.f36646d && !BaseMBMediaView.this.f36654h && (BaseMBMediaView.this.D == null || BaseMBMediaView.this.D.getParent() == null)) {
                    if (!BaseMBMediaView.this.f36674v.halfLoadingViewisVisible() && BaseMBMediaView.this.f36674v.isPlaying()) {
                        BaseMBMediaView.this.a();
                        return;
                    }
                ...
                if (BaseMBMediaView.this.f36661k0 != null) {
                    BaseMBMediaView baseMBMediaView = BaseMBMediaView.this;
                    baseMBMediaView.a(baseMBMediaView.f36661k0);
                } else {
                    BaseMBMediaView.this.a(view.getContext());
                }
                if (BaseMBMediaView.this.f36671s != null) {
    ...
    public class l implements com.mbridge.msdk.foundation.same.image.c {
        ...
        public void onSuccessLoad(Bitmap bitmap, String str) {
            if (BaseMBMediaView.this.B == null || BaseMBMediaView.this.f36641a0 != s.BIG_IMAGE) {
                return;
            }
            if (bitmap != null) {
    ...
    class o implements Runnable {
        ...
        public void run() {
            try {
                ...
                BaseMBMediaView.this.c(this.f36694a);
                t0.a(BaseMBMediaView.this.M.getCampaignUnitId(), BaseMBMediaView.this.M, com.mbridge.msdk.foundation.same.a.f35406x);
            } catch (Exception e11) {
    ...
    public class p extends MediaViewPlayerView.h {
        ...
        public void a() {
            ...
            if (!BaseMBMediaView.this.f36654h || (nvT2 != 3 && nvT2 != 4)) {
                super.a();
                return;
            }
            ...
            View q11 = BaseMBMediaView.this.q();
            if (q11 == null) {
                super.a();
                return;
            }
            if (nvT2 == 3 && BaseMBMediaView.this.f36649e0) {
                com.mbridge.msdk.nativex.view.mbfullview.a.a(BaseMBMediaView.this.getContext()).a(q11, BaseMBMediaView.this.E);
                ...
                if (!TextUtils.isEmpty(clickURL)) {
                    com.mbridge.msdk.click.a.a(BaseMBMediaView.this.getContext(), BaseMBMediaView.this.M, BaseMBMediaView.this.getUnitId(), BaseMBMediaView.this.getAddNVT2ToNoticeURL(), true, false, com.mbridge.msdk.click.retry.a.f34474o);
                    BaseMBMediaView.this.A.loadUrl(clickURL);
                }
            }
            endCardWebview.webViewShow(BaseMBMediaView.this.M, BaseMBMediaView.this.getUnitId());
            endCardWebview.orientation(BaseMBMediaView.this.f36656i);
        }
    }
    ...
    private static final class t implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        WeakReference<BaseMBMediaView> f36703a;

        public t(BaseMBMediaView baseMBMediaView) {
            this.f36703a = new WeakReference<>(baseMBMediaView);
        }

        @Override // java.lang.Runnable
        public void run() {
            BaseMBMediaView baseMBMediaView = this.f36703a.get();
            if (baseMBMediaView != null) {
                try {
                    if (baseMBMediaView.f36641a0 == null || baseMBMediaView.f36641a0 != s.BIG_IMAGE) {
                        return;
                    }
                    baseMBMediaView.U();
                    baseMBMediaView.f36641a0 = s.VIDEO;
    ...
    public static final class u implements com.mbridge.msdk.nativex.listener.a {
        ...
        /* renamed from: a, reason: collision with root package name */
        WeakReference<BaseMBMediaView> f36704a;

        public u(BaseMBMediaView baseMBMediaView) {
            this.f36704a = new WeakReference<>(baseMBMediaView);
        }

        @Override // com.mbridge.msdk.nativex.listener.a
        public void a() {
            BaseMBMediaView baseMBMediaView = this.f36704a.get();
            if (baseMBMediaView != null) {
                baseMBMediaView.K();
            }
        }
    ...
    public class w implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            int i11;
            if (BaseMBMediaView.this.f36659j0) {
                return;
            }
            try {
                ...
                int h11 = t0.h(BaseMBMediaView.this.getContext());
                if ((i11 > 45 && i11 < 135) || (i11 > 225 && i11 < 315)) {
                    if (allScreenWidth < h11 || BaseMBMediaView.this.f36658j) {
                        return;
                    }
                    BaseMBMediaView.this.f36656i = true;
                    BaseMBMediaView.this.f36658j = true;
                    BaseMBMediaView.this.L.postDelayed(new a(), 200L);
                    return;
                }
                if (((i11 <= 135 || i11 >= 225) && ((i11 <= 315 || i11 >= 360) && ((i11 < 0 || i11 > 45) && i11 != -1))) || allScreenWidth > h11 || !BaseMBMediaView.this.f36658j) {
                    return;
                }
                BaseMBMediaView.this.f36656i = false;
                BaseMBMediaView.this.f36658j = false;
    ...
    public static final class x implements com.mbridge.msdk.videocommon.listener.a {
        ...
        /* renamed from: a, reason: collision with root package name */
        WeakReference<BaseMBMediaView> f36708a;

        public x(BaseMBMediaView baseMBMediaView) {
            this.f36708a = new WeakReference<>(baseMBMediaView);
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public void a(String str) {
            BaseMBMediaView baseMBMediaView = this.f36708a.get();
            if (baseMBMediaView != null) {
    ...
    public static final class y extends WebViewClient {
        ...
        /* renamed from: a, reason: collision with root package name */
        WeakReference<BaseMBMediaView> f36709a;

        public y(BaseMBMediaView baseMBMediaView) {
            this.f36709a = new WeakReference<>(baseMBMediaView);
        }
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            try {
                BaseMBMediaView baseMBMediaView = this.f36709a.get();
                if (baseMBMediaView == null || baseMBMediaView.f36641a0 == null || baseMBMediaView.f36641a0 != s.BIG_IMAGE) {
                    return;
                }
                baseMBMediaView.R();
                baseMBMediaView.f36641a0 = s.GIF;
                baseMBMediaView.changeNoticeURL();
            } catch (Exception e11) {
                o0.b(BaseMBMediaView.TAG, e11.getMessage());
            }
    ...
    public BaseMBMediaView(Context context) {
        ...
        this.f36660k = true;
        this.f36662l = true;
        this.f36664m = new ArrayList<>();
        this.f36666n = new ArrayList<>();
        this.f36667o = false;
        this.f36668p = false;
        this.f36669q = null;
        this.f36670r = null;
    ...
    public void A() {
        try {
            MediaViewPlayerView mediaViewPlayerView = this.f36674v;
            if (mediaViewPlayerView != null && mediaViewPlayerView.hasPrepare() && this.f36674v.isPlaying()) {
                z();
            }
        } catch (Throwable th2) {
    ...
    public void E() {
        ...
        if (!mediaViewHolder.f35199l && this.f36641a0 == s.VIDEO && y0.b(this.M.getImpressionURL())) {
            mediaViewHolder.f35199l = true;
            ...
            if (!impressionURL.contains("is_video=1")) {
                ...
                if (impressionURL.contains(UrlUtils.QUESTION_MARK)) {
            ...
            Context context = getContext();
            CampaignEx campaignEx2 = this.M;
            com.mbridge.msdk.click.a.a(context, campaignEx2, campaignEx2.getCampaignUnitId(), impressionURL, false, true, com.mbridge.msdk.click.retry.a.f34472m);
        }
    }

    private void F() {
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || campaignEx.getMediaViewHolder() == null || this.M.getMediaViewHolder().f35192e || TextUtils.isEmpty(this.M.getCampaignUnitId()) || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().c() == null) {
            return;
        }
        this.M.getMediaViewHolder().f35192e = true;
        f();
    }
    ...
    public void G() {
        ...
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35193f || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().m() == null) {
            return;
        }
        mediaViewHolder.f35193f = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    public void H() {
        CampaignEx.b mediaViewHolder;
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35194g || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().n() == null) {
            return;
        }
        mediaViewHolder.f35194g = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    public void I() {
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || campaignEx.getMediaViewHolder() == null || this.M.getMediaViewHolder().f35191d || TextUtils.isEmpty(this.M.getCampaignUnitId()) || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().i() == null) {
            return;
        }
        this.M.getMediaViewHolder().f35191d = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    public void J() {
        CampaignEx.b mediaViewHolder;
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35196i || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().p() == null) {
            return;
        }
        mediaViewHolder.f35196i = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    public void K() {
        CampaignEx.b mediaViewHolder;
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35197j || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().s() == null) {
            return;
        }
        mediaViewHolder.f35197j = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    public void L() {
        CampaignEx.b mediaViewHolder;
        CampaignEx campaignEx = this.M;
        if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35198k || this.M.getNativeVideoTracking() == null || this.M.getNativeVideoTracking().t() == null) {
            return;
        }
        mediaViewHolder.f35198k = true;
        Context context = getContext();
        CampaignEx campaignEx2 = this.M;
    ...
    private void N() {
        ...
        try {
            this.f36641a0 = a(true);
            changeNoticeURL();
            s sVar = this.f36641a0;
            if (sVar == s.BIG_IMAGE) {
                CampaignEx campaignEx = this.M;
                if (campaignEx != null && TextUtils.isEmpty(campaignEx.getVideoUrlEncode()) && (bVar = this.f36669q) != null) {
                    try {
                        bVar.d(this.B);
                        this.f36670r = com.iab.omid.library.mmadbridge.adsession.a.a(this.f36669q);
                        this.f36669q.g();
                        com.iab.omid.library.mmadbridge.adsession.a aVar = this.f36670r;
                        if (aVar != null) {
                            aVar.b();
                        }
                    } catch (Exception e11) {
    ...
    public void O() {
        try {
            if (this.G == null && this.f36655h0 == null) {
                return;
            }
            ...
            if (this.f36647d0 == 0 && com.mbridge.msdk.foundation.tools.e.a(getContext())) {
            ...
            ImageView imageView = this.f36655h0;
            if (imageView != null) {
    ...
    public void S() {
        try {
            ...
            if (a((View) this)) {
                ...
                int i11 = 0;
                int s11 = unitSetting != null ? unitSetting.s() : 0;
                CampaignEx campaignEx = this.M;
                ...
                this.L.sendMessageDelayed(obtainMessage, (i11 == 0 ? 0L : i11 * 1000) + 300);
            }
            if (this.f36641a0 == s.VIDEO) {
                MediaViewPlayerView mediaViewPlayerView = this.f36674v;
    ...
    private s a(boolean z10) {
        ...
        try {
            ...
            if (y0.a(campaignEx.getVideoUrlEncode())) {
                ...
                this.f36678z.setWebViewClient(new y(this));
                j();
                return sVar2;
            }
            if (!this.f36652g || this.W == null) {
                sVar = s.BIG_IMAGE;
            } else {
    ...
    private void a(int i11, int i12) {
        ...
        try {
            CampaignEx campaignEx = this.M;
            if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35195h || i12 == 0) {
                return;
            }
            List<Map<Integer, String>> o11 = this.M.getNativeVideoTracking().o();
            int i13 = ((i11 + 1) * 100) / i12;
            if (o11 != null) {
                int i14 = 0;
                while (i14 < o11.size()) {
                    Map<Integer, String> map = o11.get(i14);
                    if (map != null && map.size() > 0) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (intValue <= i13 && !TextUtils.isEmpty(value)) {
                                Context context = getContext();
                                CampaignEx campaignEx2 = this.M;
        ...
        try {
            ...
            if (d11 > 0.0d) {
                ...
                if (d13 > 0.0d) {
                    ...
                    double a11 = t0.a(Double.valueOf(d14));
                    double a12 = t0.a(Double.valueOf(d12));
                    RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) this.f36675w.getLayoutParams();
                    RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) view.getLayoutParams();
                    boolean z10 = c(getContext()) && this.f36656i;
                    int i11 = -1;
                    if (a11 > a12) {
                        double d15 = (f11 * this.Q) / this.P;
                        ...
                        double d16 = f12 * d14;
                        layoutParams2.width = z10 ? -1 : (int) d16;
                    ...
                    if (!this.f36654h) {
                        this.f36675w.setLayoutParams(layoutParams);
                    }
    ...
    private void a(FrameLayout frameLayout) {
        BitmapDrawable a11;
        if (frameLayout == null || (a11 = com.mbridge.msdk.foundation.controller.c.m().a(getUnitId(), this.M.getAdType())) == null) {
            return;
        }
        ...
        com.iab.omid.library.mmadbridge.adsession.b bVar = this.f36669q;
        if (bVar != null) {
    ...
    public void a(Campaign campaign, String str) {
        try {
            OnMBMediaViewListener onMBMediaViewListener = this.f36643b0;
            if (onMBMediaViewListener != null) {
                onMBMediaViewListener.onFinishRedirection(campaign, str);
            }
            OnMBMediaViewListenerPlus onMBMediaViewListenerPlus = this.f36645c0;
    ...
    public void a0() {
        try {
            MediaViewPlayerView mediaViewPlayerView = this.f36674v;
            if (mediaViewPlayerView == null || !mediaViewPlayerView.hasPrepare() || this.f36674v.isPlaying() || this.f36674v.isComplete() || !this.f36674v.hasPrepare()) {
                return;
            }
            this.f36674v.startOrPlayVideo();
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        }
    }
    ...
    private void b() {
        try {
            ...
            if (mediaViewPlayerView != null && mediaViewPlayerView.getParent() != null) {
                ((ViewGroup) this.f36674v.getParent()).removeView(this.f36674v);
            }
            Z();
            MediaViewPlayerView mediaViewPlayerView2 = new MediaViewPlayerView(getContext());
            this.f36674v = mediaViewPlayerView2;
            mediaViewPlayerView2.showProgressView(this.f36660k);
            this.f36674v.showSoundIndicator(this.f36662l);
            if (this.f36650f) {
                this.f36674v.openSound();
            } else {
                this.f36674v.closeSound();
            }
            this.f36674v.setAllowLoopPlay(this.f36642b);
            this.f36674v.initPlayerViewData(getPlayUrl(), this.M, y(), this, this.W, getUnitId());
            this.f36674v.setOnMediaViewPlayerViewListener(new u(this));
            this.f36675w.addView(this.f36674v, -1, -1);
            T();
            com.iab.omid.library.mmadbridge.adsession.b bVar = this.f36669q;
            if (bVar != null) {
                MediaViewPlayerView mediaViewPlayerView3 = this.f36674v;
                if (mediaViewPlayerView3 != null) {
                    mediaViewPlayerView3.registerView(bVar);
                }
                this.f36670r = com.iab.omid.library.mmadbridge.adsession.a.a(this.f36669q);
                this.f36671s = com.iab.omid.library.mmadbridge.adsession.media.a.g(this.f36669q);
                this.f36669q.g();
                this.f36670r.d(com.iab.omid.library.mmadbridge.adsession.media.b.b(true, Position.STANDALONE));
                MediaViewPlayerView mediaViewPlayerView4 = this.f36674v;
                if (mediaViewPlayerView4 != null) {
                    mediaViewPlayerView4.setVideoEvents(this.f36671s);
                }
                try {
                    com.iab.omid.library.mmadbridge.adsession.a aVar = this.f36670r;
                    if (aVar != null) {
    ...
    private void b(int i11) {
        ...
        try {
            CampaignEx campaignEx = this.M;
            if (campaignEx == null || (mediaViewHolder = campaignEx.getMediaViewHolder()) == null || mediaViewHolder.f35189b || (map = mediaViewHolder.f35188a) == null || map.size() <= 0) {
                return;
            }
            Map<Integer, String> map2 = mediaViewHolder.f35188a;
    ...
    private void c() {
        try {
            ...
            com.iab.omid.library.mmadbridge.adsession.media.a aVar = this.f36671s;
            if (aVar != null) {
    ...
    public void c(String str) {
        ...
        try {
            com.mbridge.msdk.foundation.db.n a11 = com.mbridge.msdk.foundation.db.n.a(com.mbridge.msdk.foundation.db.g.a(getContext()));
            if (!TextUtils.isEmpty(this.M.getNoticeUrl())) {
                int s11 = k0.s(getContext());
                mVar = new com.mbridge.msdk.foundation.entity.m("2000021", s11, this.M.getNoticeUrl(), str, k0.a(getContext(), s11));
            } else if (TextUtils.isEmpty(this.M.getClickURL())) {
                mVar = null;
            } else {
                int s12 = k0.s(getContext());
                mVar = new com.mbridge.msdk.foundation.entity.m("2000021", s12, this.M.getClickURL(), str, k0.a(getContext(), s12));
            }
            if (mVar != null) {
                mVar.b(this.M.getId());
    ...
    private void d() {
        try {
            this.f36674v.showSoundIndicator(this.f36662l);
            this.f36674v.showProgressView(this.f36660k);
            OnMBMediaViewListener onMBMediaViewListener = this.f36643b0;
            if (onMBMediaViewListener != null) {
    ...
    private void f() {
        try {
            ...
            String[] c11 = this.M.getNativeVideoTracking().c();
            int i11 = this.f36656i ? f36638n0 : f36639o0;
            for (String str : c11) {
                if (!TextUtils.isEmpty(str)) {
                    Context context = getContext();
                    CampaignEx campaignEx2 = this.M;
                    com.mbridge.msdk.click.a.a(context, campaignEx2, campaignEx2.getCampaignUnitId(), str + "&orienation=" + i11, false, false);
                }
            }
        } catch (Exception e11) {
            o0.b(TAG, e11.getMessage());
    ...
    public void g() {
        try {
            ...
            RelativeLayout relativeLayout6 = this.f36653g0;
            if (relativeLayout6 != null) {
                if (relativeLayout2 != null) {
                    relativeLayout2.removeView(relativeLayout6);
                } else if (relativeLayout6.getParent() != null) {
                    ((ViewGroup) this.f36653g0.getParent()).removeView(this.f36653g0);
                }
            ...
            if (relativeLayout4 != null) {
                relativeLayout4.removeView(this.f36674v);
            }
            ...
            requestLayout();
            if (viewGroup != null) {
                if (this.f36674v.getParent() != null && this.f36674v.getParent() != viewGroup) {
                    ((ViewGroup) this.f36674v.getParent()).removeView(this.f36674v);
                }
                viewGroup.addView(this.f36674v, this.K);
    ...
    private float getAllScreenHeight() {
        try {
            float h11 = t0.h(getContext());
            return !this.f36656i ? h11 + t0.c(getContext()) : h11;
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
            return 0.0f;
        }
    ...
    public float getAllScreenWidth() {
        try {
            float i11 = t0.i(getContext());
            return this.f36656i ? i11 + t0.c(getContext()) : i11;
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
            return 0.0f;
        }
    ...
    public WindVaneWebViewForNV getEndCardWebview() {
        try {
            ...
            if (windVaneWebViewForNV != null && this.f36651f0) {
    ...
    private com.mbridge.msdk.setting.l getUnitSetting() {
        try {
            ...
            if (campaignEx != null && !y0.a(campaignEx.getCampaignUnitId())) {
                ...
                if (!y0.a(campaignUnitId) && !y0.a(b11)) {
                    com.mbridge.msdk.setting.l e11 = com.mbridge.msdk.setting.h.b().e(b11, campaignUnitId);
                    return e11 != null ? e11 : com.mbridge.msdk.setting.l.i(campaignUnitId);
                }
    ...
    private void j() {
        try {
            ...
            this.f36678z.loadDataWithBaseURL(null, "<!DOCTYPE html><html lang=\"en\"><head>  <meta charset=\"UTF-8\">  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><meta http-equiv=\"X-UA-Compatible\" content=\"ie=edge\">  <title>Document</title>  <style>  *{    margin: 0;    padding: 0;  }  html, body{    width: 100%;    height: 100%;  }  body{    background-image: url('gifUrl');    background-position: center;    background-size: contain;    background-repeat: no-repeat;  }  </style></head><body></body></html>".replace("gifUrl", gifUrl), "text/html", "utf-8", null);
            this.f36678z.setInterceptTouch(true);
            this.f36677y.setOnClickListener(new m());
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        }
    }
    ...
    public void o() {
        ...
        int i13;
        try {
            if (this.f36641a0 != s.BIG_IMAGE || (i11 = this.O) == 0 || (i12 = this.S) == 0 || (i13 = this.R) == 0) {
                return;
            }
            int i14 = (i11 * i12) / i13;
            MyImageView myImageView = this.B;
            if (myImageView == null || i14 == 0) {
                return;
            }
    ...
    private void p() {
        try {
            this.f36656i = t0.i(getContext()) >= t0.h(getContext());
            this.f36658j = this.f36656i;
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        }
    }
    ...
    public View q() {
        try {
            this.f36653g0 = new RelativeLayout(getContext());
            this.f36653g0.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
            ImageView imageView = new ImageView(getContext());
            this.f36655h0 = imageView;
            ...
            layoutParams.topMargin = t0.a(getContext(), 8.0f);
            layoutParams.rightMargin = t0.a(getContext(), 8.0f);
            this.f36655h0.setLayoutParams(layoutParams);
            this.f36655h0.setBackgroundResource(g0.a(getContext(), "mbridge_nativex_close", "drawable"));
            this.f36655h0.setOnClickListener(new q());
            this.A.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
            this.f36653g0.addView(this.A);
            this.f36653g0.addView(this.f36655h0);
            return this.f36653g0;
        } catch (Exception e11) {
            o0.b(TAG, e11.getMessage());
            return null;
        }
        ...
        try {
            if (this.f36654h) {
                ...
                if (mediaViewPlayerView == null) {
                    ...
                    MediaViewPlayerView mediaViewPlayerView2 = this.f36674v;
                    if (mediaViewPlayerView2 != null && !mediaViewPlayerView2.isComplete() && !this.f36674v.getIsActiviePause()) {
                        this.f36674v.onClickPlayButton();
                    }
                }
            }
        } catch (Throwable th2) {
    ...
    private void s() {
        try {
            ...
            com.mbridge.msdk.nativex.view.mbfullview.a.a(getContext()).a(this.E, this.f36656i);
            if (this.f36656i) {
                O();
            } else {
                P();
    ...
    public void u() {
        try {
            if (this.f36641a0 != s.VIDEO || this.f36675w == null) {
                return;
            }
            int allScreenWidth = (int) getAllScreenWidth();
            int h11 = t0.h(getContext());
            if (this.f36654h) {
                ...
                RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) this.f36675w.getLayoutParams();
                layoutParams2.width = this.O;
                layoutParams2.height = this.N;
                layoutParams2.addRule(13);
                this.f36675w.setLayoutParams(layoutParams2);
            }
            S();
            if (this.f36654h) {
                a(this.f36674v, allScreenWidth, h11);
            } else {
                a(this.f36674v, this.O, this.N);
            }
        } catch (Exception e11) {
            o0.b(TAG, e11.getMessage());
        }
    ...
    private void v() {
        ...
        try {
            ...
            String str2 = split[1];
            double m11 = t0.m(str);
            double m12 = t0.m(str2);
            if (m11 <= 0.0d || m12 <= 0.0d) {
                return;
            }
            this.P = m11;
            this.Q = m12;
    ...
    private void w() {
        int a11 = g0.a(getContext(), "mbridge_nativex_mbmediaview", TtmlNode.TAG_LAYOUT);
        if (!g0.a(a11)) {
            o0.b(TAG, "can not find mediaview resource");
            return;
        }
        View inflate = LayoutInflater.from(getContext()).inflate(a11, (ViewGroup) null);
        this.f36676x = (RelativeLayout) inflate.findViewById(g0.a(getContext(), "mbridge_rl_mediaview_root", "id"));
        this.f36675w = (RelativeLayout) inflate.findViewById(g0.a(getContext(), "mbridge_ll_playerview_container", "id"));
        ...
        this.f36677y = (RelativeLayout) inflate.findViewById(g0.a(getContext(), "mbridge_nativex_webview_layout", "id"));
        this.f36678z = (WindVaneWebViewForNV) inflate.findViewById(g0.a(getContext(), "mbridge_nativex_webview_layout_webview", "id"));
        this.f36676x.setClickable(true);
        addView(inflate, -1, -1);
    }
    ...
    public void x() {
        ...
        int i12;
        try {
            if (this.f36641a0 == s.GIF) {
                int i13 = this.O;
                if (i13 != 0 && (i11 = this.S) != 0 && (i12 = this.R) != 0) {
                    int i14 = (i13 * i11) / i12;
                    RelativeLayout relativeLayout2 = this.f36677y;
                    if (relativeLayout2 != null && i14 != 0) {
                        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) relativeLayout2.getLayoutParams();
                        layoutParams.width = this.O;
                        layoutParams.height = i14;
                        layoutParams.addRule(13);
                        this.f36677y.setLayoutParams(layoutParams);
                    }
                } else if (i13 != 0 && (relativeLayout = this.f36677y) != null) {
                    RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) relativeLayout.getLayoutParams();
                    int i15 = this.O;
                    layoutParams2.width = i15;
                    layoutParams2.height = (i15 * 627) / 1200;
                    layoutParams2.addRule(13);
                    this.f36677y.setLayoutParams(layoutParams2);
                }
            }
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        ...
        try {
            if (getRootView() != null && (getRootView() instanceof ViewGroup)) {
                ...
                if (fullScreenViewByStyle != null && k()) {
                    ...
                    BaseView baseView = this.E;
                    a11.a(baseView.style, this.M, baseView);
                    this.f36654h = true;
                    this.f36668p = false;
                    MediaViewPlayerView mediaViewPlayerView = this.f36674v;
                    if (mediaViewPlayerView != null) {
                        mediaViewPlayerView.setEnterFullScreen();
                        this.f36674v.setIsActivePause(false);
                    }
                    c();
                    FrameLayout frameLayout = (FrameLayout) getRootView().findViewById(R.id.content);
                    ...
                    ViewGroup viewGroup = (ViewGroup) this.f36674v.getParent();
                    int childCount = viewGroup.getChildCount();
                    int i11 = 0;
                    while (i11 < childCount && viewGroup.getChildAt(i11) != this.f36674v) {
                        i11++;
                    }
                    this.K = i11;
                    FrameLayout frameLayout2 = new FrameLayout(getContext());
                    frameLayout2.setId(100);
                    viewGroup.addView(frameLayout2, i11, new ViewGroup.LayoutParams(getWidth(), getHeight()));
                    viewGroup.removeView(this.f36674v);
                    ViewGroup.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
                    relativeLayout.setId(101);
                    new RelativeLayout.LayoutParams(-1, -1);
                    this.J.addView(this.f36674v, new RelativeLayout.LayoutParams(-1, -1));
                    ...
                    int i12 = i.f36687a[this.E.style.ordinal()] != 2 ? ViewCompat.MEASURED_STATE_MASK : -1;
                    int i13 = this.f36672t;
                    if (i13 != 0) {
                    ...
                    int i14 = iArr[1];
                    this.f36647d0 = i14;
                    if (i14 == 0 && (rootWindowInsets = getRootWindowInsets()) != null) {
    ...
    protected void a(String str) {
        try {
            if (TextUtils.isEmpty(str) || this.f36666n.contains(str)) {
                return;
            }
            this.f36666n.add(str);
            OnMBMediaViewListenerPlus onMBMediaViewListenerPlus = this.f36645c0;
            if (onMBMediaViewListenerPlus != null) {
    ...
    protected void b(String str) {
        try {
            if (TextUtils.isEmpty(str) || this.f36664m.contains(str)) {
                return;
            }
            this.f36664m.add(str);
            OnMBMediaViewListener onMBMediaViewListener = this.f36643b0;
            if (onMBMediaViewListener != null) {
    ...
    public void cai(Object obj, String str) {
        ...
        try {
            try {
                ...
                int i11 = t0.c(com.mbridge.msdk.foundation.controller.c.m().d(), optString) ? 1 : 2;
                try {
                    JSONObject jSONObject = new JSONObject();
    ...
    public void getEndScreenInfo(Object obj, String str) {
        try {
            ...
            String a11 = a(arrayList, getUnitId(), "MAL_16.9.71,3.0.1");
            String encodeToString = !TextUtils.isEmpty(a11) ? Base64.encodeToString(a11.getBytes(), 2) : "";
    ...
    */
    public com.mbridge.msdk.nativex.view.mbfullview.BaseView getFullScreenViewByStyle(android.content.Context r3, com.mbridge.msdk.nativex.view.mbfullview.BaseView.a r4) {
        /*
            r2 = this;
            int[] r0 = com.mbridge.msdk.nativex.view.BaseMBMediaView.i.f36687a
            int r1 = r4.ordinal()
            r0 = r0[r1]
            r1 = 1
            if (r0 == r1) goto L17
    ...
    public float getMediaContentAspectRatio() {
        ...
        try {
            ...
            if (campaignEx != null) {
                ...
                o0.b(TAG, "resource ratio is : " + f11);
            }
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        }
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            this.f36652g = isHardwareAccelerated();
            this.f36657i0 = getOrientation();
            N();
            this.L.postDelayed(this.f36665m0, 300L);
        } catch (Throwable th2) {
            o0.b(TAG, th2.getMessage());
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        try {
            ...
            if (this.f36671s != null) {
                this.f36671s = null;
            }
            if (this.f36670r != null) {
                this.f36670r = null;
            }
            this.L.removeCallbacks(this.f36665m0);
            C();
            b0();
            c0();
        } catch (Throwable th2) {
    ...
    protected void onMeasure(int i11, int i12) {
        ...
        try {
            ...
            s sVar = this.f36641a0;
            if (sVar != s.VIDEO || this.f36654h) {
                if (sVar == s.BIG_IMAGE && !this.f36654h) {
                    o();
                    return;
                } else {
                    if (sVar != s.GIF || this.f36654h) {
                        return;
                    }
                    x();
                    return;
    ...
    public void onPlayProgress(int i11, int i12) {
        ...
        if (getReadyRate() == 100 || this.f36663l0) {
            return;
        }
        ...
        if (cDRate < 0 || i11 < (i13 = (i12 * cDRate) / 100)) {
            return;
        }
        ...
        com.mbridge.msdk.videocommon.download.a a11 = com.mbridge.msdk.videocommon.download.b.getInstance().a(getUnitId(), str);
        if (a11 != null) {
            a11.v();
            this.f36663l0 = true;
            o0.b(TAG, "CDRate is : " + i13 + " and start download !");
        }
    }
    ...
    public void onPlayStarted(int i11) {
        ...
        if (aVar != null) {
            try {
                aVar.n(i11, this.f36650f ? 1.0f : 0.0f);
    ...
    public void setFullScreenViewBackgroundColor(int i11) {
        this.f36672t = i11;
    }
    ...
    */
    ...
    public void updateViewManger(boolean z10) {
        ...
        if (a11 != null) {
            try {
                a11.a(this.E);
                a11.a(z10, !this.f36674v.isComplete(), this.E);
                a11.a(z10, this.E, this.f36647d0);
        ...
        BaseView baseView = this.E;
        if (!(baseView instanceof MBridgeTopFullView) || a11 == null) {
            return;
        }
        a11.a(!z10, baseView);
    }
