...
public class MBridgeGlobalCommon {
    ...
    public static void setAlertDialogText(String str, String str2, String str3, String str4, String str5) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            w0.b(d11, "MBridge_ConfirmTitle" + str, str2.trim());
        }
        if (!TextUtils.isEmpty(str3)) {
            w0.b(d11, "MBridge_ConfirmContent" + str, str3.trim());
        }
        if (!TextUtils.isEmpty(str5)) {
            w0.b(d11, "MBridge_CancelText" + str, str5.trim());
        }
        if (TextUtils.isEmpty(str4)) {
            return;
        }
        w0.b(d11, "MBridge_ConfirmText" + str, str4.trim());
    }
}
