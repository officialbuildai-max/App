...
public class a {
    ...
    /* loaded from: classes5.dex */
    public class C0538a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            try {
                ...
                m0.a(this.f37399a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f37400b);
            } catch (Exception e11) {
                o0.a("MraidJSController", e11.getMessage());
            }
        }
    }
    ...
    public void a(Context context, String str) {
        ...
        String a11 = com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController");
        if (TextUtils.isEmpty(a11) || !a11.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0538a(str), "mraid_js", 60000L);
            } catch (Exception e11) {
                o0.b("MraidJSController", e11.getMessage());
            }
        }
    }
    ...
    public String b() {
        try {
            if (TextUtils.isEmpty(this.f37396a)) {
                this.f37396a = c();
            }
            if (!TextUtils.isEmpty(this.f37396a)) {
                return this.f37396a;
            ...
            if (d11 != null && !TextUtils.isEmpty(d11.O())) {
                a(com.mbridge.msdk.foundation.controller.c.m().d(), d11.O());
            }
            return f37394b;
