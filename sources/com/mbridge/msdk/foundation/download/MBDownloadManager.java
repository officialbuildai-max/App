...
public final class MBDownloadManager {
    ...
    public synchronized void updateZipResource(String str, String str2, long j11) {
        GlobalComponent.getInstance().getDatabaseHelper().updateUnzipResource(str, str2, j11);
    }
}
