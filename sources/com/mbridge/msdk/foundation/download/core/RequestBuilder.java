...
public interface RequestBuilder<T> {
    ...
    RequestBuilder<T> withConnectTimeout(long j11);
    ...
    RequestBuilder<T> withHttpRetryCounter(int i11);

    RequestBuilder<T> withProgressStateListener(OnProgressStateListener onProgressStateListener);

    RequestBuilder<T> withReadTimeout(long j11);

    RequestBuilder<T> withTimeout(long j11);

    RequestBuilder<T> withUserAgent(String str);

    RequestBuilder<T> withWriteTimeout(long j11);
}
