...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j11, long j12, int i11, int i12, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        ...
        downloadModel.setDownloadedBytes(j12);
        downloadModel.setTotalBytes(j11);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i12);
        downloadModel.setDownloadRate(i11);
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j11, long j12, int i11, int i12, DownloadResourceType downloadResourceType, int i13) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
    ...
    public void setDownloadRate(int i11) {
    ...
    public void setLastModifiedTime(long j11) {
    ...
    public void setUnZipResourceByte(long j11) {
        this.unZipResourceByte = j11;
    }
    ...
    public void setUsageCounter(int i11) {
        this.usageCounter = i11;
    }
}
