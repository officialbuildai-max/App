...
public class DownloadMessage<T> {
    ...
    public DownloadMessage(T t11, String str, String str2, int i11, DownloadResourceType downloadResourceType) {
        this.checkMD5 = false;
        this.md5 = "";
        this.object = t11;
    ...
    public void setMd5VerifyResult(int i11) {
        this.md5VerifyResult = i11;
    }
    ...
    public void setUseCronetDownload(int i11) {
        boolean z10 = true;
        if (i11 != 1 && i11 != 2) {
            z10 = false;
        }
