...
public class g extends f {
    ...
    public static synchronized g a(Context context) {
        ...
        synchronized (g.class) {
            try {
                if (f35149b == null) {
                    f35149b = new g(context.getApplicationContext());
                }
                gVar = f35149b;
            } catch (Throwable th2) {
                throw th2;
    ...
    private void b(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                o0.b("CommonSDKDBHelper", e11.getLocalizedMessage());
            }
        }
    }
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    protected void a(SQLiteDatabase sQLiteDatabase, int i11, int i12) {
        if (com.mbridge.msdk.util.d.a(sQLiteDatabase)) {
            c(sQLiteDatabase);
            b(sQLiteDatabase);
        }
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    protected void b(SQLiteDatabase sQLiteDatabase, int i11, int i12) {
        if (com.mbridge.msdk.util.d.a(sQLiteDatabase)) {
            c(sQLiteDatabase);
            b(sQLiteDatabase);
        }
