...
public class a {
    ...
    private final LinkedHashMap<String, JSONObject> f35411a;
    ...
    public a(int i11) {
        ...
        this.f35412b = i11;
        this.f35411a = new LinkedHashMap<>(0, 0.75f, true);
    }
    ...
    */
    private void a(int r4) {
        ...
        L0:
            monitor-enter(r3)
            int r0 = r3.f35413c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L56
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r3.f35411a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r2 = r3.f35411a     // Catch: java.lang.Throwable -> L52
            ...
            int r1 = r3.f35413c     // Catch: java.lang.Throwable -> L52
            int r1 = r1 - r0
            r3.f35413c = r1     // Catch: java.lang.Throwable -> L52
        L52:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L12
            goto L0
        L54:
    ...
    public Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f35411a.keySet());
        }
        return hashSet;
    }
    ...
    public final JSONObject a(String str) {
        ...
        synchronized (this) {
            jSONObject = this.f35411a.get(str);
        }
        return jSONObject;
    }
    ...
    public final boolean a(String str, JSONObject jSONObject) {
        ...
        synchronized (this) {
            try {
                this.f35413c += b(str, jSONObject);
                JSONObject put = this.f35411a.put(str, jSONObject);
                if (put != null) {
                    this.f35413c -= b(str, put);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f35412b));
    }
}
