...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th2, boolean z10, int i11) {
    ...
    public MediaCodecRenderer(int i11, MediaCodecSelector mediaCodecSelector, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, boolean z10) {
        super(i11);
    ...
    private static boolean codecNeedsEosFlushWorkaround(String str) {
        int i11 = Util.SDK_INT;
        return (i11 <= 23 && "OMX.google.vorbis.decoder".equals(str)) || (i11 <= 19 && "hb2000".equals(Util.DEVICE) && ("OMX.amlogic.avc.decoder.awesome".equals(str) || "OMX.amlogic.avc.decoder.awesome.secure".equals(str)));
    }
    ...
    private boolean drainOutputBuffer(long j11, long j12) throws ExoPlaybackException {
        ...
        if (this.codecNeedsEosOutputExceptionWorkaround && this.codecReceivedEos) {
            try {
                ...
                processOutputBuffer = processOutputBuffer(j11, j12, mediaCodec, byteBuffer2, i11, bufferInfo3.flags, bufferInfo3.presentationTimeUs, this.shouldSkipOutputBuffer);
            ...
            processOutputBuffer = processOutputBuffer(j11, j12, mediaCodec2, byteBuffer3, i12, bufferInfo4.flags, bufferInfo4.presentationTimeUs, this.shouldSkipOutputBuffer);
        }
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        ...
        if (this.waitingForKeys) {
            ...
            if (this.codecReconfigurationState == 1) {
                for (int i11 = 0; i11 < this.format.initializationData.size(); i11++) {
                    this.buffer.data.put(this.format.initializationData.get(i11));
                }
        ...
        try {
            ...
            if (isEncrypted) {
                this.codec.queueSecureInputBuffer(this.inputIndex, 0, getFrameworkCryptoInfo(this.buffer, position), j11, 0);
            } else {
    ...
    private static MediaCodec.CryptoInfo getFrameworkCryptoInfo(DecoderInputBuffer decoderInputBuffer, int i11) {
    ...
    private ByteBuffer getInputBuffer(int i11) {
        return Util.SDK_INT >= 21 ? this.codec.getInputBuffer(i11) : this.inputBuffers[i11];
    }

    private ByteBuffer getOutputBuffer(int i11) {
        return Util.SDK_INT >= 21 ? this.codec.getOutputBuffer(i11) : this.outputBuffers[i11];
    }
    ...
    private boolean shouldSkipOutputBuffer(long j11) {
    ...
    public final void maybeInitCodec() throws ExoPlaybackException {
        ...
        if (this.codecInfo == null) {
            try {
                ...
                throwDecoderInitError(new DecoderInitializationException(this.format, e11, z10, -49998));
            }
            if (this.codecInfo == null) {
        ...
        if (shouldInitCodec(this.codecInfo)) {
            ...
            try {
                ...
                throwDecoderInitError(new DecoderInitializationException(this.format, e12, z10, str2));
            }
    ...
    */
    ...
    protected abstract boolean processOutputBuffer(long j11, long j12, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i11, int i12, long j13, boolean z10) throws ExoPlaybackException;
