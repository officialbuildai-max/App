...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private long getNextEventTime() {
        int i11 = this.nextSubtitleEventIndex;
        if (i11 == -1 || i11 >= this.subtitle.getEventTimeCount()) {
    ...
    public void render(long j11, long j12) throws ExoPlaybackException {
        ...
        if (this.nextSubtitle == null) {
            this.decoder.setPositionUs(j11);
            try {
        ...
        if (subtitleOutputBuffer != null) {
            if (subtitleOutputBuffer.isEndOfStream()) {
            ...
            } else if (this.nextSubtitle.timeUs <= j11) {
                ...
                this.nextSubtitle = null;
                this.nextSubtitleEventIndex = subtitleOutputBuffer3.getNextEventTimeIndex(j11);
                z10 = true;
            }
        }
        if (z10) {
