...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static long parseTimecode(Matcher matcher, int i11) {
        return ((Long.parseLong(matcher.group(i11 + 1)) * 3600000) + (Long.parseLong(matcher.group(i11 + 2)) * 60000) + (Long.parseLong(matcher.group(i11 + 3)) * 1000) + Long.parseLong(matcher.group(i11 + 4))) * 1000;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.mbridge.msdk.playercommon.exoplayer2.text.SimpleSubtitleDecoder
    public SubripSubtitle decode(byte[] bArr, int i11, boolean z10) {
