...
public final class SsaDecoder extends SimpleSubtitleDecoder {
    ...
    private void parseFormatLine(String str) {
        ...
        for (int i11 = 0; i11 < this.formatKeyCount; i11++) {
            String lowerInvariant = Util.toLowerInvariant(split[i11].trim());
            ...
            switch (c11) {
                case 0:
                    this.formatEndIndex = i11;
                    break;
                case 1:
                    this.formatTextIndex = i11;
                    break;
                case 2:
                    this.formatStartIndex = i11;
                    break;
            }
        }
    ...
    public SsaSubtitle decode(byte[] bArr, int i11, boolean z10) {
