...
public final class WebvttDecoder extends SimpleSubtitleDecoder {
    ...
    private static int getNextEvent(ParsableByteArray parsableByteArray) {
        ...
        while (i11 == -1) {
            ...
            i11 = readLine == null ? 0 : STYLE_START.equals(readLine) ? 2 : COMMENT_START.startsWith(readLine) ? 1 : 3;
        }
    ...
    public WebvttSubtitle decode(byte[] bArr, int i11, boolean z10) throws SubtitleDecoderException {
