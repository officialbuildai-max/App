...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context, TransferListener<? super DataSource> transferListener, String str, int i11, int i12, boolean z10) {
        this(context, transferListener, new DefaultHttpDataSource(str, null, transferListener, i11, i12, z10, null));
    }
    ...
    public int read(byte[] bArr, int i11, int i12) throws IOException {
        return this.dataSource.read(bArr, i11, i12);
    }
}
