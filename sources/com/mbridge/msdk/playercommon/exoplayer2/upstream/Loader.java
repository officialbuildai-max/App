...
public final class Loader implements LoaderErrorThrower {
    ...
    public interface Callback<T extends Loadable> {
        void onLoadCanceled(T t11, long j11, long j12, boolean z10);

        void onLoadCompleted(T t11, long j11, long j12);

        int onLoadError(T t11, long j11, long j12, IOException iOException);
    }
    ...
    public final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void handleMessage(Message message) {
            ...
            if (this.canceled) {
                this.callback.onLoadCanceled(this.loadable, elapsedRealtime, j11, false);
                return;
            }
            ...
            if (i12 == 2) {
                try {
                    this.callback.onLoadCompleted(this.loadable, elapsedRealtime, j11);
                    return;
            ...
            int onLoadError = this.callback.onLoadError(this.loadable, elapsedRealtime, j11, iOException);
            if (onLoadError == 3) {
        ...
        public void run() {
            try {
                ...
                Log.e(TAG, "Unexpected exception loading stream", e14);
                if (this.released) {
                    return;
                }
    ...
    public <T extends Loadable> long startLoading(T t11, Callback<T> callback, int i11) {
        ...
        long elapsedRealtime = SystemClock.elapsedRealtime();
        new LoadTask(myLooper, t11, callback, i11, elapsedRealtime).start(0L);
