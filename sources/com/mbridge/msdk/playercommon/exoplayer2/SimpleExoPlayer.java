...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
    ...
    public final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
        ...
        public void onAudioDecoderInitialized(String str, long j11, long j12) {
            ...
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioDecoderInitialized(str, j11, j12);
            }
        }
        ...
        public void onAudioSessionId(int i11) {
            ...
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSessionId(i11);
            }
        }
        ...
        public void onAudioSinkUnderrun(int i11, long j11, long j12) {
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSinkUnderrun(i11, j11, j12);
            }
        }
        ...
        public void onDroppedFrames(int i11, long j11) {
            ...
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onDroppedFrames(i11, j11);
            }
        }
        ...
        public void onVideoDecoderInitialized(String str, long j11, long j12) {
            Iterator it = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onVideoDecoderInitialized(str, j11, j12);
            }
        }
        ...
        public void onVideoSizeChanged(int i11, int i12, int i13, float f11) {
            Iterator it = SimpleExoPlayer.this.videoListeners.iterator();
            while (it.hasNext()) {
                ((com.mbridge.msdk.playercommon.exoplayer2.video.VideoListener) it.next()).onVideoSizeChanged(i11, i12, i13, f11);
            }
            Iterator it2 = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it2.hasNext()) {
                ((VideoRendererEventListener) it2.next()).onVideoSizeChanged(i11, i12, i13, f11);
            }
        }
    ...
    public void setVideoScalingMode(int i11) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 2) {
                this.player.createMessage(renderer).setType(4).setPayload(Integer.valueOf(i11)).send();
            }
        }
    }
    ...
    public void setVolume(float f11) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 1) {
                this.player.createMessage(renderer).setType(2).setPayload(Float.valueOf(f11)).send();
            }
        }
    }
