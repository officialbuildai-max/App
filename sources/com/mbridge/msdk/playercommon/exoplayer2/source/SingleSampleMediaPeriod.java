...
public final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
        ...
        public void load() throws IOException, InterruptedException {
            ...
            try {
                ...
                while (i11 != -1) {
                    ...
                    i11 = dataSource.read(bArr2, i13, bArr2.length - i13);
                }
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec, DataSource.Factory factory, Format format, long j11, int i11, MediaSourceEventListener.EventDispatcher eventDispatcher, boolean z10) {
        this.dataSpec = dataSpec;
    ...
    public void onLoadCanceled(SourceLoadable sourceLoadable, long j11, long j12, boolean z10) {
        this.eventDispatcher.loadCanceled(sourceLoadable.dataSpec, 1, -1, null, 0, null, 0L, this.durationUs, j11, j12, sourceLoadable.sampleSize);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public void onLoadCompleted(SourceLoadable sourceLoadable, long j11, long j12) {
        this.eventDispatcher.loadCompleted(sourceLoadable.dataSpec, 1, -1, this.format, 0, null, 0L, this.durationUs, j11, j12, sourceLoadable.sampleSize);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public int onLoadError(SourceLoadable sourceLoadable, long j11, long j12, IOException iOException) {
        int i11 = this.errorCount + 1;
        this.errorCount = i11;
        boolean z10 = this.treatLoadErrorsAsEndOfStream && i11 >= this.minLoadableRetryCount;
        this.eventDispatcher.loadError(sourceLoadable.dataSpec, 1, -1, this.format, 0, null, 0L, this.durationUs, j11, j12, sourceLoadable.sampleSize, iOException, z10);
        if (!z10) {
            return 0;
        }
        this.loadingFinished = true;
