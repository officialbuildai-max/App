...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f36837id.equals(binaryFrame.f36837id) && Arrays.equals(this.data, binaryFrame.data);
    }

    public int hashCode() {
        return ((this.f36837id.hashCode() + 527) * 31) + Arrays.hashCode(this.data);
    }
