...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f36837id.equals(textInformationFrame.f36837id) && Util.areEqual(this.description, textInformationFrame.description) && Util.areEqual(this.value, textInformationFrame.value);
    }
    ...
    public String toString() {
        return this.f36837id + ": value=" + this.value;
    }
