...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    private byte[] blockingKeyRequest(int i11, byte[] bArr, DrmInitData drmInitData) throws DrmSession.DrmSessionException {
        DrmSession<T> openBlockingKeyRequest = openBlockingKeyRequest(i11, bArr, drmInitData);
    ...
    private DrmSession<T> openBlockingKeyRequest(int i11, byte[] bArr, DrmInitData drmInitData) {
