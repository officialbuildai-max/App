...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        public DefaultKeyStatus(int i11, byte[] bArr) {
            this.statusCode = i11;
            this.keyId = bArr;
        }
    ...
    public interface OnEventListener<T extends ExoMediaCrypto> {
        void onEvent(ExoMediaDrm<? extends T> exoMediaDrm, byte[] bArr, int i11, int i12, @Nullable byte[] bArr2);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, byte[] bArr2, String str, int i11, HashMap<String, String> hashMap) throws NotProvisionedException;
