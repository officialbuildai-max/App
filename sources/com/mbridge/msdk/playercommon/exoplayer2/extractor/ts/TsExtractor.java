...
public final class TsExtractor implements Extractor {
    ...
    private class PmtReader implements SectionPayloadReader {
        ...
        private TsPayloadReader.EsInfo readEsInfo(ParsableByteArray parsableByteArray, int i11) {
            ...
            return new TsPayloadReader.EsInfo(i13, str, arrayList, Arrays.copyOfRange(parsableByteArray.data, position, i12));
        }
        ...
        public void consume(ParsableByteArray parsableByteArray) {
            ...
            for (int i14 = 0; i14 < size; i14++) {
                ...
                if (valueAt != null) {
                    ...
                    TsExtractor.this.tsPayloadReaders.put(this.trackIdToPidScratch.valueAt(i14), valueAt);
                }
            }
            if (TsExtractor.this.mode == 2) {
    ...
    public TsExtractor(int i11, int i12) {
        this(i11, new TimestampAdjuster(0L), new DefaultTsPayloadReaderFactory(i12));
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        int i11 = position;
        while (i11 < limit2 && bArr[i11] != TS_SYNC_BYTE) {
            i11++;
        }
    ...
    public void seek(long j11, long j12) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            this.timestampAdjusters.get(i11).reset();
        }
