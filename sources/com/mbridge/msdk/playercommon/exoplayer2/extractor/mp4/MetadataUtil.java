...
final class MetadataUtil {
    ...
    private static CommentFrame parseCommentAttribute(int i11, ParsableByteArray parsableByteArray) {
        ...
        Log.w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(i11));
        return null;
    }
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            sb2.append(Atom.getAtomTypeString(readInt));
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i11, String str, ParsableByteArray parsableByteArray) {
        ...
        Log.w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i11));
        return null;
    }
    ...
    */
    ...
    private static TextInformationFrame parseTextAttribute(int i11, String str, ParsableByteArray parsableByteArray) {
        ...
        Log.w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(i11));
        return null;
    }

    private static Id3Frame parseUint8Attribute(int i11, String str, ParsableByteArray parsableByteArray, boolean z10, boolean z11) {
        ...
        if (parseUint8AttributeValue >= 0) {
            return z10 ? new TextInformationFrame(str, null, Integer.toString(parseUint8AttributeValue)) : new CommentFrame("und", str, Integer.toString(parseUint8AttributeValue));
        }
        Log.w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i11));
        return null;
    }
