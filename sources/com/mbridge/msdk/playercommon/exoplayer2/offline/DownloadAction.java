...
public abstract class DownloadAction {
    ...
    public static abstract class Deserializer {
        ...
        public Deserializer(String str, int i11) {
            this.type = str;
            this.version = i11;
        }

        public abstract DownloadAction readFromStream(int i11, DataInputStream dataInputStream) throws IOException;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public DownloadAction(String str, int i11, Uri uri, boolean z10, @Nullable byte[] bArr) {
        this.type = str;
        this.version = i11;
        this.uri = uri;
