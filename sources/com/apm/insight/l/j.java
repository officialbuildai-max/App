...
public final class j {
    ...
    private static String f19763a;

    /* renamed from: b, reason: collision with root package name */
    private static File f19764b;

    /* renamed from: c, reason: collision with root package name */
    private static File f19765c;
    ...
    public static File d(@NonNull Context context) {
        if (f19764b == null) {
            ...
            f19764b = new File(j(context), "apminsight/CrashLogNative");
        }
        return f19764b;
    }
    ...
    public static File e(@NonNull Context context) {
        if (f19765c == null) {
            f19765c = new File(j(context) + "/apminsight/CrashCommonLog/" + com.apm.insight.e.f());
        }
        return f19765c;
    }
    ...
    public static String j(@NonNull Context context) {
        if (TextUtils.isEmpty(f19763a)) {
            try {
                f19763a = context.getFilesDir().getAbsolutePath();
            } catch (Exception e11) {
                f19763a = "/sdcard/";
                e11.printStackTrace();
            }
