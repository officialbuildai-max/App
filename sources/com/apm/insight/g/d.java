...
public final class d implements c {
    ...
    public final void a(final long j11, final Thread thread, final Throwable th2, final String str, final String str2, final boolean z10) {
        final File file = new File(j.a(this.f19617a), str);
        a.a().a(file.getName());
        file.mkdirs();
        f.d(file);
        final boolean c11 = m.c(th2);
        com.apm.insight.entity.a a11 = com.apm.insight.runtime.a.f.a().a(CrashType.JAVA, new c.a() { // from class: com.apm.insight.g.d.1
            ...
            public final com.apm.insight.entity.a a(int i11, com.apm.insight.entity.a aVar) {
                this.f19618a = SystemClock.uptimeMillis();
                if (i11 == 0) {
                    ...
                    if (c11) {
                        com.apm.insight.l.a.a(d.this.f19617a, aVar.c());
                    }
                    if (e.x()) {
