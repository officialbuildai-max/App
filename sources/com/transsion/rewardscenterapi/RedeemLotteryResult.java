...
public final /* data */ class RedeemLotteryResult implements Serializable {
    ...
    public /* synthetic */ RedeemLotteryResult(String str, UserLotteryInfo userLotteryInfo, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? null : str, (i11 & 2) != 0 ? null : userLotteryInfo);
    }

    public static /* synthetic */ RedeemLotteryResult copy$default(RedeemLotteryResult redeemLotteryResult, String str, UserLotteryInfo userLotteryInfo, int i11, Object obj) {
        if ((i11 & 1) != 0) {
