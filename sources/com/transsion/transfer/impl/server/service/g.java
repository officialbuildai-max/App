...
public final class g implements q {
    ...
    private static final String f55939d = "Transfer-" + g.class.getName();

    /* renamed from: a, reason: collision with root package name */
    private final com.transsion.transfer.impl.g f55940a;
    ...
    public g(com.transsion.transfer.impl.g fileHandler, i listener) {
        Intrinsics.h(fileHandler, "fileHandler");
        Intrinsics.h(listener, "listener");
        this.f55940a = fileHandler;
        this.f55941b = listener;
    }
