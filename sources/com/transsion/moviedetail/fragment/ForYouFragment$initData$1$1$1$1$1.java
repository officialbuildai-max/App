...
final class ForYouFragment$initData$1$1$1$1$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    ...
    public ForYouFragment$initData$1$1$1$1$1(ForYouFragment forYouFragment, int i11, CourseBean courseBean, Continuation<? super ForYouFragment$initData$1$1$1$1$1> continuation) {
    ...
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ForYouFragment$initData$1$1$1$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
