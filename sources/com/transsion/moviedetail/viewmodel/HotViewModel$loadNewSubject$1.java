...
public final class HotViewModel$loadNewSubject$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public HotViewModel$loadNewSubject$1(HotViewModel hotViewModel, String str, Continuation<? super HotViewModel$loadNewSubject$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((HotViewModel$loadNewSubject$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i11 == 0) {
                ...
                this.label = 1;
                obj = b.a.e(Y, str, null, this, 2, null);
                if (obj == f11) {
                    return f11;
                }
            } else {
