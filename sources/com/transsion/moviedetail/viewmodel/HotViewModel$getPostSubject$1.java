...
@DebugMetadata(c = "com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1", f = "HotViewModel.kt", l = {106}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class HotViewModel$getPostSubject$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1$1", f = "HotViewModel.kt", l = {100, 103}, m = "invokeSuspend")
    /* renamed from: com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1$1, reason: invalid class name */
    /* loaded from: classes6.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(HotViewModel hotViewModel, String str, String str2, int i11, String str3, boolean z10, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.L$0 = cVar;
                this.label = 1;
                obj = e02.e(a11, str, str2, i12, str3, z10, this);
                if (obj == f11) {
                    return f11;
                }
            } else {
    ...
    @DebugMetadata(c = "com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1$2", f = "HotViewModel.kt", l = {105}, m = "invokeSuspend")
    /* renamed from: com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1$2, reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ HotViewModel f47482a;

        a(HotViewModel hotViewModel) {
            this.f47482a = hotViewModel;
        }
        ...
        public final Object emit(PostSubjectBean postSubjectBean, Continuation continuation) {
            ...
            if (postSubjectBean != null) {
                HotViewModel hotViewModel = this.f47482a;
                Pager pager = postSubjectBean.getPager();
                hotViewModel.k0((pager == null || (perPage = pager.getPerPage()) == null) ? 10 : perPage.intValue());
                Pager pager2 = postSubjectBean.getPager();
                if (pager2 == null || (str = pager2.getNextPage()) == null) {
                    str = "0";
                }
                hotViewModel.f47478n = str;
            }
            y10 = this.f47482a.y();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HotViewModel$getPostSubject$1(HotViewModel hotViewModel, String str, String str2, int i11, String str3, boolean z10, Continuation<? super HotViewModel$getPostSubject$1> continuation) {
        super(2, continuation);
        this.this$0 = hotViewModel;
        this.$subjectId = str;
        this.$page = str2;
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HotViewModel$getPostSubject$1(this.this$0, this.$subjectId, this.$page, this.$perPage, this.$sortType, this.$with, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((HotViewModel$getPostSubject$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
