...
public final class DownloadInterceptAdHelper$loadNativeAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    ...
    public static final class a extends di.a {
        ...
        final /* synthetic */ DownloadInterceptAdHelper f43906d;

        a(DownloadInterceptAdHelper downloadInterceptAdHelper) {
            this.f43906d = downloadInterceptAdHelper;
        }
        ...
        public void j(BiddingIntermediateMaterialBean biddingIntermediateMaterialBean) {
            ...
            this.f43906d.o(biddingIntermediateMaterialBean);
        }
        ...
        public void l(BiddingIntermediateMaterialBean biddingIntermediateMaterialBean) {
            ...
            adInterceptDialog = this.f43906d.f43905g;
    ...
    public DownloadInterceptAdHelper$loadNativeAd$1(DownloadInterceptAdHelper downloadInterceptAdHelper, Continuation<? super DownloadInterceptAdHelper$loadNativeAd$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((DownloadInterceptAdHelper$loadNativeAd$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
