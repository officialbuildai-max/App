...
public final class q {
    ...
    public static final q f52592a = new q();

    /* renamed from: b, reason: collision with root package name */
    private static String f52593b;
    ...
    public final void c(String msg, int i11) {
        ...
        linkedHashMap.put(TrackingKey.TRIGGER_ID, String.valueOf(f52593b));
