...
final class ResultVerticalRankType2Provider$convert$2 extends SuspendLambda implements Function2<n0, Continuation<? super BaseViewHolder>, Object> {
    ...
    public ResultVerticalRankType2Provider$convert$2(BaseViewHolder baseViewHolder, Continuation<? super ResultVerticalRankType2Provider$convert$2> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super BaseViewHolder> continuation) {
        return ((ResultVerticalRankType2Provider$convert$2) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
