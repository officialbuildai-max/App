...
@DebugMetadata(c = "com.transsion.search_pugc.ad.SearchHotAdHelper$loadBiddingAd$1", f = "SearchHotAdHelper.kt", l = {Sdk$SDKError.Reason.TPAT_RETRY_FAILED_VALUE}, m = "invokeSuspend")
...
public final class SearchHotAdHelper$loadBiddingAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            this.this$0.f52344e = new BiddingNativeManager();
            biddingNativeManager = this.this$0.f52344e;
            if (biddingNativeManager != null) {
                SearchHotAdHelper searchHotAdHelper = this.this$0;
                biddingNativeManager.O0("SearchHotNativeScene");
                bVar = searchHotAdHelper.f52352m;
