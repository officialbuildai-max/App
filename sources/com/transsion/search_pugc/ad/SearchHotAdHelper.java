...
public final class SearchHotAdHelper {
    ...
    public static final a f52339n = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private final LifecycleCoroutineScope f52340a;

    /* renamed from: b, reason: collision with root package name */
    private BiddingSspNativeManager f52341b;

    /* renamed from: c, reason: collision with root package name */
    private List f52342c;

    /* renamed from: d, reason: collision with root package name */
    private List f52343d;

    /* renamed from: e, reason: collision with root package name */
    private BiddingNativeManager f52344e;

    /* renamed from: f, reason: collision with root package name */
    private NativeWrapperAdView f52345f;

    /* renamed from: g, reason: collision with root package name */
    private SearchHotAdContainerView f52346g;

    /* renamed from: h, reason: collision with root package name */
    private Function1 f52347h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f52348i;

    /* renamed from: j, reason: collision with root package name */
    private ObjectAnimator f52349j;

    /* renamed from: k, reason: collision with root package name */
    private Runnable f52350k;

    /* renamed from: l, reason: collision with root package name */
    private final c f52351l;

    /* renamed from: m, reason: collision with root package name */
    private final b f52352m;
    ...
    public SearchHotAdHelper(LifecycleCoroutineScope lifecycleScope) {
        ...
        this.f52340a = lifecycleScope;
        this.f52351l = new c();
        this.f52352m = new b();
    }

    private final void k() {
        Runnable runnable = new Runnable() { // from class: com.transsion.search_pugc.ad.a
            @Override // java.lang.Runnable
            public final void run() {
                SearchHotAdHelper.l(SearchHotAdHelper.this);
            }
        };
        this.f52350k = runnable;
        NativeWrapperAdView nativeWrapperAdView = this.f52345f;
    ...
    public static final void l(SearchHotAdHelper searchHotAdHelper) {
        NativeWrapperAdView nativeWrapperAdView = searchHotAdHelper.f52345f;
    ...
    public final void n(BiddingIntermediateMaterialBean biddingIntermediateMaterialBean) {
        ...
        SearchHotAdContainerView searchHotAdContainerView = this.f52346g;
        if (searchHotAdContainerView == null || (nativeWrapperAdView = searchHotAdContainerView.getNativeWrapperAdView()) == null) {
            return;
        }
        this.f52345f = nativeWrapperAdView;
        cy.b bVar = cy.b.f61063a;
        Context context = nativeWrapperAdView.getContext();
        Intrinsics.g(context, "getContext(...)");
        nativeWrapperAdView.bindNativeView(this.f52344e, bVar.a(context, "SearchHotNativeScene"), biddingIntermediateMaterialBean);
        x();
        v();
    }
    ...
    public final void o(List list) {
        ...
        if (list3 == null || list3.isEmpty() || (list2 = list) == null || list2.isEmpty() || (biddingSspNativeManager = this.f52341b) == null) {
            return;
        }
    ...
    private final void q() {
        NativeWrapperAdView nativeWrapperAdView;
        ObjectAnimator objectAnimator = this.f52349j;
        if (objectAnimator != null) {
            objectAnimator.cancel();
        }
        this.f52349j = null;
        Runnable runnable = this.f52350k;
        if (runnable != null && (nativeWrapperAdView = this.f52345f) != null) {
    ...
    private final void r() {
        BiddingNativeManager biddingNativeManager = this.f52344e;
    ...
    private final void s() {
        ...
        this.f52342c = null;
        BiddingSspNativeManager biddingSspNativeManager = this.f52341b;
    ...
    public final void t() {
        r();
        k.d(this.f52340a, y0.b(), null, new SearchHotAdHelper$loadBiddingAd$1(this, null), 2, null);
    }

    private final void u() {
        s();
        k.d(this.f52340a, y0.b(), null, new SearchHotAdHelper$loadHiAd$1(this, null), 2, null);
    }
    ...
    private final void x() {
        this.f52348i = true;
        Function1 function1 = this.f52347h;
        if (function1 != null) {
    ...
    public final void m(SearchHotAdContainerView searchHotAdContainerView) {
        this.f52346g = searchHotAdContainerView;
        u();
    }
