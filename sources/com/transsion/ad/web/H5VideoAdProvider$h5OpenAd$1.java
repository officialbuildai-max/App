...
import com.transsion.ad.web.H5VideoAdProvider;
...
@DebugMetadata(c = "com.transsion.ad.web.H5VideoAdProvider$h5OpenAd$1", f = "H5VideoAdProvider.kt", l = {TmcConstants.NOTIFY_ADDHOME_API_SHOW}, m = "invokeSuspend")
...
public final class H5VideoAdProvider$h5OpenAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            BiddingVideoManager biddingVideoManager = H5VideoAdProvider.f42509d;
            if (biddingVideoManager != null) {
                biddingVideoManager.O0(this.$sceneId);
            }
            BiddingVideoManager biddingVideoManager2 = H5VideoAdProvider.f42509d;
            if (biddingVideoManager2 != null) {
                biddingVideoManager2.M0(null);
            }
            BiddingVideoManager biddingVideoManager3 = H5VideoAdProvider.f42509d;
            if (biddingVideoManager3 != null) {
                aVar = H5VideoAdProvider.f42510e;
                biddingVideoManager3.N0(aVar);
            }
            BiddingVideoManager biddingVideoManager4 = H5VideoAdProvider.f42509d;
