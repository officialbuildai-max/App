...
public final class BiddingInterstitialManager extends AbsAdBidding {

    /* renamed from: w */
    public static final Companion f42019w = new Companion(null);

    /* renamed from: v */
    private final ei.a f42020v = new ei.a();
    ...
    public static final class Companion {
        ...
        public final void a(String sceneId, Map map) {
            ...
            kotlinx.coroutines.k.d(o0.a(y0.b()), null, null, new BiddingInterstitialManager$Companion$preLoadAd$1(sceneId, map, null), 3, null);
        }
    }
    ...
    public void S(List biddingPlan, AdPlans adPlans, int i11) {
        ...
        l b11 = l.f42034j.b(getMSceneId());
        if (b11 != null) {
            b11.d(getMSceneId());
        }
        AdditionalInfo g11 = b11 != null ? b11.g() : null;
        if (g11 == null) {
            b.a.c(this, 6, "addHiSavanaProvider() --> 插屏广告同步获取失败 --> additionalInfo == null", null, false, 4, null);
            return;
        }
        if (u0(adPlans)) {
