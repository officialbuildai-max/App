...
@DebugMetadata(c = "com.transsion.ad.MBAd$initAd$2$1$sdkMb$1", f = "MBAd.kt", l = {Sdk$SDKError.Reason.AD_ALREADY_LOADED_VALUE}, m = "invokeSuspend")
...
final class MBAd$initAd$2$1$sdkMb$1 extends SuspendLambda implements Function2<n0, Continuation<? super String>, Object> {
    ...
    public MBAd$initAd$2$1$sdkMb$1(MBAd.a aVar, Continuation<? super MBAd$initAd$2$1$sdkMb$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super String> continuation) {
        return ((MBAd$initAd$2$1$sdkMb$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        return MonopolyAdManager.c(monopolyAdManager, b11, null, this, 2, null) == f11 ? f11 : "包断广告初始化完成";
    }
}
