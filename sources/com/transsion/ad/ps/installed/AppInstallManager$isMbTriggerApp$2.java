...
final class AppInstallManager$isMbTriggerApp$2 extends SuspendLambda implements Function2<n0, Continuation<? super Boolean>, Object> {
    ...
    public AppInstallManager$isMbTriggerApp$2(Context context, String str, Continuation<? super AppInstallManager$isMbTriggerApp$2> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Boolean> continuation) {
        return ((AppInstallManager$isMbTriggerApp$2) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            a w02 = MbAdDatabase.INSTANCE.b(this.$applicationContext).w0();
