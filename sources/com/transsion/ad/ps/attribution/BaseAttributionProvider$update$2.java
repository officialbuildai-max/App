...
public final class BaseAttributionProvider$update$2 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public BaseAttributionProvider$update$2(AttributionPoint attributionPoint, BaseAttributionProvider baseAttributionProvider, Continuation<? super BaseAttributionProvider$update$2> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((BaseAttributionProvider$update$2) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            if (f11.b(attributionPoint, this) == f12) {
                return f12;
            }
        } else {
            if (i11 != 1) {
