...
@DebugMetadata(c = "com.transsion.ad.ps.distribute.PsDbManager$onBiddingBuyOutClick$1", f = "PsDbManager.kt", l = {128, 142}, m = "invokeSuspend")
/* loaded from: classes5.dex */
public final class PsDbManager$onBiddingBuyOutClick$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    final /* synthetic */ PsLinkAdPlan $psLinkAdPlan;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PsDbManager$onBiddingBuyOutClick$1(PsLinkAdPlan psLinkAdPlan, Continuation<? super PsDbManager$onBiddingBuyOutClick$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((PsDbManager$onBiddingBuyOutClick$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (psLinkAdPlan != null) {
            ...
            e11 = psDbManager2.e();
            oi.a.k(aVar, e11 + " --> onBiddingBuyOutClick() --> id = " + psLinkAdPlan.getId() + " --> clickMax = " + psLinkAdPlan.getClickMax() + " --> clickedTimes = " + psLinkAdPlan.getClickedTimes() + " --> showDate = " + psLinkAdPlan.getShowDate() + " ", 0, false, 6, null);
            this.label = 2;
