...
@DebugMetadata(c = "com.transsion.ad.strategy.HotSplashManager$onBiddingLoad$1$1$1", f = "HotSplashManager.kt", l = {130}, m = "invokeSuspend")
...
final class HotSplashManager$onBiddingLoad$1$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            boolean l11 = com.transsion.ad.scene.a.f42255a.l(a11);
            biddingInterstitialManager = HotSplashManager.f42276g;
            if (biddingInterstitialManager != null) {
                biddingInterstitialManager.Q0(this.$topAct, this.$maxEcpmObject, l11);
            }
            ii.b.g(ii.b.f65371a, a11, null, 2, null);
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HotSplashManager$onBiddingLoad$1$1$1(Activity activity, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean, Continuation<? super HotSplashManager$onBiddingLoad$1$1$1> continuation) {
        super(2, continuation);
        this.$topAct = activity;
        this.$maxEcpmObject = biddingIntermediateMaterialBean;
    }
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((HotSplashManager$onBiddingLoad$1$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
