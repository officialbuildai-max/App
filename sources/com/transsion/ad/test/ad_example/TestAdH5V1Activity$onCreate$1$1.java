...
import com.transsion.ad.test.ad_example.TestAdH5V1Activity;
...
@DebugMetadata(c = "com.transsion.ad.test.ad_example.TestAdH5V1Activity$onCreate$1$1", f = "TestAdH5V1Activity.kt", l = {76}, m = "invokeSuspend")
/* loaded from: classes5.dex */
public final class TestAdH5V1Activity$onCreate$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ TestAdH5V1Activity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TestAdH5V1Activity$onCreate$1$1(TestAdH5V1Activity testAdH5V1Activity, Continuation<? super TestAdH5V1Activity$onCreate$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TestAdH5V1Activity$onCreate$1$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((TestAdH5V1Activity$onCreate$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        TestAdH5V1Activity.a aVar;
