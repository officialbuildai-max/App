...
public final class SpeechRecognizerDialog extends BaseDialog {
    ...
    public static final class a implements RecognitionListener {
        ...
        public void onBeginningOfSpeech() {
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onBeginningOfSpeech() --> 当开始说话时调用");
        }

        @Override // android.speech.RecognitionListener
        public void onBufferReceived(byte[] bArr) {
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onBufferReceived() --> 当接收到音频数据时调用");
        }

        @Override // android.speech.RecognitionListener
        public void onEndOfSpeech() {
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onEndOfSpeech() --> 当说话结束时调用");
        }
        ...
        public void onError(int i11) {
            ...
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onError() --> 当发生错误时调用 --> error = " + i11 + " -- msg = " + a11);
            SpeechRecognizerDialog.this.P0(a11, true);
            if (SpeechRecognizerDialog.this.isWorking) {
                q.f52281a.c(eVar.a(16), 16);
            } else {
                q.f52281a.c(a11, i11);
            }
        ...
        public void onEvent(int i11, Bundle bundle) {
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onEvent() --> 当发生其他事件时调用 --> eventType = " + i11 + " --> params = " + bundle);
        }
        ...
        public void onReadyForSpeech(Bundle bundle) {
            f.f52268a.a(SpeechRecognizerDialog.this.getClassTag() + " --> onReadyForSpeech() --> 当语音识别准备好时调用 --> params = " + bundle);
            q.f52281a.d();
        ...
        public void onResults(Bundle bundle) {
            ...
            Intrinsics.e(str);
            SpeechRecognizerDialog.Q0(speechRecognizerDialog, str, false, 2, null);
            f.f52268a.a(speechRecognizerDialog.getClassTag() + " --> onResults() --> 当获得语音识别结果时调用 = " + str);
    ...
    private final void D0() {
        final com.transsion.search_pugc.speech.SpeechRecognizerVolumeCircleView speechRecognizerVolumeCircleView;
        Unit unit;
        try {
        ...
        speechRecognizerVolumeCircleView.post(new Runnable() { // from class: com.transsion.search.speech.i
    ...
    public static final void E0(SpeechRecognizerDialog speechRecognizerDialog, com.transsion.search_pugc.speech.SpeechRecognizerVolumeCircleView speechRecognizerVolumeCircleView) {
    ...
    public static final Unit G0(SpeechRecognizerDialog speechRecognizerDialog) {
        ...
        f.f52268a.a(speechRecognizerDialog.getClassTag() + " --> onViewCreated() --> setCallback{} --> 重新获取语音识别对象 --> initSpeechRecognizer()");
    ...
    private final void J0() {
        ...
        if (bVar != null && (appCompatImageView = bVar.f74722b) != null) {
            appCompatImageView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.search.speech.j
        ...
        speechRecognizerVolumeCircleView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.search.speech.k
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void M0(long timeout) {
        H0();
        this.mHandler.postDelayed(new Runnable() { // from class: com.transsion.search.speech.l
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final void O0(SpeechRecognizerDialog speechRecognizerDialog) {
        ...
        f.f52268a.a(speechRecognizerDialog.getClassTag() + " --> setSpeechTimeout() --> 语音识别超时");
    }
    ...
    private final void initView() {
        com.transsion.search_pugc.speech.SpeechRecognizerVolumeCircleView speechRecognizerVolumeCircleView;
        com.transsion.search_pugc.speech.SpeechRecognizerVolumeCircleView speechRecognizerVolumeCircleView2;
        AppCompatTextView appCompatTextView;
        com.transsion.search_pugc.speech.SpeechRecognizerVolumeCircleView speechRecognizerVolumeCircleView3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        f.f52268a.a(getClassTag() + " --> onCreate() --> 展示弹窗组件");
    }
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        this.mCallback = null;
        f.f52268a.a(getClassTag() + " --> onDismiss() --> 语音识别弹窗关闭 释放资源");
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cVar.j(new Function0() { // from class: com.transsion.search.speech.h
        ...
        D0();
        f.f52268a.b(getClassTag() + " --> onViewCreated() --> 语音识别是否可用 = " + g.f52269a.a());
    }
}
