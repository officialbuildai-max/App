...
public final class c {
    ...
    public static final a f52263c = new a(null);

    /* renamed from: a, reason: collision with root package name */
    private Function0 f52264a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f52265b = LazyKt.b(new Function0() { // from class: com.transsion.search.speech.a
    ...
    private final Handler d() {
        return (Handler) this.f52265b.getValue();
    }

    private final SpeechRecognizer f(Context context) {
        f.f52268a.a(c() + " --> getSpeechRecognizerOneParameterStrategy() --> deviceModel = " + Build.MODEL + " --> 采用第一种策略");
    ...
    public static final void l(c cVar) {
        ...
        f.f52268a.a(cVar.c() + " --> startListening() --> 标记当前不支持第一种策略 --> 回调给场景重新加载对象");
        Function0 function0 = cVar.f52264a;
        if (function0 != null) {
        }
        q.f52281a.f();
    }
    ...
    public final SpeechRecognizer e(Context context) {
        ...
        f.f52268a.a(c() + " --> getSpeechRecognizer() --> 确定了支持第一种策略，直接返回");
        return f(context);
    }

    public final void i() {
        d().removeCallbacksAndMessages(null);
        f.f52268a.a(c() + " --> onReadyForSpeech() --> 当前策略起作用了");
    ...
    public final void k() {
        if (TextUtils.equals(com.transsion.baselib.report.launch.b.f43424a.b().getString("initialize_strategy", "initialize_one"), "initialize_two")) {
            f.f52268a.a(c() + " --> startListening() --> 当前策略已经是第二种策略了");
            return;
        }
        d().removeCallbacksAndMessages(null);
        ...
        f.f52268a.a(c() + " --> startListening() --> 开启倒计时");
    }
}
