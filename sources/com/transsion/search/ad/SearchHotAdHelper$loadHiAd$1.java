...
@DebugMetadata(c = "com.transsion.search.ad.SearchHotAdHelper$loadHiAd$1", f = "SearchHotAdHelper.kt", l = {91}, m = "invokeSuspend")
...
public final class SearchHotAdHelper$loadHiAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            this.this$0.f52011b = new BiddingSspNativeManager();
            biddingSspNativeManager = this.this$0.f52011b;
            if (biddingSspNativeManager != null) {
                ...
                cVar = searchHotAdHelper.f52021l;
