...
@DebugMetadata(c = "com.transsion.player.longvideo.member.ResolutionMemberManager$isVipResolutionTip$2", f = "ResolutionMemberManager.kt", l = {44}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class ResolutionMemberManager$isVipResolutionTip$2 extends SuspendLambda implements Function2<n0, Continuation<? super Boolean>, Object> {
    final /* synthetic */ go.a $curBean;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ResolutionMemberManager$isVipResolutionTip$2(go.a aVar, Continuation<? super ResolutionMemberManager$isVipResolutionTip$2> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Boolean> continuation) {
        return ((ResolutionMemberManager$isVipResolutionTip$2) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
