...
final class PayUtils$retryWithBackoff$2 extends SuspendLambda implements Function2<n0, Continuation<Object>, Object> {
    ...
    public PayUtils$retryWithBackoff$2(Function1<? super Continuation<Object>, ? extends Object> function1, Continuation<? super PayUtils$retryWithBackoff$2> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<Object> continuation) {
        return ((PayUtils$retryWithBackoff$2) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
