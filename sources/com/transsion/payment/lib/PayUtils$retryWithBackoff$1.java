...
public final class PayUtils$retryWithBackoff$1<T> extends ContinuationImpl {
    int I$0;
    long J$0;
    Object L$0;
    int label;
    ...
    public PayUtils$retryWithBackoff$1(PayUtils payUtils, Continuation<? super PayUtils$retryWithBackoff$1> continuation) {
        super(continuation);
