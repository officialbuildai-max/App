...
public class DataBinderMapperImpl extends androidx.databinding.e {
    ...
    private static final SparseIntArray f47819a = new SparseIntArray(0);

    /* loaded from: classes6.dex */
    private static class a {

        /* renamed from: a, reason: collision with root package name */
        static final HashMap f47820a = new HashMap(0);
    }
    ...
    public ViewDataBinding b(androidx.databinding.f fVar, View view, int i11) {
        if (f47819a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int c(String str) {
        Integer num;
        if (str == null || (num = (Integer) a.f47820a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
