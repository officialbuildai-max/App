...
final class PreloadTrendingData$loadOperatingDataFromNet$1$op$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public PreloadTrendingData$loadOperatingDataFromNet$1$op$1(PreloadTrendingData preloadTrendingData, String str, Continuation<? super PreloadTrendingData$loadOperatingDataFromNet$1$op$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((PreloadTrendingData$loadOperatingDataFromNet$1$op$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            T = preloadTrendingData.T(str, this);
            if (T == f11) {
                return f11;
            }
        } else {
