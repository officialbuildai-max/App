...
final class PreloadTrendingData$preloadSkuDataCache$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((PreloadTrendingData$preloadSkuDataCache$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            String a11 = new zm.g().a(context);
            if (a11 != null) {
                i.f79561a.b().n((SkuData) o.e(a11, o.h(SkuData.class, new Type[0])));
            }
