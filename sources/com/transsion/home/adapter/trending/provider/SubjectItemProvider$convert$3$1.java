...
@DebugMetadata(c = "com.transsion.home.adapter.trending.provider.SubjectItemProvider$convert$3$1", f = "SubjectItemProvider.kt", l = {110}, m = "invokeSuspend")
/* loaded from: classes5.dex */
final class SubjectItemProvider$convert$3$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.home.adapter.trending.provider.SubjectItemProvider$convert$3$1$1", f = "SubjectItemProvider.kt", l = {105}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Ref.ObjectRef<String> objectRef, ShapeableImageView shapeableImageView, Continuation<? super AnonymousClass1> continuation) {
    ...
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((SubjectItemProvider$convert$3$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.b f12 = kotlinx.coroutines.flow.d.f(kotlinx.coroutines.flow.d.u(kotlinx.coroutines.flow.d.s(new AnonymousClass1(this.$url, this.$this_apply, null)), y0.b()), new AnonymousClass2(null));
