...
final class SubFilterAdapter$convert$1$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public SubFilterAdapter$convert$1$1$1(ImageView imageView, Bitmap bitmap, Continuation<? super SubFilterAdapter$convert$1$1$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((SubFilterAdapter$convert$1$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
