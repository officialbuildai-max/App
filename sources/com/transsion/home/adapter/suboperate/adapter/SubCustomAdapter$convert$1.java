...
final class SubCustomAdapter$convert$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public SubCustomAdapter$convert$1(BannerData bannerData, ImageView imageView, Continuation<? super SubCustomAdapter$convert$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((SubCustomAdapter$convert$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            if (image != null && (url = image.getUrl()) != null) {
                ...
                this.label = 1;
                if (kotlinx.coroutines.i.g(c11, subCustomAdapter$convert$1$1$1, this) == f11) {
                    return f11;
                }
            }
        } else {
