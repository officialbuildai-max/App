...
final class GetInStationSubtitleListTask$disposeResponse$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public GetInStationSubtitleListTask$disposeResponse$2$1(Function1<? super Boolean, Unit> function1, Continuation<? super GetInStationSubtitleListTask$disposeResponse$2$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((GetInStationSubtitleListTask$disposeResponse$2$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
