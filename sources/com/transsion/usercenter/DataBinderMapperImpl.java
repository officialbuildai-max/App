...
public class DataBinderMapperImpl extends androidx.databinding.e {
    ...
    private static final SparseIntArray f56763a = new SparseIntArray(0);

    /* loaded from: classes6.dex */
    private static class a {

        /* renamed from: a, reason: collision with root package name */
        static final HashMap f56764a = new HashMap(0);
    }
    ...
    public ViewDataBinding b(androidx.databinding.f fVar, View view, int i11) {
        if (f56763a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int c(String str) {
        Integer num;
        if (str == null || (num = (Integer) a.f56764a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
