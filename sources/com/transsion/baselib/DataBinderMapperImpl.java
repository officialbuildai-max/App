...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f43065a = new SparseIntArray(0);

    /* loaded from: classes5.dex */
    private static class a {

        /* renamed from: a, reason: collision with root package name */
        static final HashMap f43066a = new HashMap(0);
    }
    ...
    public ViewDataBinding b(f fVar, View view, int i11) {
        if (f43065a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int c(String str) {
        Integer num;
        if (str == null || (num = (Integer) a.f43066a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
