...
public final class f implements Application.ActivityLifecycleCallbacks {
    ...
    private final SparseArray f43363a = new SparseArray(4);
    ...
    public static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Activity f43366a;

        /* renamed from: b, reason: collision with root package name */
        private Locale f43367b;

        /* renamed from: c, reason: collision with root package name */
        private Locale f43368c;

        public b(Activity activity) {
            Intrinsics.h(activity, "activity");
            this.f43366a = activity;
        }
    ...
    private final void a(View view) {
        if (view instanceof tj.a) {
            ((tj.a) view).changeLocal();
    ...
    private final void b(Activity activity) {
        a.C0856a.f(lg.a.f68962a, "LocaleManagerCB", "notifyActivityChangedLocale()-> activity = " + activity + " , waitChangedCount = " + this.f43364b, false, 4, null);
        if (this.f43364b <= 0) {
            return;
        }
        b bVar = (b) this.f43363a.get(System.identityHashCode(activity));
    ...
    private final void c() {
        ...
        SparseArray sparseArray = this.f43363a;
        Intrinsics.e(num);
    ...
    public final void e(Locale locale) {
        ...
        int size = this.f43363a.size();
        boolean z10 = false;
        if (size <= 0) {
            this.f43364b = 0;
            return;
        }
        int i12 = this.f43364b;
        int i13 = 0;
        while (i13 < size) {
            b bVar = (b) this.f43363a.valueAt(i13);
    ...
    public void onActivityDestroyed(Activity activity) {
        Intrinsics.h(activity, "activity");
        int identityHashCode = System.identityHashCode(activity);
        b bVar = (b) this.f43363a.get(identityHashCode);
        if ((bVar != null ? bVar.c() : null) != null) {
            bVar.e(null);
            this.f43364b--;
        }
        this.f43363a.remove(identityHashCode);
    }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        this.f43365c = Integer.valueOf(System.identityHashCode(activity));
        b(activity);
    }
