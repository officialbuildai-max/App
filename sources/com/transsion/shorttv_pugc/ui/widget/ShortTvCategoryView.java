...
public final class ShortTvCategoryView extends LinearLayoutCompat {
    ...
    public ShortTvCategoryView(Context context, AttributeSet attributeSet, int i11) {
        ...
        Intrinsics.h(context, "context");
        View.inflate(context, R$layout.pugc_short_tv_layout_category, this);
    ...
    private final void g() {
        this.viewBinding.f69906d.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.h
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShortTvCategoryView.h(ShortTvCategoryView.this, view);
            }
        });
        this.viewBinding.f69905c.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShortTvCategoryView.i(ShortTvCategoryView.this, view);
            }
        });
        this.viewBinding.f69904b.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.j
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
