...
public class ShimmerConstraintLayout extends ConstraintLayout {
    ...
    private final Paint f53959a;

    /* renamed from: b, reason: collision with root package name */
    private final b f53960b;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            setShimmer(((obtainStyledAttributes.hasValue(R$styleable.ShortTvShimmerConstraintLayout_short_tv_shimmer_colored) && obtainStyledAttributes.getBoolean(R$styleable.ShortTvShimmerConstraintLayout_short_tv_shimmer_colored, false)) ? new a.c() : new a.C0663a()).c(obtainStyledAttributes).a());
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f53961c && getVisibility() == 0) {
            this.f53960b.b();
        }
    }
    ...
    public void onLayout(boolean z10, int i11, int i12, int i13, int i14) {
        ...
        this.f53960b.setBounds(0, 0, getWidth(), getHeight());
    }
    ...
    protected void onVisibilityChanged(View view, int i11) {
        ...
        if (i11 != 0) {
            stopShimmer();
        } else if (this.f53961c && isAttachedToWindow()) {
            this.f53960b.b();
        }
    }
    ...
    public void startShimmer(int i11, AnimatorListenerAdapter animatorListenerAdapter) {
        this.f53960b.g(i11, animatorListenerAdapter);
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f53960b;
    }
}
