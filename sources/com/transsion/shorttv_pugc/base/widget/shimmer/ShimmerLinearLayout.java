...
public class ShimmerLinearLayout extends LinearLayout {
    ...
    private final Paint f53965a;

    /* renamed from: b, reason: collision with root package name */
    private final b f53966b;
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f53967c && getVisibility() == 0) {
            this.f53966b.b();
        }
    }
    ...
    public void onLayout(boolean z10, int i11, int i12, int i13, int i14) {
        ...
        this.f53966b.setBounds(0, 0, getWidth(), getHeight());
    }
    ...
    protected void onVisibilityChanged(View view, int i11) {
        ...
        if (i11 != 0) {
            stopShimmer();
        } else if (this.f53967c && isAttachedToWindow()) {
            this.f53966b.b();
        }
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f53966b;
    }
}
