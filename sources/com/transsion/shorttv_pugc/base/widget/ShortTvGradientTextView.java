...
public final class ShortTvGradientTextView extends TnTextView {
    ...
    @JvmOverloads
    public ShortTvGradientTextView(Context context, AttributeSet attributeSet, int i11) {
    ...
    public /* synthetic */ ShortTvGradientTextView(Context context, AttributeSet attributeSet, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
