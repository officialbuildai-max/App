...
@DebugMetadata(c = "com.transsion.shorttv_pugc.viewmodel.ShortTvDownloadViewModel$favorite$1", f = "ShortTvDownloadViewModel.kt", l = {176}, m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes6.dex */
public final class ShortTvDownloadViewModel$favorite$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public ShortTvDownloadViewModel$favorite$1(Subject subject, boolean z10, ShortTvDownloadViewModel shortTvDownloadViewModel, ShortTVFavInfo shortTVFavInfo, Continuation<? super ShortTvDownloadViewModel$favorite$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShortTvDownloadViewModel$favorite$1(this.$shortTvInfo, this.$favorite, this.this$0, this.$favoriteInfo, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTvDownloadViewModel$favorite$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i11 == 0) {
                ...
                this.label = 1;
                obj = a.C0937a.a(f11, create, null, this, 2, null);
                if (obj == f12) {
                    return f12;
                }
            } else {
        ...
        ShortTvDownloadViewModel shortTvDownloadViewModel2 = this.this$0;
        ...
        if (Result.m1192isSuccessimpl(m1185constructorimpl)) {
            if (shortTVFavInfo.getHasFavorite() != (!z11)) {
                ...
                shortTvDownloadViewModel2.j().q(!z11 ? Boxing.d(1) : Boxing.d(2));
        ...
        ShortTvDownloadViewModel shortTvDownloadViewModel3 = this.this$0;
        if (Result.m1188exceptionOrNullimpl(m1185constructorimpl) != null) {
            shortTvDownloadViewModel3.j().q(Boxing.d(0));
        }
        return Unit.f67184a;
    }
}
