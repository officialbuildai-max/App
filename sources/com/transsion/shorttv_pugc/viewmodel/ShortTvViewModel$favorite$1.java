...
@DebugMetadata(c = "com.transsion.shorttv_pugc.viewmodel.ShortTvViewModel$favorite$1", f = "ShortTvViewModel.kt", l = {Sdk$SDKError.Reason.AD_CLOSED_MISSING_HEARTBEAT_VALUE}, m = "invokeSuspend")
...
public final class ShortTvViewModel$favorite$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public ShortTvViewModel$favorite$1(ShortTvViewModel shortTvViewModel, String str, boolean z10, Continuation<? super ShortTvViewModel$favorite$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShortTvViewModel$favorite$1(this.this$0, this.$ugcVideoId, this.$favorite, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i11 == 0) {
                ...
                String str2 = z10 ? "0" : "1";
                this.label = 1;
                obj = a.C0937a.h(aVar, null, str, str2, this, 1, null);
                if (obj == f11) {
                    return f11;
                }
            } else {
