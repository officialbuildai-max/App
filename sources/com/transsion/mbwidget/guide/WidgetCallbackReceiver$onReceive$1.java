...
final class WidgetCallbackReceiver$onReceive$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public WidgetCallbackReceiver$onReceive$1(Continuation<? super WidgetCallbackReceiver$onReceive$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((WidgetCallbackReceiver$onReceive$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
