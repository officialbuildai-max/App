...
public final class BitmapUtils$loadBitmap$bitmap$1 extends SuspendLambda implements Function2<n0, Continuation<? super Bitmap>, Object> {
    ...
    public BitmapUtils$loadBitmap$bitmap$1(Context context, String str, Continuation<? super BitmapUtils$loadBitmap$bitmap$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Bitmap> continuation) {
        return ((BitmapUtils$loadBitmap$bitmap$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
