...
public final class MemberTaskAdHelper$loadRegularAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ MemberTaskAdHelper this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MemberTaskAdHelper$loadRegularAd$1(MemberTaskAdHelper memberTaskAdHelper, Continuation<? super MemberTaskAdHelper$loadRegularAd$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((MemberTaskAdHelper$loadRegularAd$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            int f12 = RangesKt.f(MemberTaskAdHelper.f51091r.a(), 2);
            biddingSspNativeManager = this.this$0.f51099k;
