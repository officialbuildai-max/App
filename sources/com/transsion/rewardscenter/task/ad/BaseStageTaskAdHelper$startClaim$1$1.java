...
public final class BaseStageTaskAdHelper$startClaim$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public BaseStageTaskAdHelper$startClaim$1$1(MemberTaskItem memberTaskItem, BaseStageTaskAdHelper baseStageTaskAdHelper, v vVar, Function0<Unit> function0, Continuation<? super BaseStageTaskAdHelper$startClaim$1$1> continuation) {
    ...
    public static final Unit g(BaseStageTaskAdHelper baseStageTaskAdHelper, String str, String str2) {
        ...
        Context context;
        aVar = baseStageTaskAdHelper.f51090d;
        if (aVar != null) {
            aVar.b();
        }
        if (str2 == null) {
            context = baseStageTaskAdHelper.f51087a;
    ...
    public static final Unit h(v vVar, BaseStageTaskAdHelper baseStageTaskAdHelper, Function0 function0, TaskRewards taskRewards) {
        ...
        if (taskRewards != null) {
            ...
            a.C0856a.f(lg.a.f68962a, "StageTaskAd", "----> claimMemberShipReward: " + taskRewards.getTaskInfo() + ", " + taskRewards.getCurrentPoint(), false, 4, null);
            u.f51176a.b(vVar, taskRewards.getTaskInfo());
            aVar = baseStageTaskAdHelper.f51090d;
            if (aVar != null) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((BaseStageTaskAdHelper$startClaim$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
        ...
        if (i11 == 0) {
            ...
            Function2 function2 = new Function2() { // from class: com.transsion.rewardscenter.task.ad.b
                ...
                public final Object invoke(Object obj2, Object obj3) {
                    Unit g11;
                    g11 = BaseStageTaskAdHelper$startClaim$1$1.g(BaseStageTaskAdHelper.this, (String) obj2, (String) obj3);
                    return g11;
                }
            };
            ...
            Function1 function1 = new Function1() { // from class: com.transsion.rewardscenter.task.ad.c
                ...
                public final Object invoke(Object obj2) {
                    Unit h11;
                    h11 = BaseStageTaskAdHelper$startClaim$1$1.h(v.this, baseStageTaskAdHelper2, function0, (TaskRewards) obj2);
                    return h11;
                }
            };
            this.label = 1;
