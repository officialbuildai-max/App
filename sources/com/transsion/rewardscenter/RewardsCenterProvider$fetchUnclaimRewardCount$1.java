...
@DebugMetadata(c = "com.transsion.rewardscenter.RewardsCenterProvider$fetchUnclaimRewardCount$1", f = "RewardsCenterProvider.kt", l = {57}, m = "invokeSuspend")
...
final class RewardsCenterProvider$fetchUnclaimRewardCount$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public RewardsCenterProvider$fetchUnclaimRewardCount$1(RewardsCenterProvider rewardsCenterProvider, Continuation<? super RewardsCenterProvider$fetchUnclaimRewardCount$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RewardsCenterProvider$fetchUnclaimRewardCount$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i11 == 0) {
                ...
                this.label = 1;
                obj = a.C0966a.e(k11, null, this, 1, null);
                if (obj == f11) {
                    return f11;
                }
            } else {
        ...
        if (Result.m1192isSuccessimpl(m1185constructorimpl)) {
            ...
            if (n.a(baseDto)) {
                ...
                b0Var = rewardsCenterProvider2.f51004c;
                b0Var.n(Boxing.d(size));
                a.C0856a.f(lg.a.f68962a, "RewardsCenter", "fetchUnclaimRewardCount: " + size, false, 4, null);
            }
        }
        Throwable m1188exceptionOrNullimpl = Result.m1188exceptionOrNullimpl(m1185constructorimpl);
        if (m1188exceptionOrNullimpl != null) {
            a.C0856a.f(lg.a.f68962a, "RewardsCenter", "fetchUnclaimRewardCount error: " + m1188exceptionOrNullimpl.getMessage(), false, 4, null);
        }
        return Unit.f67184a;
    }
}
