...
public final class RoomViewModel$getRoomTabs$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ RoomViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002*\n\u0012\u0006\u0012\u0004\u0018\u00010\u00010\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lkotlinx/coroutines/flow/c;", "Lcom/transsion/moviedetailapi/bean/RoomTabBean;", "", "<anonymous>", "(Lkotlinx/coroutines/flow/c;)V"}, k = 3, mv = {2, 1, 0})
    @DebugMetadata(c = "com.transsion.room.viewmodel.RoomViewModel$getRoomTabs$1$1", f = "RoomViewModel.kt", l = {MBSupportMuteAdType.INTERSTITIAL_VIDEO, 289, 291}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.L$0 = cVar;
                this.label = 1;
                obj = a.C0769a.c(K, null, str, this, 1, null);
                if (obj == f11) {
                    return f11;
                }
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0005\u001a\u00020\u0004*\n\u0012\u0006\u0012\u0004\u0018\u00010\u00010\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\n¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"Lkotlinx/coroutines/flow/c;", "Lcom/transsion/moviedetailapi/bean/RoomTabBean;", "", "it", "", "<anonymous>", "(Lkotlinx/coroutines/flow/c;Ljava/lang/Throwable;)V"}, k = 3, mv = {2, 1, 0})
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        public final Object emit(RoomTabBean roomTabBean, Continuation continuation) {
            ...
            if (version != null && version.length() != 0) {
                ...
                if (!Intrinsics.c(str, this.f51909b)) {
                    a.C0856a.f(lg.a.f68962a, "RoomViewModel", "getRoomTabs update tab， savedVersion:" + this.f51909b + ", newVersion:" + (roomTabBean != null ? roomTabBean.getVersion() : null) + " ", false, 4, null);
                    b0Var = this.f51908a.f51891d;
                    b0Var.n(roomTabBean);
                    return Unit.f67184a;
                }
            }
            lg.a.f68962a.c("RoomViewModel", "getRoomTabs version same, version:" + (roomTabBean != null ? roomTabBean.getVersion() : null), true);
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomViewModel$getRoomTabs$1(RoomViewModel roomViewModel, Continuation<? super RoomViewModel$getRoomTabs$1> continuation) {
        super(2, continuation);
        this.this$0 = roomViewModel;
    }
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RoomViewModel$getRoomTabs$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            String string = com.transsion.baselib.report.launch.b.f43424a.b().getString("k_room_tab_cache_version", "2493811379");
            String str = string != null ? string : "2493811379";
            a.C0856a.f(lg.a.f68962a, "RoomViewModel", "getRoomTabs savedVersion：" + str, false, 4, null);
            kotlinx.coroutines.flow.b f12 = kotlinx.coroutines.flow.d.f(kotlinx.coroutines.flow.d.u(kotlinx.coroutines.flow.d.s(new AnonymousClass1(this.this$0, str, null)), y0.b()), new AnonymousClass2(null));
