...
@DebugMetadata(c = "com.transsion.room.helper.LocationPlaceHelper$startRealTimeUpdates$1$onLocationResult$1$1", f = "LocationPlaceHelper.kt", l = {Sdk$SDKError.Reason.INVALID_WATERFALL_PLACEMENT_ID_VALUE}, m = "invokeSuspend")
...
final class LocationPlaceHelper$startRealTimeUpdates$1$onLocationResult$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LocationPlaceHelper$startRealTimeUpdates$1$onLocationResult$1$1(double d11, double d12, Function1<? super LocationPlace, Unit> function1, Continuation<? super LocationPlaceHelper$startRealTimeUpdates$1$onLocationResult$1$1> continuation) {
        super(2, continuation);
        this.$latitude = d11;
        this.$longitude = d12;
        this.$callback = function1;
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((LocationPlaceHelper$startRealTimeUpdates$1$onLocationResult$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            lg.a.f68962a.c("LocationP", "Location--update--------------2 success " + this.$longitude + ", :" + this.$latitude + ", address:" + m11, true);
