...
public final /* data */ class SubscriptionUserUnreadCountData implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final SubscriptionUserUnreadCountData[] newArray(int i11) {
            return new SubscriptionUserUnreadCountData[i11];
        }
    }
    ...
    public SubscriptionUserUnreadCountData(int i11) {
        this.unreadCount = i11;
    }

    public /* synthetic */ SubscriptionUserUnreadCountData(int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? 0 : i11);
    }

    public static /* synthetic */ SubscriptionUserUnreadCountData copy$default(SubscriptionUserUnreadCountData subscriptionUserUnreadCountData, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i11 = subscriptionUserUnreadCountData.unreadCount;
        }
        return subscriptionUserUnreadCountData.copy(i11);
    }
