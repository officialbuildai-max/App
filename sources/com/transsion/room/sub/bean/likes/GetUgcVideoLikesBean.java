...
public final /* data */ class GetUgcVideoLikesBean implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final GetUgcVideoLikesBean[] newArray(int i11) {
            return new GetUgcVideoLikesBean[i11];
        }
    }

    public GetUgcVideoLikesBean(PagerInfoLikes pager, List<UGCVideo> list) {
        Intrinsics.h(pager, "pager");
        this.pager = pager;
        this.items = list;
    }

    public /* synthetic */ GetUgcVideoLikesBean(PagerInfoLikes pagerInfoLikes, List list, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? new PagerInfoLikes(false, null, null, 0, 0, 31, null) : pagerInfoLikes, list);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ GetUgcVideoLikesBean copy$default(GetUgcVideoLikesBean getUgcVideoLikesBean, PagerInfoLikes pagerInfoLikes, List list, int i11, Object obj) {
        if ((i11 & 1) != 0) {
