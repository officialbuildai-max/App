...
public class BaseLoadMoreView extends q6.a implements View.OnAttachStateChangeListener, Parcelable {
    ...
    /* renamed from: com.transsion.baseui.widget.BaseLoadMoreView$a, reason: from kotlin metadata */
    ...
    public void convert(BaseViewHolder holder, int position, LoadMoreStatus loadMoreStatus) {
        ...
        if (b.f43593a[loadMoreStatus.ordinal()] == 1) {
            jg.c.k(getLoadingView(holder));
        } else {
            jg.c.g(getLoadingView(holder));
        }
    }
    ...
    public View getLoadFailView(BaseViewHolder holder) {
        ...
        appCompatTextView.setText(m.f70597a.e() ? appCompatTextView.getContext().getString(R$string.base_load_err) : appCompatTextView.getContext().getString(com.tn.lib.widget.R$string.no_network_tips));
