...
public final /* data */ class PreVideoAddress implements Serializable {
    ...
    public PreVideoAddress(Integer num, String str, Integer num2, Integer num3, Integer num4, Long l11, Integer num5, String str2, String str3, Integer num6) {
        this.bitrate = num;
        this.definition = str;
        this.duration = num2;
        this.fps = num3;
    ...
    public final PreVideoAddress copy(Integer bitrate, String definition, Integer duration, Integer fps, Integer height, Long size, Integer type, String url, String videoId, Integer width) {
        return new PreVideoAddress(bitrate, definition, duration, fps, height, size, type, url, videoId, width);
    }
