...
public final /* data */ class ShortTVItem implements Serializable {
    ...
    public final e toMediaSource() {
        ...
        if (url != null && url.length() != 0) {
            String str = this.id;
            eVar = new e(str == null ? url : str, url, this.ep, null, null, 24, null);
        }
        return eVar;
    }
