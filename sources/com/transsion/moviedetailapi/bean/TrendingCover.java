...
public final /* data */ class TrendingCover implements Serializable {
    ...
    public TrendingCover(Integer num, Integer num2, Integer num3, String str, String str2, String str3, GifBean gifBean, String str4, String str5) {
        this.width = num;
        this.height = num2;
        this.size = num3;
        this.url = str;
    ...
    public /* synthetic */ TrendingCover(Integer num, Integer num2, Integer num3, String str, String str2, String str3, GifBean gifBean, String str4, String str5, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final TrendingCover copy(Integer width, Integer height, Integer size, String url, String format, String thumbnail, GifBean gifBean, String averageHueLight, String averageHueDark) {
        return new TrendingCover(width, height, size, url, format, thumbnail, gifBean, averageHueLight, averageHueDark);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TrendingCover)) {
            return false;
        }
        TrendingCover trendingCover = (TrendingCover) other;
        return Intrinsics.c(this.width, trendingCover.width) && Intrinsics.c(this.height, trendingCover.height) && Intrinsics.c(this.size, trendingCover.size) && Intrinsics.c(this.url, trendingCover.url) && Intrinsics.c(this.format, trendingCover.format) && Intrinsics.c(this.thumbnail, trendingCover.thumbnail) && Intrinsics.c(this.gifBean, trendingCover.gifBean) && Intrinsics.c(this.averageHueLight, trendingCover.averageHueLight) && Intrinsics.c(this.averageHueDark, trendingCover.averageHueDark);
    }
    ...
    public String toString() {
        return "TrendingCover(width=" + this.width + ", height=" + this.height + ", size=" + this.size + ", url=" + this.url + ", format=" + this.format + ", thumbnail=" + this.thumbnail + ", gifBean=" + this.gifBean + ", averageHueLight=" + this.averageHueLight + ", averageHueDark=" + this.averageHueDark + ")";
    }
}
