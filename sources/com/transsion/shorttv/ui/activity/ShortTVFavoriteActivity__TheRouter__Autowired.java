...
public class ShortTVFavoriteActivity__TheRouter__Autowired {
    ...
    public static void autowiredInject(Object obj) {
        if (obj instanceof ShortTVFavoriteActivity) {
            ...
            while (it.hasNext()) {
                try {
                    String str = (String) ((a) it.next()).a("java.lang.String", shortTVFavoriteActivity, new b("java.lang.String", "ops", 0, "", "com.transsion.shorttv.ui.activity.ShortTVFavoriteActivity", "ops", false, "No desc."));
                    if (str != null) {
