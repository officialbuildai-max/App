...
final class ShortTvListActivity$preloadAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public ShortTvListActivity$preloadAd$1(String str, Continuation<? super ShortTvListActivity$preloadAd$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTvListActivity$preloadAd$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            BiddingHiSavanaNativeProvider b11 = BiddingHiSavanaNativeProvider.f42037j.b(this.$overlaySceneId);
            if (b11 != null) {
                String str = this.$overlaySceneId;
                this.label = 1;
                if (BiddingHiSavanaNativeProvider.v(b11, str, null, this, 2, null) == f11) {
                    return f11;
                }
            }
        } else {
