...
@DebugMetadata(c = "com.transsion.shorttv.ui.adapter.provider.ShortTvListSubjectProvider$loadBuiltInCover$1", f = "ShortTvListSubjectProvider.kt", l = {167}, m = "invokeSuspend")
/* loaded from: classes6.dex */
final class ShortTvListSubjectProvider$loadBuiltInCover$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.shorttv.ui.adapter.provider.ShortTvListSubjectProvider$loadBuiltInCover$1$1", f = "ShortTvListSubjectProvider.kt", l = {164}, m = "invokeSuspend")
    /* renamed from: com.transsion.shorttv.ui.adapter.provider.ShortTvListSubjectProvider$loadBuiltInCover$1$1, reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    @DebugMetadata(c = "com.transsion.shorttv.ui.adapter.provider.ShortTvListSubjectProvider$loadBuiltInCover$1$2", f = "ShortTvListSubjectProvider.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.transsion.shorttv.ui.adapter.provider.ShortTvListSubjectProvider$loadBuiltInCover$1$2, reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ AppCompatImageView f53223a;

        a(AppCompatImageView appCompatImageView) {
            this.f53223a = appCompatImageView;
        }

        @Override // kotlinx.coroutines.flow.c
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Object emit(Bitmap bitmap, Continuation continuation) {
            this.f53223a.setImageBitmap(bitmap);
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShortTvListSubjectProvider$loadBuiltInCover$1(Subject subject, AppCompatImageView appCompatImageView, Continuation<? super ShortTvListSubjectProvider$loadBuiltInCover$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_loadBuiltInCover = appCompatImageView;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShortTvListSubjectProvider$loadBuiltInCover$1(this.$item, this.$this_loadBuiltInCover, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTvListSubjectProvider$loadBuiltInCover$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
