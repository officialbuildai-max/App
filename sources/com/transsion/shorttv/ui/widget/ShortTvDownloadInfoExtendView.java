...
public final class ShortTvDownloadInfoExtendView extends ConstraintLayout {
    ...
    private final String getNewTextByConfig() {
        ...
        ms.s0 s0Var2 = this.mViewBinding;
        ...
        ms.s0 s0Var3 = this.mViewBinding;
    ...
    private final void m() {
        AppCompatTextView appCompatTextView;
        ms.s0 a11 = ms.s0.a(View.inflate(getContext(), R$layout.short_tv_view_download_info_extend_layout, this));
    ...
    public final void showData(Subject bean) {
        ...
        root.post(new Runnable() { // from class: com.transsion.shorttv.ui.widget.o
    ...
    public final void showData(String desc) {
        ...
        root.post(new Runnable() { // from class: com.transsion.shorttv.ui.widget.n
            @Override // java.lang.Runnable
            public final void run() {
