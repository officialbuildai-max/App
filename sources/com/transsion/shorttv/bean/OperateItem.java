...
public final /* data */ class OperateItem implements Parcelable {
    ...
    public /* synthetic */ OperateItem(String str, String str2, Integer num, String str3, BannerBean bannerBean, List list, List list2, CustomData customData, PlayListItem playListItem, Subject subject, String str4, SingleImagePage singleImagePage, List list3, RankingData rankingData, RankingListData rankingListData, List list4, List list5, BiddingNativeManager biddingNativeManager, String str5, String str6, String str7, int i11, DefaultConstructorMarker defaultConstructorMarker) {
