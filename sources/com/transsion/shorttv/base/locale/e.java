...
public final class e implements Application.ActivityLifecycleCallbacks {
    ...
    private final SparseArray f52865a = new SparseArray(4);

    /* renamed from: b, reason: collision with root package name */
    private int f52866b;

    /* renamed from: c, reason: collision with root package name */
    private Integer f52867c;
    ...
    public static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Activity f52868a;

        /* renamed from: b, reason: collision with root package name */
        private Locale f52869b;

        /* renamed from: c, reason: collision with root package name */
        private Locale f52870c;

        public b(Activity activity) {
            Intrinsics.h(activity, "activity");
            this.f52868a = activity;
        }
    ...
    private final void a(View view) {
        if (view instanceof bs.a) {
            ((bs.a) view).changeLocal();
    ...
    private final void b(Activity activity) {
        a.C0856a.f(lg.a.f68962a, "LocaleManagerCB", "notifyActivityChangedLocale()-> activity = " + activity + " , waitChangedCount = " + this.f52866b, false, 4, null);
        if (this.f52866b <= 0) {
            return;
        }
        b bVar = (b) this.f52865a.get(System.identityHashCode(activity));
    ...
    private final void c() {
        Integer num = this.f52867c;
        if (num == null) {
            return;
        }
        SparseArray sparseArray = this.f52865a;
        Intrinsics.e(num);
    ...
    public final void e(Locale locale) {
        ...
        int i12 = this.f52866b;
        int i13 = 0;
        while (i13 < size) {
            b bVar = (b) this.f52865a.valueAt(i13);
    ...
    public void onActivityDestroyed(Activity activity) {
        Intrinsics.h(activity, "activity");
        int identityHashCode = System.identityHashCode(activity);
        b bVar = (b) this.f52865a.get(identityHashCode);
        if ((bVar != null ? bVar.c() : null) != null) {
            bVar.e(null);
            this.f52866b--;
        }
        this.f52865a.remove(identityHashCode);
    }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        this.f52867c = Integer.valueOf(System.identityHashCode(activity));
        b(activity);
    }
