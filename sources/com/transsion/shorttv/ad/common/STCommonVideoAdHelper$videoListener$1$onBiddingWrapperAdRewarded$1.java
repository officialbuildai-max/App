...
final class STCommonVideoAdHelper$videoListener$1$onBiddingWrapperAdRewarded$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public STCommonVideoAdHelper$videoListener$1$onBiddingWrapperAdRewarded$1(STCommonVideoAdHelper sTCommonVideoAdHelper, Continuation<? super STCommonVideoAdHelper$videoListener$1$onBiddingWrapperAdRewarded$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((STCommonVideoAdHelper$videoListener$1$onBiddingWrapperAdRewarded$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            function0 = sTCommonVideoAdHelper.f52758f;
            if (function0 != null) {
                function0.invoke();
                unit = Unit.f67184a;
            } else {
