...
@DebugMetadata(c = "com.transsion.postdetail.ui.view.ImmVideoItemView$updateVideoInfo$1", f = "ImmVideoItemView.kt", l = {418}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class ImmVideoItemView$updateVideoInfo$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.ui.view.ImmVideoItemView$updateVideoInfo$1$1", f = "ImmVideoItemView.kt", l = {TTAdConstant.VIDEO_COVER_URL_CODE}, m = "invokeSuspend")
    ...
    @DebugMetadata(c = "com.transsion.postdetail.ui.view.ImmVideoItemView$updateVideoInfo$1$2", f = "ImmVideoItemView.kt", l = {}, m = "invokeSuspend")
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ ImmVideoItemView f49990a;

        a(ImmVideoItemView immVideoItemView) {
            this.f49990a = immVideoItemView;
        }

        @Override // kotlinx.coroutines.flow.c
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Object emit(Bitmap bitmap, Continuation continuation) {
            this.f49990a.viewBinding.f75893i.setImageBitmap(bitmap);
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ImmVideoItemView$updateVideoInfo$1(PostSubjectItem postSubjectItem, ImmVideoItemView immVideoItemView, Continuation<? super ImmVideoItemView$updateVideoInfo$1> continuation) {
        super(2, continuation);
        this.$item = postSubjectItem;
        this.this$0 = immVideoItemView;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ImmVideoItemView$updateVideoInfo$1(this.$item, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ImmVideoItemView$updateVideoInfo$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
