...
public class RoomPostSubFragment extends RoomPostBaseFragment {
    ...
    private final Lazy trendingImageRoomsViewModel = FragmentViewModelLazyKt.a(this, Reflection.b(aq.g.class), new Function0<androidx.view.x0>() { // from class: com.transsion.postdetail.ui.fragment.RoomPostSubFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
    ...
    }, new Function0<v0.c>() { // from class: com.transsion.postdetail.ui.fragment.RoomPostSubFragment$special$$inlined$activityViewModels$default$2
        {
            super(0);
        }
    ...
    /* renamed from: com.transsion.postdetail.ui.fragment.RoomPostSubFragment$a, reason: from kotlin metadata */
    /* loaded from: classes6.dex */
    public static final class Companion {
        ...
        public final RoomPostSubFragment a(String str, RoomTabItem item, int i11) {
            Intrinsics.h(item, "item");
            RoomPostSubFragment roomPostSubFragment = new RoomPostSubFragment();
            roomPostSubFragment.setArguments(androidx.core.os.d.b(TuplesKt.a(RoomPostSubFragment.TAB_ITEM, item), TuplesKt.a(RoomPostSubFragment.TAB_INDEX, Integer.valueOf(i11)), TuplesKt.a("parent_type", str)));
            return roomPostSubFragment;
        }
    }
    ...
    public static final class b implements ak.q {
        ...
        public void a(int i11) {
            if (RoomPostSubFragment.this.curExposurePosition < i11) {
                RoomPostSubFragment.this.curExposurePosition = i11;
            }
        }
    }
    ...
    static final class c implements androidx.view.c0, FunctionAdapter {
        ...
        private final /* synthetic */ Function1 f49669a;
    ...
    public static final Unit initViewModel$lambda$1(RoomPostSubFragment roomPostSubFragment, PostSubjectBean postSubjectBean) {
        String str;
        List<PostSubjectItem> items;
        PostSubjectItem postSubjectItem;
        String ops;
        if (postSubjectBean != null && postSubjectBean.getIsRefresh() && (str = roomPostSubFragment.insertPostOps) != null && str.length() != 0 && (items = postSubjectBean.getItems()) != null && (postSubjectItem = (PostSubjectItem) CollectionsKt.k0(items)) != null && Intrinsics.c(postSubjectItem.getPostId(), roomPostSubFragment.insertPostId) && ((ops = postSubjectItem.getOps()) == null || ops.length() == 0)) {
            postSubjectItem.setOps(roomPostSubFragment.insertPostOps);
        }
        roomPostSubFragment.updateData(postSubjectBean);
        return Unit.f67184a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    public static final Unit initViewModel$lambda$3(RoomPostSubFragment roomPostSubFragment, Pair pair) {
        ...
        if (g12 != null && g12.length() != 0) {
            roomPostSubFragment.pageFrom = hVar.g();
            hVar.r(null);
        }
        if (roomPostSubFragment.pageFrom != null && (logViewConfig = roomPostSubFragment.getLogViewConfig()) != null && (g11 = logViewConfig.g()) != null) {
        }
        roomPostSubFragment.insertPostOps = (String) pair.getSecond();
        roomPostSubFragment.insertPostId = str;
        RoomPostBaseFragment.loadData$default(roomPostSubFragment, false, true, 1, null);
        so.s sVar = (so.s) roomPostSubFragment.getMViewBinding();
        if (sVar != null && (recyclerView = sVar.f75827b) != null) {
            recyclerView.scrollToPosition(0);
        }
        roomPostSubFragment.insertPostId = null;
        return Unit.f67184a;
    }
    ...
    private final void trySaveDataCache(boolean isSaveInstance) {
        ...
        if (i12 > 0 && size > i12) {
            ...
            int i14 = bVar.b().getInt("post_sub_page_cache_code", 0);
            ...
            bVar.b().putInt("post_sub_page_cache_code", hashCode);
            bVar.b().putString("post_sub_page_cache_" + tabId, j11);
        }
    }
    ...
    public void initViewModel() {
        ...
        if (mViewModel != null && (W = mViewModel.W()) != null) {
            W.j(this, new c(new Function1() { // from class: com.transsion.postdetail.ui.fragment.f5
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit initViewModel$lambda$1;
                    initViewModel$lambda$1 = RoomPostSubFragment.initViewModel$lambda$1(RoomPostSubFragment.this, (PostSubjectBean) obj);
                    return initViewModel$lambda$1;
                }
            }));
        }
        getTrendingImageRoomsViewModel().b().j(this, new c(new Function1() { // from class: com.transsion.postdetail.ui.fragment.g5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit initViewModel$lambda$3;
                initViewModel$lambda$3 = RoomPostSubFragment.initViewModel$lambda$3(RoomPostSubFragment.this, (Pair) obj);
    ...
    public void lazyLoadWithoutNet() {
        ...
        mViewModel.i0(mTopTab.getTabId());
    }
    ...
    public String subpageName() {
        String str;
        RoomTabItem mTopTab = getMTopTab();
        if (mTopTab == null || (str = mTopTab.getTabId()) == null) {
            str = "";
        }
        return "room_home_" + str;
    }
