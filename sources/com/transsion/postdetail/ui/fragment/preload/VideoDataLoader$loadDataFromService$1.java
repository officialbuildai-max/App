...
final class VideoDataLoader$loadDataFromService$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (baseDto.getData() == null) {
                ...
                PostSubjectBean postSubjectBean = new PostSubjectBean(CollectionsKt.q((PostSubjectItem) data), new Pager(Boxing.a(false), "1", "1", Boxing.d(0), Boxing.d(1)), null, null);
                this.L$0 = null;
                this.label = 3;
                if (cVar.emit(postSubjectBean, this) == f11) {
                    return f11;
                }
            }
            return Unit.f67184a;
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function3<kotlinx.coroutines.flow.c, Throwable, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                a.C0856a.g(lg.a.f68962a, "imm video get postDetail failed", false, 2, null);
                this.label = 1;
                if (cVar.emit(null, this) == f11) {
                    return f11;
                }
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ VideoDataLoader f49841a;

        a(VideoDataLoader videoDataLoader) {
            this.f49841a = videoDataLoader;
        }
        ...
        public final Object emit(PostSubjectBean postSubjectBean, Continuation continuation) {
            if (postSubjectBean == null) {
                ...
                this.f49841a.d(postSubjectBean);
            }
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoDataLoader$loadDataFromService$1(VideoDataLoader videoDataLoader, Continuation<? super VideoDataLoader$loadDataFromService$1> continuation) {
        super(2, continuation);
        this.this$0 = videoDataLoader;
    }
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((VideoDataLoader$loadDataFromService$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
