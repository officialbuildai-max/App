...
final class ShortTvWatchAdDialog$videoListener$1$onBiddingLoad$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShortTvWatchAdDialog$videoListener$1$onBiddingLoad$1(ShortTvWatchAdDialog shortTvWatchAdDialog, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean, Continuation<? super ShortTvWatchAdDialog$videoListener$1$onBiddingLoad$1> continuation) {
        super(2, continuation);
        this.this$0 = shortTvWatchAdDialog;
        this.$maxEcpmObject = biddingIntermediateMaterialBean;
    }
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTvWatchAdDialog$videoListener$1$onBiddingLoad$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
