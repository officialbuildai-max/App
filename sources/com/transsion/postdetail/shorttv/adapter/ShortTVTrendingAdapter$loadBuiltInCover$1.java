...
@DebugMetadata(c = "com.transsion.postdetail.shorttv.adapter.ShortTVTrendingAdapter$loadBuiltInCover$1", f = "ShortTVTrendingAdapter.kt", l = {169}, m = "invokeSuspend")
/* loaded from: classes6.dex */
final class ShortTVTrendingAdapter$loadBuiltInCover$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.shorttv.adapter.ShortTVTrendingAdapter$loadBuiltInCover$1$1", f = "ShortTVTrendingAdapter.kt", l = {166}, m = "invokeSuspend")
    /* renamed from: com.transsion.postdetail.shorttv.adapter.ShortTVTrendingAdapter$loadBuiltInCover$1$1, reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    @DebugMetadata(c = "com.transsion.postdetail.shorttv.adapter.ShortTVTrendingAdapter$loadBuiltInCover$1$2", f = "ShortTVTrendingAdapter.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.transsion.postdetail.shorttv.adapter.ShortTVTrendingAdapter$loadBuiltInCover$1$2, reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    public static final class a implements c {
        ...
        final /* synthetic */ AppCompatImageView f49251a;

        a(AppCompatImageView appCompatImageView) {
            this.f49251a = appCompatImageView;
        }

        @Override // kotlinx.coroutines.flow.c
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Object emit(Bitmap bitmap, Continuation continuation) {
            this.f49251a.setImageBitmap(bitmap);
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShortTVTrendingAdapter$loadBuiltInCover$1(Subject subject, AppCompatImageView appCompatImageView, Continuation<? super ShortTVTrendingAdapter$loadBuiltInCover$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_loadBuiltInCover = appCompatImageView;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ShortTVTrendingAdapter$loadBuiltInCover$1(this.$item, this.$this_loadBuiltInCover, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTVTrendingAdapter$loadBuiltInCover$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.b f12 = d.f(d.u(d.s(new AnonymousClass1(this.$item, this.$this_loadBuiltInCover, null)), y0.b()), new AnonymousClass2(null));
