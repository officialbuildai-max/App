...
final class ShortTVHeaderViewAdapter$loadBuiltInCover$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.shorttv.adapter.ShortTVHeaderViewAdapter$loadBuiltInCover$1$1", f = "ShortTVHeaderViewAdapter.kt", l = {TmcConstants.NOTIFY_ADDHOME_GUIDE_TOP_SHOW}, m = "invokeSuspend")
    ...
    public static final class a implements c {
        ...
        final /* synthetic */ AppCompatImageView f49250a;

        a(AppCompatImageView appCompatImageView) {
            this.f49250a = appCompatImageView;
        }

        @Override // kotlinx.coroutines.flow.c
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Object emit(Bitmap bitmap, Continuation continuation) {
            this.f49250a.setImageBitmap(bitmap);
            return Unit.f67184a;
        }
    }
