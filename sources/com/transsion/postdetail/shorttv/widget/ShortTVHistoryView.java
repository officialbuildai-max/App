...
public final class ShortTVHistoryView extends LinearLayout {
    ...
    public static final class b implements sj.a {
        ...
        public void a(int i11, long j11, View view) {
            ...
            if (subject != null) {
                ShortTVHistoryView.this.recReport.a("minitv_explore", subject, i11, j11, ShortTVHistoryView.this.getItemOptType());
            }
        }
    }
            ...
            if (parent.getAdapter() != null) {
                if (childAdapterPosition == 0) {
                    if (ShortTVHistoryView.this.isRTL) {
                        outRect.right = ShortTVHistoryView.this.dp8 * 2;
                        return;
                    } else {
                        outRect.left = ShortTVHistoryView.this.dp8 * 2;
                        return;
                    }
                }
                if (childAdapterPosition == r4.getItemCount() - 1) {
                    outRect.right = ShortTVHistoryView.this.dp8;
                    outRect.left = ShortTVHistoryView.this.dp8;
    ...
    public static final class d implements c0, FunctionAdapter {
        ...
        private final /* synthetic */ Function1 f49331a;

        d(Function1 function) {
            Intrinsics.h(function, "function");
            this.f49331a = function;
        }
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            this.f49331a.invoke(obj);
        }
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ShortTVHistoryView(Fragment fragment, String type, com.transsion.postdetail.shorttv.j recReport, Context context) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ShortTVHistoryView(Fragment fragment, String type, com.transsion.postdetail.shorttv.j recReport, Context context, AttributeSet attributeSet) {
    ...
    public ShortTVHistoryView(final Fragment fragment, String type, com.transsion.postdetail.shorttv.j recReport, Context context, AttributeSet attributeSet, int i11) {
    ...
    private final void c() {
        ...
        shortTVHeaderViewAdapter.w1(new p6.d() { // from class: com.transsion.postdetail.shorttv.widget.i
            @Override // p6.d
            public final void a(BaseQuickAdapter baseQuickAdapter, View view, int i11) {
                ShortTVHistoryView.d(ShortTVHistoryView.this, baseQuickAdapter, view, i11);
            }
        });
        this.headerAdapter = shortTVHeaderViewAdapter;
        RecyclerView recyclerView = this.viewBinding.f75696b;
    ...
    public static final void d(ShortTVHistoryView shortTVHistoryView, BaseQuickAdapter adapter, View view, int i11) {
        Intrinsics.h(adapter, "adapter");
        Intrinsics.h(view, "<unused var>");
        Object item = adapter.getItem(i11);
        if (item instanceof Subject) {
            Subject subject = (Subject) item;
            shortTVHistoryView.recReport.b("minitv_explore", subject, i11, shortTVHistoryView.getItemOptType());
    ...
    private final void e() {
        if (Intrinsics.c(this.type, TYPE_HISTORY)) {
            TnTextView tvTitleTrending = this.viewBinding.f75698d;
            Intrinsics.g(tvTitleTrending, "tvTitleTrending");
            tvTitleTrending.setVisibility(8);
            this.viewBinding.f75697c.setText(getContext().getString(R$string.short_tv_history_title));
            this.viewBinding.f75697c.setTextWithString(getContext().getString(R$string.short_tv_history_title));
            getViewModel().i().j(this.fragment, new d(new Function1() { // from class: com.transsion.postdetail.shorttv.widget.j
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit f11;
                    f11 = ShortTVHistoryView.f(ShortTVHistoryView.this, (ShortTVRespData) obj);
                    return f11;
                }
            }));
        }
    ...
    private final void h(List list) {
        ...
        a.C0856a.f(lg.a.f68962a, "ShortTVHistoryView", "updateList, type:" + this.type + "，size:" + (list != null ? Integer.valueOf(list.size()) : null), false, 4, null);
        List list2 = list;
