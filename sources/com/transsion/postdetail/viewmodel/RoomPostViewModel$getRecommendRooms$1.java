...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getRecommendRooms$1", f = "RoomPostViewModel.kt", l = {627}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class RoomPostViewModel$getRecommendRooms$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getRecommendRooms$1$1", f = "RoomPostViewModel.kt", l = {618, 620, 622}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(RoomPostViewModel roomPostViewModel, double d11, double d12, Address address, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                roomRequestEntity.setGeo(new RoomGeo(d11, d12, address != null ? address.getCountryCode() : null, address != null ? address.getAdminArea() : null, address != null ? address.getLocality() : null, null, null, 96, null));
                String j11 = com.blankj.utilcode.util.o.j(roomRequestEntity);
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getRecommendRooms$1$2", f = "RoomPostViewModel.kt", l = {626}, m = "invokeSuspend")
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ RoomPostViewModel f50314a;

        a(RoomPostViewModel roomPostViewModel) {
            this.f50314a = roomPostViewModel;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomPostViewModel$getRecommendRooms$1(RoomPostViewModel roomPostViewModel, double d11, double d12, Address address, Continuation<? super RoomPostViewModel$getRecommendRooms$1> continuation) {
        super(2, continuation);
        this.this$0 = roomPostViewModel;
        this.$lat = d11;
        this.$lon = d12;
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RoomPostViewModel$getRecommendRooms$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.b f12 = kotlinx.coroutines.flow.d.f(kotlinx.coroutines.flow.d.u(kotlinx.coroutines.flow.d.s(new AnonymousClass1(this.this$0, this.$lat, this.$lon, this.$address, null)), y0.b()), new AnonymousClass2(null));
