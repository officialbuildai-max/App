...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$deletePost$1", f = "RoomPostViewModel.kt", l = {590}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class RoomPostViewModel$deletePost$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$deletePost$1$1", f = "RoomPostViewModel.kt", l = {584, 586}, m = "invokeSuspend")
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$deletePost$1$2", f = "RoomPostViewModel.kt", l = {589}, m = "invokeSuspend")
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ RoomPostViewModel f50298a;

        a(RoomPostViewModel roomPostViewModel) {
            this.f50298a = roomPostViewModel;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomPostViewModel$deletePost$1(String str, RoomPostViewModel roomPostViewModel, Continuation<? super RoomPostViewModel$deletePost$1> continuation) {
        super(2, continuation);
        this.$postId = str;
        this.this$0 = roomPostViewModel;
    }
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RoomPostViewModel$deletePost$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.b f12 = kotlinx.coroutines.flow.d.f(kotlinx.coroutines.flow.d.u(kotlinx.coroutines.flow.d.s(new AnonymousClass1(this.$postId, this.this$0, null)), y0.b()), new AnonymousClass2(null));
