...
public final class RoomPostViewModel$loadStaggeredPostPageCache$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public RoomPostViewModel$loadStaggeredPostPageCache$1(String str, RoomPostViewModel roomPostViewModel, Continuation<? super RoomPostViewModel$loadStaggeredPostPageCache$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RoomPostViewModel$loadStaggeredPostPageCache$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            str = null;
            string = com.transsion.baselib.report.launch.b.f43424a.b().getString("post_staggered_page_cache_" + str2, null);
        } catch (Throwable th2) {
        ...
        if (string != null && string.length() != 0) {
            ...
            b0Var2 = roomPostViewModel.f50296n;
            b0Var2.n(postSubjectBean);
            Result.m1185constructorimpl(Unit.f67184a);
            return Unit.f67184a;
        }
        if (!nh.m.f70597a.e()) {
            b0Var = roomPostViewModel.f50296n;
            b0Var.n(null);
        }
        Result.m1185constructorimpl(Unit.f67184a);
        return Unit.f67184a;
