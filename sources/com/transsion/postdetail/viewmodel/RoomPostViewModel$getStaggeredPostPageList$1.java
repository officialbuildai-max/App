...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getStaggeredPostPageList$1", f = "RoomPostViewModel.kt", l = {725}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class RoomPostViewModel$getStaggeredPostPageList$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getStaggeredPostPageList$1$1", f = "RoomPostViewModel.kt", l = {716, 718, 720}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.L$0 = cVar;
                this.label = 1;
                obj = c.a.b(S, str, str2, i12, str3, null, this, 16, null);
                if (obj == f11) {
                    return f11;
                }
            } else {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getStaggeredPostPageList$1$2", f = "RoomPostViewModel.kt", l = {724}, m = "invokeSuspend")
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ boolean f50315a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ RoomPostViewModel f50316b;

        a(boolean z10, RoomPostViewModel roomPostViewModel) {
            this.f50315a = z10;
            this.f50316b = roomPostViewModel;
        }
        ...
        public final Object emit(PostSubjectBean postSubjectBean, Continuation continuation) {
            ...
            if (postSubjectBean != null) {
                postSubjectBean.setRefresh(this.f50315a);
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomPostViewModel$getStaggeredPostPageList$1(boolean z10, String str, boolean z11, RoomPostViewModel roomPostViewModel, String str2, int i11, String str3, Continuation<? super RoomPostViewModel$getStaggeredPostPageList$1> continuation) {
        super(2, continuation);
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((RoomPostViewModel$getStaggeredPostPageList$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            if (this.$isFirstLoad) {
                String string = com.transsion.baselib.report.launch.b.f43424a.b().getString("post_staggered_page_cache_" + this.$tabId, null);
