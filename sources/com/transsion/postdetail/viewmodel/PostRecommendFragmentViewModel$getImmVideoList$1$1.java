...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.PostRecommendFragmentViewModel$getImmVideoList$1$1", f = "PostRecommendFragmentViewModel.kt", l = {TsExtractor.TS_STREAM_TYPE_DVBSUBS}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class PostRecommendFragmentViewModel$getImmVideoList$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.PostRecommendFragmentViewModel$getImmVideoList$1$1$1", f = "PostRecommendFragmentViewModel.kt", l = {80, TmcConstants.NOTIFY_ADDHOME_GUIDE_BOTTOM_SHOW, 84}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.c, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i12 == 0) {
                ...
                this.L$0 = cVar;
                this.label = 1;
                obj = i11.h(a11, requestBody, this);
                if (obj == f11) {
                    return f11;
                }
            } else {
    ...
    public static final class a implements kotlinx.coroutines.flow.c {
        ...
        final /* synthetic */ PostRecommendFragmentViewModel f50281a;

        a(PostRecommendFragmentViewModel postRecommendFragmentViewModel) {
            this.f50281a = postRecommendFragmentViewModel;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PostRecommendFragmentViewModel$getImmVideoList$1$1(PostRecommendFragmentViewModel postRecommendFragmentViewModel, RequestBody requestBody, Continuation<? super PostRecommendFragmentViewModel$getImmVideoList$1$1> continuation) {
        super(2, continuation);
        this.this$0 = postRecommendFragmentViewModel;
        this.$it = requestBody;
    }
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((PostRecommendFragmentViewModel$getImmVideoList$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.b f12 = kotlinx.coroutines.flow.d.f(kotlinx.coroutines.flow.d.u(kotlinx.coroutines.flow.d.s(new AnonymousClass1(this.this$0, this.$it, null)), y0.b()), new AnonymousClass2(null));
