...
final class BaseVideoAdHelper$wrapperAdListener$1$onBiddingLoad$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public BaseVideoAdHelper$wrapperAdListener$1$onBiddingLoad$1(Function0<Unit> function0, BaseVideoAdHelper baseVideoAdHelper, String str, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean, Continuation<? super BaseVideoAdHelper$wrapperAdListener$1$onBiddingLoad$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((BaseVideoAdHelper$wrapperAdListener$1$onBiddingLoad$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.this$0.Z0(this.$sceneId, this.$maxEcpmObject);
        return Unit.f67184a;
    }
}
