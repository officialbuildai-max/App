...
public final class BaseVideoAdHelper$onAdLoad$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public BaseVideoAdHelper$onAdLoad$1(String str, BaseVideoAdHelper baseVideoAdHelper, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean, Continuation<? super BaseVideoAdHelper$onAdLoad$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((BaseVideoAdHelper$onAdLoad$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
        ...
        switch (str.hashCode()) {
            case -1994104145:
                if (str.equals("LandscapePauseSceneNew")) {
                    this.this$0.L1(this.$maxEcpmObject);
                    break;
                }
                break;
            case -73588874:
                if (str.equals("VideoStartBidScene")) {
                    this.this$0.M1(this.$sceneId, this.$maxEcpmObject);
                    this.this$0.F1("VideoStartBidScene");
                    break;
                }
                break;
            case 354873452:
                if (str.equals("VerticalPauseScene")) {
                    this.this$0.V1(this.$maxEcpmObject);
                    break;
                }
                break;
            case 2049503279:
