...
public final class VideoFloatingView$addToParent$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    final /* synthetic */ VideoFloatingView $this_runCatching;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoFloatingView$addToParent$1$1(VideoFloatingView videoFloatingView, Continuation<? super VideoFloatingView$addToParent$1$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((VideoFloatingView$addToParent$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            if (u0.a(displayDuration, this) == f11) {
                return f11;
            }
        } else {
            if (i11 != 1) {
