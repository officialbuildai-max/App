...
public final /* data */ class CommentListBean implements Serializable {
    ...
    public static /* synthetic */ CommentListBean copy$default(CommentListBean commentListBean, List list, Pager pager, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public final CommentListBean copy(List<CommentBean> commentList, Pager pager) {
        return new CommentListBean(commentList, pager);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.c(this.commentList, commentListBean.commentList) && Intrinsics.c(this.pager, commentListBean.pager);
    }
