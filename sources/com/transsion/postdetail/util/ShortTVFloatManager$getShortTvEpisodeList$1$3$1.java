...
final class ShortTVFloatManager$getShortTvEpisodeList$1$3$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public ShortTVFloatManager$getShortTvEpisodeList$1$3$1(Function1<? super ShortTvInfoEpisodeList, Unit> function1, Continuation<? super ShortTVFloatManager$getShortTvEpisodeList$1$3$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ShortTVFloatManager$getShortTvEpisodeList$1$3$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
