...
public class OSSUtils {
    ...
    public static String buildBaseLogInfo(Context context) {
        ...
        sb2.append("[INFO]: android_version：" + Build.VERSION.RELEASE + NEW_LINE);
        sb2.append("[INFO]: mobile_model：" + Build.MODEL + NEW_LINE);
        return sb2.toString();
    }

    public static String buildCanonicalString(RequestMessage requestMessage) {
        StringBuilder sb2 = new StringBuilder();
        sb2.append(requestMessage.getMethod().toString() + NEW_LINE);
    ...
    public static String buildImagePersistentBody(String str, String str2, String str3) {
        ...
        OSSLog.logDebug("ImagePersistent body : " + sb3);
        return sb3;
    }
    ...
    public static void checkChecksum(Long l11, Long l12, String str) throws InconsistentException {
        if (l11 != null && l12 != null && !l11.equals(l12)) {
            throw new InconsistentException(l11, l12, str);
        }
    }

    public static boolean checkParamRange(long j11, long j12, boolean z10, long j13, boolean z11) {
        return (z10 && z11) ? j12 <= j11 && j11 <= j13 : (!z10 || z11) ? (z10 || z11) ? j12 < j11 && j11 <= j13 : j12 < j11 && j11 < j13 : j12 <= j11 && j11 < j13;
    }
