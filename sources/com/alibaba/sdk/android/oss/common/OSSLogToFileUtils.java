...
public class OSSLogToFileUtils {
    ...
    private long readSDCardSpace() {
        ...
        OSSLog.logDebug("sd卡存储空间:" + String.valueOf(j11) + "kb", false);
        return j11;
    }
    ...
    private long readSystemSpace() {
        ...
        OSSLog.logDebug("内部存储空间:" + String.valueOf(j11) + "kb", false);
        return j11;
    }
    ...
    public void createNewFile(File file) {
        try {
            ...
            OSSLog.logError("Create log file failure !!! " + e11.toString(), false);
        }
    }
    ...
    public void setUseSdCard(boolean z10) {
        this.useSdCard = z10;
    }
