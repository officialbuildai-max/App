...
public final class FlowEventBus extends t0 {
    ...
    public static final class a implements c {
        ...
        final /* synthetic */ Function1 f41596b;

        a(Function1 function1) {
            this.f41596b = function1;
        }

        @Override // kotlinx.coroutines.flow.c
        public final Object emit(Object obj, Continuation continuation) {
            FlowEventBus.this.invokeReceived(obj, this.f41596b);
            return Unit.f67184a;
        }
    }
    ...
    public final <T> void invokeReceived(Object value, Function1<? super T, Unit> onReceived) {
        try {
            ...
            if (message != null) {
                ai.a.c(ai.a.f694a, "class cast error on message received: " + message, null, 2, null);
            }
        } catch (Exception e12) {
            String message2 = e12.getMessage();
            if (message2 != null) {
                ai.a.c(ai.a.f694a, "error on message received: " + message2, null, 2, null);
            }
        }
    }
    ...
    */
    public final <T> java.lang.Object observeWithoutLifecycle(java.lang.String r5, boolean r6, kotlin.jvm.functions.Function1<? super T, kotlin.Unit> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r4 = this;
            boolean r0 = r8 instanceof com.tn.tranpay.event.FlowEventBus$observeWithoutLifecycle$1
            if (r0 == 0) goto L13
            r0 = r8
            com.tn.tranpay.event.FlowEventBus$observeWithoutLifecycle$1 r0 = (com.tn.tranpay.event.FlowEventBus$observeWithoutLifecycle$1) r0
            int r1 = r0.label
            ...
            goto L18
        L13:
            com.tn.tranpay.event.FlowEventBus$observeWithoutLifecycle$1 r0 = new com.tn.tranpay.event.FlowEventBus$observeWithoutLifecycle$1
            r0.<init>(r4, r8)
        L18:
        ...
        L31:
            ...
            com.tn.tranpay.event.FlowEventBus$a r6 = new com.tn.tranpay.event.FlowEventBus$a
            r6.<init>(r7)
            r0.label = r3
        ...
        L46:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tn.tranpay.event.FlowEventBus.observeWithoutLifecycle(java.lang.String, boolean, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public final void postEvent(String eventName, Object value, long timeMillis) {
        Intrinsics.h(eventName, "eventName");
        Intrinsics.h(value, "value");
        ai.a.c(ai.a.f694a, "post Event:" + eventName, null, 2, null);
