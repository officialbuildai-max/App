...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f40876a = new SparseIntArray(0);

    /* loaded from: classes3.dex */
    private static class a {

        /* renamed from: a, reason: collision with root package name */
        static final HashMap f40877a = new HashMap(0);
    }
    ...
    public ViewDataBinding b(f fVar, View view, int i11) {
        if (f40876a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int c(String str) {
        Integer num;
        if (str == null || (num = (Integer) a.f40877a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
