...
public class DrawableFactory {
    ...
    public static GradientDrawable getDrawable(TypedArray typedArray, int i11) throws XmlPullParserException {
        return new GradientDrawableCreator(typedArray, i11).create();
    }
