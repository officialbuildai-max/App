...
public class GradientStateDrawableCreator implements ICreateDrawable {
    ...
    private void setSelectorDrawable(StateListDrawable stateListDrawable, int i11) throws Exception {
        stateListDrawable.addState(new int[]{i11}, DrawableFactory.getDrawable(this.typedArray, i11));
    }
