...
@DebugMetadata(c = "com.transsnet.flow.event.FlowEventBus$observeEvent$1", f = "FlowEventBus.kt", l = {Sdk$SDKMetric.SDKMetricType.AD_REWARD_USER_VALUE}, m = "invokeSuspend")
...
public final class FlowEventBus$observeEvent$1 extends SuspendLambda implements Function2<n0, Continuation<?>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            kotlinx.coroutines.flow.c cVar = new kotlinx.coroutines.flow.c() { // from class: com.transsnet.flow.event.FlowEventBus$observeEvent$1.1

                @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lkotlinx/coroutines/n0;", "", "<anonymous>", "(Lkotlinx/coroutines/n0;)V"}, k = 3, mv = {2, 1, 0})
                @DebugMetadata(c = "com.transsnet.flow.event.FlowEventBus$observeEvent$1$1$1", f = "FlowEventBus.kt", l = {}, m = "invokeSuspend")
                ...
                static final class C07181 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C07181(FlowEventBus flowEventBus, Object obj, Function1<Object, Unit> function1, Continuation<? super C07181> continuation) {
                        super(2, continuation);
                        this.this$0 = flowEventBus;
                        this.$value = obj;
                        this.$onReceived = function1;
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C07181(this.this$0, this.$value, this.$onReceived, continuation);
                    }

                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
                        return ((C07181) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
                    }
                ...
                public final Object emit(Object obj2, Continuation continuation) {
                    k.d(n0.this, i0Var, null, new C07181(flowEventBus, obj2, function1, null), 2, null);
                    return Unit.f67184a;
                }
            };
            this.label = 1;
