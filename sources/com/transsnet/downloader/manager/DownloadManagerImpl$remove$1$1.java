...
public final class DownloadManagerImpl$remove$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public DownloadManagerImpl$remove$1$1(String str, DownloadBean downloadBean, Continuation<? super DownloadManagerImpl$remove$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DownloadManagerImpl$remove$1$1(this.$path, this.$downloadInfo, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((DownloadManagerImpl$remove$1$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
