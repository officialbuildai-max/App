...
public final class DownloadEsHelper$deleteItem$1 extends ContinuationImpl {
    Object L$0;
    int label;
    ...
    public DownloadEsHelper$deleteItem$1(DownloadEsHelper downloadEsHelper, Continuation<? super DownloadEsHelper$deleteItem$1> continuation) {
        super(continuation);
