...
@DebugMetadata(c = "com.transsnet.downloader.fragment.LocalFileFragment$initViewModel$1", f = "LocalFileFragment.kt", l = {Sdk$SDKMetric.SDKMetricType.AD_OPTIONAL_DOWNLOAD_DURATION_MS_VALUE}, m = "invokeSuspend")
/* loaded from: classes7.dex */
final class LocalFileFragment$initViewModel$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((LocalFileFragment$initViewModel$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            kotlinx.coroutines.flow.c cVar = new kotlinx.coroutines.flow.c() { // from class: com.transsnet.downloader.fragment.LocalFileFragment$initViewModel$1.1
                ...
                /* loaded from: classes7.dex */
                public static final class C07141 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
                    final /* synthetic */ int $it;
                    int label;
                    final /* synthetic */ LocalFileFragment this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C07141(int i11, LocalFileFragment localFileFragment, Continuation<? super C07141> continuation) {
                        super(2, continuation);
                        this.$it = i11;
                        this.this$0 = localFileFragment;
                    }
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C07141(this.$it, this.this$0, continuation);
                    }

                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
                        return ((C07141) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
                    }
                ...
                public final Object a(int i12, Continuation continuation) {
                    Object g11 = kotlinx.coroutines.i.g(kotlinx.coroutines.y0.c(), new C07141(i12, LocalFileFragment.this, null), continuation);
