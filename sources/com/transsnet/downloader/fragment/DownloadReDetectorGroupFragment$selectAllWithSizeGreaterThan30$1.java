...
public final class DownloadReDetectorGroupFragment$selectAllWithSizeGreaterThan30$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass2(DownloadReDetectorGroupFragment downloadReDetectorGroupFragment, boolean z10, Ref.LongRef longRef, Continuation<? super AnonymousClass2> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            Integer num = null;
            if (this.$isSelected) {
                this.this$0.formatSize = oh.b.a(this.$totalSize.element, 1);
                function13 = this.this$0.formatSizeListener;
                if (function13 != null) {
                    str = this.this$0.formatSize;
                    function13.invoke(str);
                }
            } else {
                function1 = this.this$0.formatSizeListener;
                if (function1 != null) {
                    function1.invoke(null);
                }
            }
            function12 = this.this$0.selessctAllLoadinVisibilityListener;
            if (function12 != null) {
            ...
            if (gVar != null && (F1 = gVar.F1()) != null) {
                ...
                gVar2 = downloadReDetectorGroupFragment.mAdapter;
                Integer d11 = (gVar2 == null || (F12 = gVar2.F1()) == null) ? null : Boxing.d(F12.size());
                i11 = downloadReDetectorGroupFragment.unableSize;
                gVar3 = downloadReDetectorGroupFragment.mAdapter;
                ...
                function2 = downloadReDetectorGroupFragment.checkListListener;
                if (function2 != null) {
                    int size = F1.size();
                    i12 = downloadReDetectorGroupFragment.unableSize;
                    int i13 = size + i12;
                    gVar4 = downloadReDetectorGroupFragment.mAdapter;
                    Intrinsics.e(gVar4);
                    function2.invoke(F1, Boxing.a(i13 == gVar4.getData().size()));
                }
            }
            return Unit.f67184a;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DownloadReDetectorGroupFragment$selectAllWithSizeGreaterThan30$1(List<DownloadBean> list, DownloadReDetectorGroupFragment downloadReDetectorGroupFragment, boolean z10, int i11, Continuation<? super DownloadReDetectorGroupFragment$selectAllWithSizeGreaterThan30$1> continuation) {
        super(2, continuation);
        this.$data = list;
        this.this$0 = downloadReDetectorGroupFragment;
        this.$isSelected = z10;
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(kotlinx.coroutines.n0 n0Var, Continuation<? super Unit> continuation) {
        return ((DownloadReDetectorGroupFragment$selectAllWithSizeGreaterThan30$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
