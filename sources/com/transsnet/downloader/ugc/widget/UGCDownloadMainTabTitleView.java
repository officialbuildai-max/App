...
public final class UGCDownloadMainTabTitleView extends AppCompatTextView implements d, a {
    ...
    public UGCDownloadMainTabTitleView(Context context) {
        super(context);
        Intrinsics.h(context, "context");
        this.mNormalColor = b.getColor(context, R$color.text_02);
        this.mSelectedColor = b.getColor(context, R$color.text_01);
        setTextSize(14.0f);
        setGravity(17);
        setPadding(dk.a.b(12), 0, dk.a.b(10), 0);
        setSingleLine();
