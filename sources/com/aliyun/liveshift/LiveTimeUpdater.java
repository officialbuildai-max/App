...
public class LiveTimeUpdater {
    ...
    static /* synthetic */ long access$508(LiveTimeUpdater liveTimeUpdater) {
        long j11 = liveTimeUpdater.playTime;
        liveTimeUpdater.playTime = 1 + j11;
        return j11;
    }

    static /* synthetic */ long access$608(LiveTimeUpdater liveTimeUpdater) {
        long j11 = liveTimeUpdater.liveTime;
        liveTimeUpdater.liveTime = 1 + j11;
        return j11;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void startUpdateLiveTimerDelay(int i11) {
        stopUpdateLiveTimer();
        this.timer.sendEmptyMessageDelayed(WHAT_UPDATE_LIVE_TIME, i11 * 1000);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void startUpdatePlayTimerDelay(int i11) {
        stopUpdatePlayTimer();
        this.timer.sendEmptyMessageDelayed(WHAT_UPDATE_PLAY_TIME, i11 * 1000);
    }
    ...
    public void updateLiveTimer() {
        GetTimeShiftRequest getTimeShiftRequest = new GetTimeShiftRequest(this.contextWeak.get(), this.mTimeShift, new BaseRequest.OnRequestListener<TimeLineContent>() { // from class: com.aliyun.liveshift.LiveTimeUpdater.2
            ...
            public void onSuccess(TimeLineContent timeLineContent, String str) {
                if (LiveTimeUpdater.this.timeShiftUpdaterListener != null) {
                    long j11 = timeLineContent.current;
                    ...
                    LiveTimeUpdater.this.liveTime = j11;
                    ...
                    LiveTimeUpdater.this.timeShiftUpdaterListener.onUpdater(j11, startTime, endTime);
                }
            }
        });
