...
public abstract class ApasaraExternalPlayer {
    ...
    public interface OnBufferPositionUpdateListener {
        void onBufferPositionUpdate(long j11);
    }

    /* loaded from: classes2.dex */
    public interface OnCaptureScreenListener {
        void onCaptureScreen(int i11, int i12, byte[] bArr);
    }
    ...
    public interface OnEventListener {
        void onEvent(int i11, String str);
    }
    ...
    public interface OnLoadStatusListener {
        ...
        void onLoadingProgress(int i11);
    ...
    public interface OnPositionUpdateListener {
        void onPositionUpdate(long j11);
    }
    ...
    public interface OnSeekStatusListener {
        void onSeekEnd(boolean z10);

        void onSeekStart(boolean z10);
    }

    /* loaded from: classes2.dex */
    public interface OnStatusChangedListener {
        void onStatusChanged(int i11, int i12);
    }
    ...
    public abstract void enterBackGround(boolean z10);
    ...
    public abstract void seekTo(long j11, boolean z10);

    public abstract int selectExtSubtitle(int i11, boolean z10);
    ...
    public abstract void setDropBufferThreshold(int i11);
    ...
    public abstract void setSpeed(float f11);

    public abstract void setSurface(Surface surface);

    public abstract void setTimeout(int i11);

    public abstract void setUserAgent(String str);

    public abstract void setVideoBackgroundColor(long j11);
    ...
    public abstract StreamType switchStream(int i11);
}
