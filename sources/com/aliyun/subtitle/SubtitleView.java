...
public class SubtitleView extends RelativeLayout {
    ...
    public static class DefaultValueBuilder {
        ...
        public DefaultValueBuilder setLocation(int i11) {
            this.mLocation = i11;
            return this;
        }

        public DefaultValueBuilder setSize(int i11) {
            this.mTextSize = i11;
            return this;
        }

        public DefaultValueBuilder setSizePercent(float f11) {
            this.mTextSizePercent = f11;
            return this;
        }
    }
    ...
    protected void onLayout(boolean z10, int i11, int i12, int i13, int i14) {
        ...
        float f11 = this.mDefaultPercent;
        if (f11 > 0.0f) {
            this.mDefaultSize = (int) (f11 * i15);
        }
        if (this.mDefaultSize <= 0) {
    ...
    public void show(Subtitle subtitle) {
        ...
        this.mSubtitleView.put(subtitle.f18350id, finalTextView);
    }
}
