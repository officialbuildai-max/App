...
public class ApsaraDownloader extends AliMediaDownloader {
    ...
    private static class InnerOnProgressListener implements AliMediaDownloader.OnProgressListener {
        ...
        public void onDownloadingProgress(int i11) {
            ApsaraDownloader apsaraDownloader = this.downloaderWk.get();
            if (apsaraDownloader != null) {
                apsaraDownloader.onDownloadingProgress(i11);
            }
        }

        @Override // com.aliyun.downloader.AliMediaDownloader.OnProgressListener
        public void onProcessingProgress(int i11) {
            ApsaraDownloader apsaraDownloader = this.downloaderWk.get();
            if (apsaraDownloader != null) {
                apsaraDownloader.onProcessingProgress(i11);
            }
        }
    }
    ...
    public void onDownloadingProgress(int i11) {
        ...
        if (onProgressListener != null) {
            onProgressListener.onDownloadingProgress(i11);
        }
    }
    ...
    public void onProcessingProgress(int i11) {
        AliMediaDownloader.OnProgressListener onProgressListener = this.mOuterOnProgressListener;
        if (onProgressListener != null) {
            onProgressListener.onProcessingProgress(i11);
        }
    }
    ...
    public void selectItem(int i11) {
        this.mCoreDownloader.selectItem(i11);
    }
