...
public class S3ErrorResponseHandler implements HttpResponseHandler<AmazonServiceException> {
    ...
    private static final Log f18743a = LogFactory.b(S3ErrorResponseHandler.class);
    ...
    private AmazonS3Exception e(String str, HttpResponse httpResponse) {
        ...
        Map c11 = httpResponse.c();
        amazonS3Exception.setRequestId((String) c11.get("x-amz-request-id"));
        amazonS3Exception.setExtendedRequestId((String) c11.get("x-amz-id-2"));
        amazonS3Exception.setCloudFrontId((String) c11.get("X-Amz-Cf-Id"));
    ...
    public AmazonServiceException a(HttpResponse httpResponse) {
        ...
        try {
            ...
            try {
                ...
                amazonS3Exception.setCloudFrontId((String) httpResponse.c().get("X-Amz-Cf-Id"));
                return amazonS3Exception;
            } catch (Exception e12) {
                Log log = f18743a;
                if (log.b()) {
            ...
            if (f18743a.b()) {
                f18743a.g("Failed in reading the error response", e13);
            }
            return e(httpResponse.f(), httpResponse);
        }
    }
