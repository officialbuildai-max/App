...
public abstract class RegionDefaults {
    public static List a() {
        ...
        b(region2, "sts", "sts.amazonaws.com", false, true);
        ...
        b(region4, "sts", "sts.amazonaws.com", false, true);
        ...
        b(region5, "sts", "sts.amazonaws.com", false, true);
        ...
        b(region6, "sts", "sts.amazonaws.com", false, true);
        ...
        b(region7, "sts", "sts.amazonaws.com", false, true);
        ...
        b(region8, "sts", "sts.amazonaws.com", false, true);
        Region region9 = new Region("eu-south-1", "amazonaws.com");
        arrayList.add(region9);
        b(region9, "autoscaling", "autoscaling.eu-south-1.amazonaws.com", false, true);
        b(region9, "dynamodb", "dynamodb.eu-south-1.amazonaws.com", false, true);
        b(region9, "ec2", "ec2.eu-south-1.amazonaws.com", false, true);
        b(region9, "elasticloadbalancing", "elasticloadbalancing.eu-south-1.amazonaws.com", false, true);
        b(region9, "lambda", "lambda.eu-south-1.amazonaws.com", false, true);
        b(region9, "logs", "logs.eu-south-1.amazonaws.com", false, true);
        b(region9, "s3", "s3.eu-south-1.amazonaws.com", false, true);
        b(region9, "sns", "sns.eu-south-1.amazonaws.com", false, true);
        b(region9, "sqs", "sqs.eu-south-1.amazonaws.com", false, true);
        Region region10 = new Region("eu-west-1", "amazonaws.com");
        arrayList.add(region10);
        b(region10, "autoscaling", "autoscaling.eu-west-1.amazonaws.com", false, true);
        ...
        b(region10, "dynamodb", "dynamodb.eu-west-1.amazonaws.com", false, true);
        b(region10, "ec2", "ec2.eu-west-1.amazonaws.com", false, true);
        b(region10, "elasticloadbalancing", "elasticloadbalancing.eu-west-1.amazonaws.com", false, true);
        ...
        b(region10, "s3", "s3.eu-west-1.amazonaws.com", false, true);
        b(region10, "sdb", "sdb.eu-west-1.amazonaws.com", false, true);
        b(region10, "sns", "sns.eu-west-1.amazonaws.com", false, true);
        b(region10, "sqs", "sqs.eu-west-1.amazonaws.com", false, true);
        b(region10, "sts", "sts.amazonaws.com", false, true);
        Region region11 = new Region("eu-west-2", "amazonaws.com");
        arrayList.add(region11);
        b(region11, "autoscaling", "autoscaling.eu-west-2.amazonaws.com", false, true);
        ...
        b(region11, "dynamodb", "dynamodb.eu-west-2.amazonaws.com", false, true);
        b(region11, "ec2", "ec2.eu-west-2.amazonaws.com", false, true);
        b(region11, "elasticloadbalancing", "elasticloadbalancing.eu-west-2.amazonaws.com", false, true);
        ...
        b(region11, "s3", "s3.eu-west-2.amazonaws.com", false, true);
        b(region11, "sns", "sns.eu-west-2.amazonaws.com", false, true);
        b(region11, "sqs", "sqs.eu-west-2.amazonaws.com", false, true);
        b(region11, "sts", "sts.amazonaws.com", false, true);
        Region region12 = new Region("eu-west-3", "amazonaws.com");
        arrayList.add(region12);
        b(region12, "autoscaling", "autoscaling.eu-west-3.amazonaws.com", false, true);
        b(region12, "dynamodb", "dynamodb.eu-west-3.amazonaws.com", false, true);
        b(region12, "ec2", "ec2.eu-west-3.amazonaws.com", false, true);
        b(region12, "elasticloadbalancing", "elasticloadbalancing.eu-west-3.amazonaws.com", false, true);
        ...
        b(region12, "s3", "s3.eu-west-3.amazonaws.com", false, true);
        b(region12, "sns", "sns.eu-west-3.amazonaws.com", false, true);
        b(region12, "sqs", "sqs.eu-west-3.amazonaws.com", false, true);
        b(region12, "sts", "sts.amazonaws.com", false, true);
        Region region13 = new Region("sa-east-1", "amazonaws.com");
        arrayList.add(region13);
        b(region13, "autoscaling", "autoscaling.sa-east-1.amazonaws.com", false, true);
        b(region13, "dynamodb", "dynamodb.sa-east-1.amazonaws.com", false, true);
        b(region13, "ec2", "ec2.sa-east-1.amazonaws.com", false, true);
        b(region13, "elasticloadbalancing", "elasticloadbalancing.sa-east-1.amazonaws.com", false, true);
        ...
        b(region13, "s3", "s3.sa-east-1.amazonaws.com", false, true);
        b(region13, "sdb", "sdb.sa-east-1.amazonaws.com", false, true);
        b(region13, "sns", "sns.sa-east-1.amazonaws.com", false, true);
        b(region13, "sqs", "sqs.sa-east-1.amazonaws.com", false, true);
        b(region13, "sts", "sts.amazonaws.com", false, true);
        Region region14 = new Region("us-east-1", "amazonaws.com");
        arrayList.add(region14);
        b(region14, "autoscaling", "autoscaling.us-east-1.amazonaws.com", false, true);
        ...
        b(region14, "dynamodb", "dynamodb.us-east-1.amazonaws.com", false, true);
        b(region14, "ec2", "ec2.us-east-1.amazonaws.com", false, true);
        b(region14, "elasticloadbalancing", "elasticloadbalancing.us-east-1.amazonaws.com", false, true);
        ...
        b(region14, "s3", "s3.amazonaws.com", false, true);
        b(region14, "sdb", "sdb.amazonaws.com", false, true);
        b(region14, "sns", "sns.us-east-1.amazonaws.com", false, true);
        b(region14, "sqs", "sqs.us-east-1.amazonaws.com", false, true);
        b(region14, "sts", "sts.amazonaws.com", false, true);
        Region region15 = new Region("us-east-2", "amazonaws.com");
        arrayList.add(region15);
        b(region15, "autoscaling", "autoscaling.us-east-2.amazonaws.com", false, true);
        ...
        b(region15, "dynamodb", "dynamodb.us-east-2.amazonaws.com", false, true);
        b(region15, "ec2", "ec2.us-east-2.amazonaws.com", false, true);
        b(region15, "elasticloadbalancing", "elasticloadbalancing.us-east-2.amazonaws.com", false, true);
        ...
        b(region15, "s3", "s3.us-east-2.amazonaws.com", false, true);
        b(region15, "sns", "sns.us-east-2.amazonaws.com", false, true);
        b(region15, "sqs", "sqs.us-east-2.amazonaws.com", false, true);
        b(region15, "sts", "sts.amazonaws.com", false, true);
        Region region16 = new Region("us-west-1", "amazonaws.com");
        arrayList.add(region16);
        b(region16, "autoscaling", "autoscaling.us-west-1.amazonaws.com", false, true);
        b(region16, "dynamodb", "dynamodb.us-west-1.amazonaws.com", false, true);
        b(region16, "ec2", "ec2.us-west-1.amazonaws.com", false, true);
        b(region16, "elasticloadbalancing", "elasticloadbalancing.us-west-1.amazonaws.com", false, true);
        ...
        b(region16, "s3", "s3.us-west-1.amazonaws.com", false, true);
        b(region16, "sdb", "sdb.us-west-1.amazonaws.com", false, true);
        b(region16, "sns", "sns.us-west-1.amazonaws.com", false, true);
        b(region16, "sqs", "sqs.us-west-1.amazonaws.com", false, true);
        b(region16, "sts", "sts.amazonaws.com", false, true);
        Region region17 = new Region("us-west-2", "amazonaws.com");
        arrayList.add(region17);
        b(region17, "autoscaling", "autoscaling.us-west-2.amazonaws.com", false, true);
        ...
        b(region17, "dynamodb", "dynamodb.us-west-2.amazonaws.com", false, true);
        b(region17, "ec2", "ec2.us-west-2.amazonaws.com", false, true);
        b(region17, "elasticloadbalancing", "elasticloadbalancing.us-west-2.amazonaws.com", false, true);
        ...
        b(region17, "s3", "s3.us-west-2.amazonaws.com", false, true);
        b(region17, "sdb", "sdb.us-west-2.amazonaws.com", false, true);
        b(region17, "sns", "sns.us-west-2.amazonaws.com", false, true);
        b(region17, "sqs", "sqs.us-west-2.amazonaws.com", false, true);
        b(region17, "sts", "sts.amazonaws.com", false, true);
        Region region18 = new Region("cn-north-1", "amazonaws.com.cn");
        arrayList.add(region18);
        b(region18, "autoscaling", "autoscaling.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "cognito-identity", "cognito-identity.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "dynamodb", "dynamodb.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "ec2", "ec2.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "elasticloadbalancing", "elasticloadbalancing.cn-north-1.amazonaws.com.cn", false, true);
        ...
        b(region18, "s3", "s3.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "sns", "sns.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "sqs", "sqs.cn-north-1.amazonaws.com.cn", false, true);
        b(region18, "sts", "sts.cn-north-1.amazonaws.com.cn", false, true);
        Region region19 = new Region("cn-northwest-1", "amazonaws.com.cn");
        arrayList.add(region19);
        b(region19, "autoscaling", "autoscaling.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "dynamodb", "dynamodb.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "ec2", "ec2.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "elasticloadbalancing", "elasticloadbalancing.cn-northwest-1.amazonaws.com.cn", false, true);
        ...
        b(region19, "s3", "s3.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "sns", "sns.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "sqs", "sqs.cn-northwest-1.amazonaws.com.cn", false, true);
        b(region19, "sts", "sts.amazonaws.com.cn", false, true);
        Region region20 = new Region("us-gov-west-1", "amazonaws.com");
        arrayList.add(region20);
        b(region20, "autoscaling", "autoscaling.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "dynamodb", "dynamodb.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "ec2", "ec2.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "elasticloadbalancing", "elasticloadbalancing.us-gov-west-1.amazonaws.com", false, true);
        ...
        b(region20, "s3", "s3.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "sns", "sns.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "sqs", "sqs.us-gov-west-1.amazonaws.com", false, true);
        b(region20, "sts", "sts.amazonaws.com", false, true);
        Region region21 = new Region("eu-north-1", "amazonaws.com");
        arrayList.add(region21);
        b(region21, "autoscaling", "autoscaling.eu-north-1.amazonaws.com", false, true);
        b(region21, "dynamodb", "dynamodb.eu-north-1.amazonaws.com", false, true);
        b(region21, "ec2", "ec2.eu-north-1.amazonaws.com", false, true);
        b(region21, "elasticloadbalancing", "elasticloadbalancing.eu-north-1.amazonaws.com", false, true);
        ...
        b(region21, "s3", "s3.eu-north-1.amazonaws.com", false, true);
        b(region21, "sns", "sns.eu-north-1.amazonaws.com", false, true);
        b(region21, "sqs", "sqs.eu-north-1.amazonaws.com", false, true);
        b(region21, "sts", "sts.amazonaws.com", false, true);
        Region region22 = new Region("ap-east-1", "amazonaws.com");
        arrayList.add(region22);
        b(region22, "autoscaling", "autoscaling.ap-east-1.amazonaws.com", false, true);
        b(region22, "dynamodb", "dynamodb.ap-east-1.amazonaws.com", false, true);
        b(region22, "ec2", "ec2.ap-east-1.amazonaws.com", false, true);
        b(region22, "elasticloadbalancing", "elasticloadbalancing.ap-east-1.amazonaws.com", false, true);
        ...
        b(region22, "s3", "s3.ap-east-1.amazonaws.com", false, true);
        b(region22, "sns", "sns.ap-east-1.amazonaws.com", false, true);
        b(region22, "sqs", "sqs.ap-east-1.amazonaws.com", false, true);
        b(region22, "sts", "sts.amazonaws.com", false, true);
        Region region23 = new Region("me-south-1", "amazonaws.com");
        arrayList.add(region23);
        b(region23, "autoscaling", "autoscaling.me-south-1.amazonaws.com", false, true);
        ...
        b(region23, "dynamodb", "dynamodb.me-south-1.amazonaws.com", false, true);
        b(region23, "ec2", "ec2.me-south-1.amazonaws.com", false, true);
        b(region23, "elasticloadbalancing", "elasticloadbalancing.me-south-1.amazonaws.com", false, true);
        ...
        b(region23, "s3", "s3.me-south-1.amazonaws.com", false, true);
        b(region23, "sdb", "sdb.me-south-1.amazonaws.com", false, true);
        b(region23, "sns", "sns.me-south-1.amazonaws.com", false, true);
        b(region23, "sqs", "sqs.me-south-1.amazonaws.com", false, true);
        b(region23, "sts", "sts.amazonaws.com", false, true);
        return arrayList;
    }
    ...
    private static void b(Region region, String str, String str2, boolean z10, boolean z11) {
        ...
        Map c11 = region.c();
        h11.put(str, str2);
        b11.put(str, Boolean.valueOf(z10));
        c11.put(str, Boolean.valueOf(z11));
    }
}
