...
public final class Address {
    ...
    public Address(String str, int i11, Dns dns, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, CertificatePinner certificatePinner, Authenticator authenticator, Proxy proxy, List<Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector) {
        this.url = new HttpUrl.Builder().scheme(sSLSocketFactory != null ? "https" : "http").host(str).port(i11).build();
        if (dns == null) {
        ...
        this.protocols = g.j(list);
        if (list2 == null) {
            throw new IllegalArgumentException("connectionSpecs == null");
        }
        this.connectionSpecs = g.j(list2);
    ...
    public boolean equals(Object obj) {
        ...
        return this.url.equals(address.url) && this.dns.equals(address.dns) && this.authenticator.equals(address.authenticator) && this.protocols.equals(address.protocols) && this.connectionSpecs.equals(address.connectionSpecs) && this.proxySelector.equals(address.proxySelector) && g.h(this.proxy, address.proxy) && g.h(this.sslSocketFactory, address.sslSocketFactory) && g.h(this.hostnameVerifier, address.hostnameVerifier) && g.h(this.certificatePinner, address.certificatePinner);
    }
