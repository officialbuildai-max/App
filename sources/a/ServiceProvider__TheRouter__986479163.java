...
import com.transsnet.downloader.provider.IDownloadProvider;
import uo.c;

@Keep
/* loaded from: classes.dex */
public class ServiceProvider__TheRouter__986479163 implements b {
    ...
    public <T> T interception(Class<T> cls, Object... objArr) {
        if (IDownloadProvider.class.equals(cls) && objArr.length == 0) {
            return (T) zo.b.a();
        }
        if (IPostDetailApi.class.equals(cls) && objArr.length == 0) {
            return (T) c.a();
        }
        return null;
    }
