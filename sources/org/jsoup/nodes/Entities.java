...
public abstract class Entities {
    ...
    private static final char[] f71868a = {',', ';'};

    /* renamed from: b, reason: collision with root package name */
    private static final HashMap f71869b = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    private static final Document.OutputSettings f71870c = new Document.OutputSettings();
    ...
    public enum EscapeMode {
        ...
        String nameForCodepoint(int i11) {
    ...
    public static /* synthetic */ class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f71871a;
        ...
        static {
            ...
            try {
                f71871a[CoreCharset.utf.ordinal()] = 2;
    ...
    private static boolean c(CoreCharset coreCharset, char c11, CharsetEncoder charsetEncoder) {
        int i11 = a.f71871a[coreCharset.ordinal()];
        if (i11 == 1) {
            return c11 < 128;
        }
        if (i11 != 2) {
    ...
    public static int d(String str, int[] iArr) {
        String str2 = (String) f71869b.get(str);
        if (str2 != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void e(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z10, boolean z11, boolean z12) {
        EscapeMode g11 = outputSettings.g();
        CharsetEncoder f11 = outputSettings.f();
        CoreCharset coreCharset = outputSettings.f71854d;
        ...
        while (i11 < length) {
            ...
            if (z11) {
                if (org.jsoup.helper.c.h(codePointAt)) {
                    if ((!z12 || z13) && !z14) {
                        appendable.append(' ');
                        z14 = true;
                    }
            ...
            if (codePointAt < 65536) {
                ...
                if (c11 != '\"') {
                    ...
                    } else if (!z10 || g11 == EscapeMode.xhtml) {
                        appendable.append("&lt;");
                    } else {
                        appendable.append(c11);
                    }
    ...
    public static void h(EscapeMode escapeMode, String str, int i11) {
        ...
        while (!aVar.r()) {
            String k11 = aVar.k('=');
            aVar.a();
            int parseInt = Integer.parseInt(aVar.m(f71868a), 36);
            char q11 = aVar.q();
            aVar.a();
            if (q11 == ',') {
            ...
            aVar.a();
            escapeMode.nameKeys[i13] = k11;
            escapeMode.codeVals[i13] = parseInt;
            escapeMode.codeKeys[parseInt2] = parseInt;
            escapeMode.nameVals[parseInt2] = k11;
            if (i12 != -1) {
                f71869b.put(k11, new String(new int[]{parseInt, i12}, 0, 2));
            }
            i13++;
        }
        org.jsoup.helper.d.e(i13 == i11, "Unexpected count of entities loaded");
    }
}
