...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
    ...
    public void addExtraField(ZipExtraField zipExtraField) {
        ...
        for (int i11 = 0; !z10 && i11 < size; i11++) {
            if (((ZipExtraField) this.extraFields.elementAt(i11)).getHeaderId().equals(headerId)) {
                this.extraFields.setElementAt(zipExtraField, i11);
                z10 = true;
            }
        }
        if (!z10) {
    ...
    public void removeExtraField(ZipShort zipShort) {
        ...
        boolean z10 = false;
        for (int i11 = 0; !z10 && i11 < size; i11++) {
            if (((ZipExtraField) this.extraFields.elementAt(i11)).getHeaderId().equals(zipShort)) {
                this.extraFields.removeElementAt(i11);
                z10 = true;
            }
        }
        if (!z10) {
    ...
    public void setComprSize(long j11) {
        setCompressedSize(j11);
    }
