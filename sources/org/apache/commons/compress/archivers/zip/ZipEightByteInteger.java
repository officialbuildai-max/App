...
public final class ZipEightByteInteger implements Serializable {
    ...
    public static BigInteger getValue(byte[] bArr, int i11) {
        int i12 = i11 + 7;
        BigInteger valueOf = BigInteger.valueOf(((bArr[i12] << 56) & BYTE_7_MASK) + ((bArr[i11 + 6] << 48) & BYTE_6_MASK) + ((bArr[i11 + 5] << 40) & BYTE_5_MASK) + ((bArr[i11 + 4] << 32) & BYTE_4_MASK) + ((bArr[i11 + 3] << 24) & BYTE_3_MASK) + ((bArr[i11 + 2] << 16) & 16711680) + ((bArr[i11 + 1] << 8) & 65280) + (bArr[i11] & 255));
        return (bArr[i12] & LEFTMOST_BIT) == -128 ? valueOf.setBit(LEFTMOST_BIT_SHIFT) : valueOf;
    }
