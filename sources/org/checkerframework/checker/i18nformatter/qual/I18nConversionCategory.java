...
public enum I18nConversionCategory {
    UNUSED(null, null),
    GENERAL(null, null),
    DATE(new Class[]{Date.class, Number.class}, new String[]{"date", EventConstants.KEY_TIME}),
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner a11 = b.a(", ", " conversion category (one of: ", ")");
            for (Class<?> cls : this.types) {
                a11.add(cls.getCanonicalName());
            }
            sb2.append(a11);
        }
        return sb2.toString();
