...
public final class TakeWhileSequence$iterator$1<T> implements Iterator<T>, KMappedMarker {
    ...
    private final void a() {
        ...
        if (this.iterator.hasNext()) {
            ...
            function1 = this.f67583d.predicate;
