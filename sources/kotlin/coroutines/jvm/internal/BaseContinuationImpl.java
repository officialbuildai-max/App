...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public abstract /* synthetic */ CoroutineContext getF67302a();
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                result = Result.m1185constructorimpl(ResultKt.a(th2));
            }
            if (invokeSuspend == IntrinsicsKt.f()) {
                return;
            }
            result = Result.m1185constructorimpl(invokeSuspend);
