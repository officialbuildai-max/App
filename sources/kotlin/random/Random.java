...
public abstract class Random {
    ...
    public static final class Companion extends Random implements Serializable {
        ...
        @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\bÂ\u0002\u0018\u00002\u00060\u0001j\u0002`\u0002B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\b\u0010\u0007\u001a\u00020\bH\u0002R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lkotlin/random/Random$Default$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "<init>", "()V", "serialVersionUID", "", "readResolve", "", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = Sdk$SDKMetric.SDKMetricType.AD_SHOW_TO_VALIDATION_DURATION_MS_VALUE)
    ...
    public byte[] nextBytes(byte[] array, int fromIndex, int toIndex) {
        ...
        for (int i14 = 0; i14 < i13; i14++) {
            array[fromIndex + i14] = (byte) (nextBits >>> (i14 * 8));
        }
        return array;
    }

    public double nextDouble() {
        return PlatformRandomKt.a(nextBits(26), nextBits(27));
    }
    ...
    public double nextDouble(double from, double until) {
        ...
        double d11 = until - from;
        if (!Double.isInfinite(d11) || Math.abs(from) > Double.MAX_VALUE || Math.abs(until) > Double.MAX_VALUE) {
            nextDouble = from + (nextDouble() * d11);
        } else {
            double d12 = 2;
            double nextDouble2 = nextDouble() * ((until / d12) - (from / d12));
    ...
    public long nextLong(long from, long until) {
        ...
        if (j13 > 0) {
            if (((-j13) & j13) == j13) {
                ...
                int i12 = (int) (j13 >>> 32);
                if (i11 != 0) {
                    nextInt = nextBits(RandomKt.e(i11));
                } else {
                    if (i12 != 1) {
                        j12 = (nextBits(RandomKt.e(i12)) << 32) + (nextInt() & 4294967295L);
                        return from + j12;
                    }
                    nextInt = nextInt();
                }
