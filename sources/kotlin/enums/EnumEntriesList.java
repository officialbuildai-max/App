...
public final class EnumEntriesList<T extends Enum<T>> extends AbstractList<T> implements EnumEntries<T>, Serializable {
    ...
    public boolean contains(T element) {
        ...
        return ((Enum) ArraysKt.c0(this.entries, element.ordinal())) == element;
    }
    ...
    public int indexOf(T element) {
        ...
        if (((Enum) ArraysKt.c0(this.entries, ordinal)) == element) {
            return ordinal;
        }
        return -1;
    }
