...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.isTopLevel == adaptedFunctionReference.isTopLevel && this.arity == adaptedFunctionReference.arity && this.flags == adaptedFunctionReference.flags && Intrinsics.c(this.receiver, adaptedFunctionReference.receiver) && Intrinsics.c(this.owner, adaptedFunctionReference.owner) && this.name.equals(adaptedFunctionReference.name) && this.signature.equals(adaptedFunctionReference.signature);
    }
