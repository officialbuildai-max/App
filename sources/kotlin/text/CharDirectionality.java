...
public final class CharDirectionality {
    ...
    static {
        ...
        directionalityMap$delegate = LazyKt.b(new Function0() { // from class: kotlin.text.a
    ...
    public static final Map directionalityMap_delegate$lambda$1() {
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.f(MapsKt.e(CollectionsKt.v(entries, 10)), 16));
