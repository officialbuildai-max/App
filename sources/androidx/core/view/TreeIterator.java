    ...
    private final void prepareNextIterator(T item) {
        ...
        if (it != null && it.hasNext()) {
            ...
            while (!this.iterator.hasNext() && !this.stack.isEmpty()) {
                this.iterator = (Iterator) CollectionsKt.u0(this.stack);
                CollectionsKt.L(this.stack);
            }
        }
    }
