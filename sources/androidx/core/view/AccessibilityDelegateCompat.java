...
public class AccessibilityDelegateCompat {
    ...
    public static final class a extends View.AccessibilityDelegate {
        ...
        final AccessibilityDelegateCompat f8356a;

        a(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            this.f8356a = accessibilityDelegateCompat;
        }

        @Override // android.view.View.AccessibilityDelegate
        public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            return this.f8356a.dispatchPopulateAccessibilityEvent(view, accessibilityEvent);
        }

        @Override // android.view.View.AccessibilityDelegate
        public AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
            AccessibilityNodeProviderCompat accessibilityNodeProvider = this.f8356a.getAccessibilityNodeProvider(view);
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            this.f8356a.onInitializeAccessibilityEvent(view, accessibilityEvent);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            this.f8356a.onInitializeAccessibilityNodeInfo(view, wrap);
        ...
        public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            this.f8356a.onPopulateAccessibilityEvent(view, accessibilityEvent);
        }

        @Override // android.view.View.AccessibilityDelegate
        public boolean onRequestSendAccessibilityEvent(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
            return this.f8356a.onRequestSendAccessibilityEvent(viewGroup, view, accessibilityEvent);
        }

        @Override // android.view.View.AccessibilityDelegate
        public boolean performAccessibilityAction(View view, int i11, Bundle bundle) {
            return this.f8356a.performAccessibilityAction(view, i11, bundle);
        }

        @Override // android.view.View.AccessibilityDelegate
        public void sendAccessibilityEvent(View view, int i11) {
            this.f8356a.sendAccessibilityEvent(view, i11);
        }

        @Override // android.view.View.AccessibilityDelegate
        public void sendAccessibilityEventUnchecked(View view, AccessibilityEvent accessibilityEvent) {
            this.f8356a.sendAccessibilityEventUnchecked(view, accessibilityEvent);
        }
    }
    ...
    public boolean performAccessibilityAction(View view, int i11, Bundle bundle) {
        ...
        if (!z10) {
            z10 = this.mOriginalDelegate.performAccessibilityAction(view, i11, bundle);
        }
        return (z10 || i11 != R$id.accessibility_action_clickable_span || bundle == null) ? z10 : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
