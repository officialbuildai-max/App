...
/* renamed from: androidx.core.۟ۧۧۦۨ, reason: contains not printable characters */
/* loaded from: classes7.dex */
public class C0078 {

    /* renamed from: ۧۦۣ۠, reason: collision with root package name */
    public static int f8597 = 54;
    ...
    public static int m391() {
        return (-1754371) ^ C0799.m1158((Object) "ۧ۟ۧ");
    }

    /* renamed from: ۣۨۨۢ, reason: not valid java name and contains not printable characters */
    public static String m392(short[] sArr, int i11, int i12, int i13) {
