...
public final class LifecycleCoroutineScopeImpl$register$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((LifecycleCoroutineScopeImpl$register$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.this$0.a().b().compareTo(Lifecycle.State.INITIALIZED) >= 0) {
            ...
            JobKt__JobKt.e(n0Var.getCoroutineContext(), null, 1, null);
        }
        return Unit.f67184a;
    }
}
