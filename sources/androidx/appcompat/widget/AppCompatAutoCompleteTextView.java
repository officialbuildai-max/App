...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView, androidx.core.widget.p {

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f1753d = {R.attr.popupBackground};

    /* renamed from: a, reason: collision with root package name */
    private final c f1754a;

    /* renamed from: b, reason: collision with root package name */
    private final AppCompatTextHelper f1755b;

    /* renamed from: c, reason: collision with root package name */
    private final g f1756c;
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        j0 v11 = j0.v(getContext(), attributeSet, f1753d, i11, 0);
        if (v11.s(0)) {
        ...
        this.f1755b = appCompatTextHelper;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatTextHelper appCompatTextHelper = this.f1755b;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1755b.j();
    }

    @Nullable
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1755b.k();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1756c.e(i.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f1756c.a(keyListener));
    }
