...
public class PlaybackException extends Exception {
    ...
    private static final String FIELD_INT_ERROR_CODE = a1.C0(0);
    private static final String FIELD_LONG_TIMESTAMP_MS = a1.C0(1);
    private static final String FIELD_STRING_MESSAGE = a1.C0(2);
    private static final String FIELD_STRING_CAUSE_CLASS_NAME = a1.C0(3);
    private static final String FIELD_STRING_CAUSE_MESSAGE = a1.C0(4);
    private static final String FIELD_BUNDLE_EXTRAS = a1.C0(5);
    ...
    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i11) {
        this(str, th2, i11, Bundle.EMPTY, androidx.media3.common.util.i.f10469a.elapsedRealtime());
    }

    public PlaybackException(@Nullable String str, @Nullable Throwable th2, int i11, Bundle bundle) {
        this(str, th2, i11, bundle, androidx.media3.common.util.i.f10469a.elapsedRealtime());
    }
