...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        SchemeData(Parcel parcel) {
            ...
            this.mimeType = (String) a1.i(parcel.readString());
            this.data = parcel.createByteArray();
        }

        public SchemeData(UUID uuid, @Nullable String str, String str2, @Nullable byte[] bArr) {
            this.uuid = (UUID) androidx.media3.common.util.a.e(uuid);
            this.licenseServerUrl = str;
            this.mimeType = y.u((String) androidx.media3.common.util.a.e(str2));
            this.data = bArr;
        }
        ...
        public boolean matches(UUID uuid) {
            return h.f10063a.equals(this.uuid) || uuid.equals(this.uuid);
        }
    ...
    DrmInitData(Parcel parcel) {
        ...
        SchemeData[] schemeDataArr = (SchemeData[]) a1.i((SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR));
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        ...
        androidx.media3.common.util.a.g(str2 == null || (str = drmInitData.schemeType) == null || TextUtils.equals(str2, str));
        String str3 = this.schemeType;
        if (str3 == null) {
            str3 = drmInitData.schemeType;
        }
        return new DrmInitData(str3, (SchemeData[]) a1.W0(this.schemeDatas, drmInitData.schemeDatas));
    }
