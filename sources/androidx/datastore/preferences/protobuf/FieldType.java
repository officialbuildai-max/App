...
public final class FieldType {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f8789b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8789b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f8788a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f8788a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f8787id] = fieldType52;
        }
    }

    private FieldType(String str, int i11, int i12, Collection collection, JavaType javaType) {
        int i13;
        this.f8787id = i12;
        this.collection = collection;
        this.javaType = javaType;
        int i14 = a.f8788a[collection.ordinal()];
        if (i14 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i13 = a.f8789b[javaType.ordinal()]) == 1 || i13 == 2 || i13 == 3) ? false : true;
    }
