...
public final class DataStoreImpl$decrementCollector$1 extends ContinuationImpl {
    ...
    public DataStoreImpl$decrementCollector$1(DataStoreImpl dataStoreImpl, Continuation<? super DataStoreImpl$decrementCollector$1> continuation) {
        super(continuation);
