...
public final class OkioStorageConnection$readScope$1<R> extends ContinuationImpl {
    ...
    public OkioStorageConnection$readScope$1(OkioStorageConnection okioStorageConnection, Continuation<? super OkioStorageConnection$readScope$1> continuation) {
        super(continuation);
