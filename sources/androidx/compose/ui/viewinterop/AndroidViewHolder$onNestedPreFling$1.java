...
final class AndroidViewHolder$onNestedPreFling$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((AndroidViewHolder$onNestedPreFling$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            if (nestedScrollDispatcher.c(j11, this) == f11) {
                return f11;
            }
        } else {
            if (i11 != 1) {
