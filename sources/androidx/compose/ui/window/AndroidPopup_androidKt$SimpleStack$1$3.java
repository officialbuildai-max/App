...
public final class AndroidPopup_androidKt$SimpleStack$1$3 extends Lambda implements Function1<g0.a, Unit> {
    final /* synthetic */ List<g0> $placeables;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AndroidPopup_androidKt$SimpleStack$1$3(List<? extends g0> list) {
        super(1);
