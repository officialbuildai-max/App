...
public final class ModifierLocalConsumerKt$modifierLocalConsumer$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public final void invoke(z0 z0Var) {
        z0Var.b("modifierLocalConsumer");
        z0Var.a().c("consumer", this.$consumer$inlined);
    }
}
