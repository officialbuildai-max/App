...
final class ComposeScrollCaptureCallback$onScrollCaptureEnd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ComposeScrollCaptureCallback$onScrollCaptureEnd$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.b(obj);
            relativeScroller = this.this$0.f5971e;
            this.label = 1;
            if (relativeScroller.g(0.0f, this) == f11) {
                return f11;
            }
        } else {
            if (i11 != 1) {
