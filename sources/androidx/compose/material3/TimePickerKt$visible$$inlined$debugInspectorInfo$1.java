...
public final class TimePickerKt$visible$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public final void invoke(z0 z0Var) {
        z0Var.b("visible");
        z0Var.a().c("visible", Boolean.valueOf(this.$visible$inlined));
    }
}
