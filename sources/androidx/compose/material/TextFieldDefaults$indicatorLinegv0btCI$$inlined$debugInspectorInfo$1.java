...
public final class TextFieldDefaults$indicatorLinegv0btCI$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    final /* synthetic */ q $colors$inlined;
    ...
    public TextFieldDefaults$indicatorLinegv0btCI$$inlined$debugInspectorInfo$1(boolean z10, boolean z11, p.g gVar, q qVar, float f11, float f12) {
        super(1);
    ...
    public final void invoke(z0 z0Var) {
        ...
        z0Var.a().c("focusedIndicatorLineThickness", o0.i.d(this.$focusedIndicatorLineThickness$inlined));
        z0Var.a().c("unfocusedIndicatorLineThickness", o0.i.d(this.$unfocusedIndicatorLineThickness$inlined));
    }
}
