...
public final class DraggableAnchorsElement$inspectableProperties$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public final void invoke(z0 z0Var) {
        l2 a11 = z0Var.a();
        DraggableAnchorsElement.l(null);
        a11.c("state", null);
        z0Var.a().c("anchors", DraggableAnchorsElement.j(null));
        z0Var.a().c("orientation", DraggableAnchorsElement.k(null));
    }
}
