...
public final class WindowInsetsPadding_androidKt$safeDrawingPadding$$inlined$windowInsetsPadding$1 extends Lambda implements Function3<androidx.compose.ui.f, androidx.compose.runtime.i, Integer, androidx.compose.ui.f> {
    ...
    public final androidx.compose.ui.f invoke(androidx.compose.ui.f fVar, androidx.compose.runtime.i iVar, int i11) {
        ...
        if (O || y10 == androidx.compose.runtime.i.f3811a.a()) {
            y10 = new InsetsPaddingModifier(c11.j());
            iVar.p(y10);
        }
