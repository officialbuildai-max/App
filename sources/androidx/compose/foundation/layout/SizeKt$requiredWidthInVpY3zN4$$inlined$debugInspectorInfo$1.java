...
public final class SizeKt$requiredWidthInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    final /* synthetic */ float $max$inlined;
    final /* synthetic */ float $min$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SizeKt$requiredWidthInVpY3zN4$$inlined$debugInspectorInfo$1(float f11, float f12) {
        super(1);
    ...
    public final void invoke(z0 z0Var) {
        ...
        z0Var.a().c("min", o0.i.d(this.$min$inlined));
        z0Var.a().c("max", o0.i.d(this.$max$inlined));
    }
}
