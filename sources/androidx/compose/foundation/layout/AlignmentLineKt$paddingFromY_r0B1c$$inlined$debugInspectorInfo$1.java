...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1(androidx.compose.ui.layout.a aVar, long j11, long j12) {
        super(1);
        this.$alignmentLine$inlined = aVar;
        this.$before$inlined = j11;
        this.$after$inlined = j12;
    }
    ...
    public final void invoke(z0 z0Var) {
        ...
        z0Var.a().c("before", o0.w.b(this.$before$inlined));
        z0Var.a().c("after", o0.w.b(this.$after$inlined));
    }
}
