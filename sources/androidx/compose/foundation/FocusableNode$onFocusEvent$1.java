...
public final class FocusableNode$onFocusEvent$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((FocusableNode$onFocusEvent$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            b11 = ScrollIntoView__ScrollIntoViewRequesterKt.b(focusableNode, null, this, 1, null);
            if (b11 == f11) {
                return f11;
            }
        } else {
