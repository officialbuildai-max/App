...
public final class ToggleableKt$triStateToggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1 extends Lambda implements Function3<f, i, Integer, f> {
    ...
    public ToggleableKt$triStateToggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1(x xVar, ToggleableState toggleableState, boolean z10, androidx.compose.ui.semantics.f fVar, Function0 function0) {
        super(3);
    ...
    public final f invoke(f fVar, i iVar, int i11) {
        ...
        p.i iVar2 = (p.i) y10;
        f e11 = IndicationKt.b(f.f4253a, iVar2, this.$indication).e(new TriStateToggleableElement(this.$state$inlined, iVar2, null, this.$enabled$inlined, this.$role$inlined, this.$onClick$inlined, null));
        if (k.H()) {
            k.P();
        }
        iVar.K();
