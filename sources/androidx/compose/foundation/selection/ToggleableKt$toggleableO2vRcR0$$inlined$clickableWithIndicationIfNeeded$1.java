...
public final class ToggleableKt$toggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1 extends Lambda implements Function3<f, i, Integer, f> {
    ...
    public ToggleableKt$toggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1(x xVar, boolean z10, boolean z11, androidx.compose.ui.semantics.f fVar, Function1 function1) {
        super(3);
    ...
    public final f invoke(f fVar, i iVar, int i11) {
        ...
        p.i iVar2 = (p.i) y10;
        f e11 = IndicationKt.b(f.f4253a, iVar2, this.$indication).e(new ToggleableElement(this.$value$inlined, iVar2, null, this.$enabled$inlined, this.$role$inlined, this.$onValueChange$inlined, null));
        if (k.H()) {
            k.P();
        }
        iVar.K();
