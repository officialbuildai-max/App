...
public final class LazyStaggeredGridDslKt$items$5 extends Lambda implements Function4<a, Integer, i, Integer, Unit> {
    final /* synthetic */ Function4<a, Object, i, Integer, Unit> $itemContent;
    final /* synthetic */ List<Object> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyStaggeredGridDslKt$items$5(Function4<? super a, Object, ? super i, ? super Integer, Unit> function4, List<Object> list) {
        super(4);
    ...
    public final void invoke(a aVar, int i11, i iVar, int i12) {
        ...
        if (k.H()) {
            k.Q(-886456479, i13, -1, "androidx.compose.foundation.lazy.staggeredgrid.items.<anonymous> (LazyStaggeredGridDsl.kt:345)");
        }
        this.$itemContent.invoke(aVar, this.$items.get(i11), iVar, Integer.valueOf(i13 & 14));
        if (k.H()) {
            k.P();
        }
    }
