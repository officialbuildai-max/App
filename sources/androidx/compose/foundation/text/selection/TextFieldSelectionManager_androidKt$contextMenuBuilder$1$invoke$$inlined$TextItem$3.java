...
public final class TextFieldSelectionManager_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$3 extends Lambda implements Function0<Unit> {
    ...
    public TextFieldSelectionManager_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$3(o.a aVar, TextFieldSelectionManager textFieldSelectionManager) {
        super(0);
        this.$state = aVar;
    ...
    public final void m71invoke() {
        this.$this_contextMenuBuilder$inlined.k();
        o.b.a(this.$state);
    }
}
