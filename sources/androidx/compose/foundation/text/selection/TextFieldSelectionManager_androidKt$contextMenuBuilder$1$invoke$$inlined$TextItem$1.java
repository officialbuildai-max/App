...
public final class TextFieldSelectionManager_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$1 extends Lambda implements Function0<Unit> {
    ...
    public TextFieldSelectionManager_androidKt$contextMenuBuilder$1$invoke$$inlined$TextItem$1(o.a aVar, TextFieldSelectionManager textFieldSelectionManager) {
        super(0);
        this.$state = aVar;
    ...
    public final void m69invoke() {
        this.$this_contextMenuBuilder$inlined.d();
        o.b.a(this.$state);
    }
}
