...
final class ScrollableNode$onKeyEvent$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScrollableNode$onKeyEvent$1(ScrollableNode scrollableNode, long j11, Continuation<? super ScrollableNode$onKeyEvent$1> continuation) {
        super(2, continuation);
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ScrollableNode$onKeyEvent$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
