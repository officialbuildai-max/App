...
public final class ScrollableNode$processMouseWheelEvent$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<h, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.b(obj);
            ((h) this.L$0).b(this.$scrollAmount, androidx.compose.ui.input.nestedscroll.e.f5014a.b());
            return Unit.f67184a;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScrollableNode$processMouseWheelEvent$2$1(ScrollableNode scrollableNode, long j11, Continuation<? super ScrollableNode$processMouseWheelEvent$2$1> continuation) {
        super(2, continuation);
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ScrollableNode$processMouseWheelEvent$2$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
