...
public final class k0 extends p0 {
    ...
    private final void h() {
        int compare;
        if (this.f2392d > 8) {
            compare = Long.compare(ULong.b(ULong.b(this.f2393e) * 32) ^ Long.MIN_VALUE, ULong.b(ULong.b(this.f2392d) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
                i();
                return;
            }
    ...
    private final int k(Object obj) {
        ...
        while (true) {
            ...
            if ((((~j11) << 6) & j11 & (-9187201950435737472L)) != 0) {
                int j15 = j(i12);
                if (this.f2367f == 0 && ((this.f2389a[j15 >> 3] >> ((j15 & 7) << 3)) & 255) != 254) {
                    h();
                    j15 = j(i12);
                }
                this.f2393e++;
                int i20 = this.f2367f;
                long[] jArr2 = this.f2389a;
                int i21 = j15 >> 3;
                long j16 = jArr2[i21];
                int i22 = (j15 & 7) << 3;
                this.f2367f = i20 - (((j16 >> i22) & 255) == 128 ? 1 : 0);
                int i23 = this.f2392d;
    ...
    private final void l() {
        this.f2367f = v0.c(c()) - this.f2393e;
    }
    ...
    private final void n(int i11) {
        ...
        this.f2392d = max;
        m(max);
        this.f2390b = new Object[max];
        this.f2391c = new int[max];
    }
    ...
    public final int o(Object obj, int i11, int i12) {
        int k11 = k(obj);
        if (k11 < 0) {
            k11 = ~k11;
        } else {
    ...
    public final void p(int i11) {
        ...
        this.f2390b[i11] = null;
    }

    public final void r(Object obj, int i11) {
        int k11 = k(obj);
        if (k11 < 0) {
            k11 = ~k11;
        }
