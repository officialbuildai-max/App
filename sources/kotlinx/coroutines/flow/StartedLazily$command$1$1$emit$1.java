...
public final class StartedLazily$command$1$1$emit$1 extends ContinuationImpl {
    ...
    public StartedLazily$command$1$1$emit$1(StartedLazily$command$1.AnonymousClass1 anonymousClass1, Continuation<? super StartedLazily$command$1$1$emit$1> continuation) {
        super(continuation);
