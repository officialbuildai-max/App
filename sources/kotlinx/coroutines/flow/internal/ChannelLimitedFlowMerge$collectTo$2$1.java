...
final class ChannelLimitedFlowMerge$collectTo$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    public ChannelLimitedFlowMerge$collectTo$2$1(kotlinx.coroutines.flow.b bVar, r rVar, Continuation<? super ChannelLimitedFlowMerge$collectTo$2$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super Unit> continuation) {
        return ((ChannelLimitedFlowMerge$collectTo$2$1) create(n0Var, continuation)).invokeSuspend(Unit.f67184a);
    }
